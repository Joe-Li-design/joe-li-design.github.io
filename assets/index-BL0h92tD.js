import*as T from"https://unpkg.com/three@0.180.0/build/three.module.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function a(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=a(o);fetch(o.href,i)}})();const hn=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
...
`,vn=[{value:"value",label:"Value"},{value:"cloud",label:"Cloud"},{value:"voronoi",label:"Voronoi"},{value:"ridged",label:"Ridged"},{value:"warp",label:"Domain Warp"},{value:"turbulence",label:"Turbulence"}],zo={value:0,cloud:1,voronoi:2,ridged:3,warp:4,turbulence:5};function pa(e){return zo[e]??1}const we=8,gn=`
...
`;function he(e){return Math.min(1,Math.max(0,Number.isFinite(e)?e:0))}function wa(e,t,a){return Math.min(a,Math.max(t,Number.isFinite(e)?e:0))}function Ho(e,t,a,n,o){let i=he(o);for(let l=0;l<8;l++){const s=1-i,c=s*s*s*e+3*s*s*i*t+3*s*i*i*a+i*i*i*n-o,u=3*s*s*(t-e)+6*s*i*(a-t)+3*i*i*(n-a);if(Math.abs(u)<1e-6)break;i=he(i-c/u)}return i}function qo(e){if(typeof e.handleAngle=="number"&&typeof e.handleDist=="number"&&e.handleDist>0){const t=e.handleDist*.33;return{tanDx:Math.cos(e.handleAngle)*t,tanDy:Math.sin(e.handleAngle)*t,tanSet:!0}}return typeof e.bend=="number"&&e.bend!==0?{tanDx:0,tanDy:wa(e.bend,-1,1)*.25,tanSet:!0}:{tanDx:0,tanDy:0,tanSet:!1}}function St(e){if(e&&Array.isArray(e.points)&&e.points.length>=2){const t=e.points.map(a=>{const o=a.tanSet&&typeof a.tanDx=="number"&&typeof a.tanDy=="number"?{tanDx:a.tanDx,tanDy:a.tanDy,tanSet:!0}:qo(a);return{x:he(a.x),y:he(a.y),type:a.type==="constant"?"constant":"bezier",tanDx:o.tanSet?o.tanDx:0,tanDy:o.tanSet?o.tanDy:0,tanSet:!!o.tanSet}}).sort((a,n)=>a.x-n.x).slice(0,we);return t[0]={...t[0],x:0},t[t.length-1]={...t[t.length-1],x:1},{points:t}}return e&&typeof e.x=="number"&&typeof e.y=="number"?{points:[{x:0,y:0,type:"bezier",tanDx:0,tanDy:0,tanSet:!1},{x:he(e.x),y:he(e.y),type:"bezier",tanDx:0,tanDy:0,tanSet:!1},{x:1,y:1,type:"bezier",tanDx:0,tanDy:0,tanSet:!1}]}:{points:[{x:0,y:0,type:"bezier",tanDx:0,tanDy:0,tanSet:!1},{x:1,y:1,type:"bezier",tanDx:0,tanDy:0,tanSet:!1}]}}function Go(e,t){const{points:a}=St(e),n=he(t);for(let o=0;o<a.length-1;o++){const i=a[o],l=a[o+1];if(n>=i.x&&(n<l.x||o===a.length-2)){if(i.type==="constant")return i.y;const s=Math.max(l.x-i.x,1e-5),c=wa(i.tanSet?i.x+i.tanDx:i.x+s/3,i.x,l.x),u=i.tanSet?i.y+i.tanDy:i.y,d=wa(l.tanSet?l.x-l.tanDx:l.x-s/3,i.x,l.x),f=l.tanSet?l.y-l.tanDy:l.y,p=Ho(i.x,c,d,l.x,n),h=1-p;return h*h*h*i.y+3*h*h*p*u+3*h*p*p*f+p*p*p*l.y}}return a[a.length-1].y}function bn(e){const{points:t}=St(e),a=[],n=[];for(let o=0;o<we;o++){const i=t[Math.min(o,t.length-1)];a.push([i.x,i.y,i.type==="constant"?1:0,0]),n.push([i.tanDx||0,i.tanDy||0,i.tanSet?1:0,0])}return{points:a,tans:n,count:t.length}}const Ct=8;function Fn(e){const t=typeof e=="string"?/^#?([0-9a-fA-F]{6})$/.exec(e.trim()):null;return t?`#${t[1].toLowerCase()}`:"#ffffff"}function xt(e){const t=Fn(e).slice(1);return[parseInt(t.slice(0,2),16)/255,parseInt(t.slice(2,4),16)/255,parseInt(t.slice(4,6),16)/255]}function Wo([e,t,a]){const n=o=>Math.round(he(o)*255).toString(16).padStart(2,"0");return`#${n(e)}${n(t)}${n(a)}`}function st(e){let t=e&&Array.isArray(e.stops)?e.stops:null;(!t||t.length<2)&&(t=[{t:0,color:"#1b2a6b"},{t:1,color:"#ffcf6b"}]);const a=t.map(n=>({t:he(Number(n&&n.t)),color:Fn(n&&n.color)})).sort((n,o)=>n.t-o.t).slice(0,Ct);return a.length<2&&a.push({t:1,color:"#ffffff"}),{stops:a}}function jo(e,t){const{stops:a}=st(e),n=he(t);if(n<=a[0].t)return a[0].color;if(n>=a[a.length-1].t)return a[a.length-1].color;for(let o=0;o<a.length-1;o++){const i=a[o],l=a[o+1];if(n>=i.t&&n<=l.t){const s=Math.max(l.t-i.t,1e-5),c=(n-i.t)/s,u=xt(i.color),d=xt(l.color);return Wo([u[0]+(d[0]-u[0])*c,u[1]+(d[1]-u[1])*c,u[2]+(d[2]-u[2])*c])}}return a[a.length-1].color}function $n(e){const{stops:t}=st(e);return`linear-gradient(90deg, ${t.map(a=>`${a.color} ${(a.t*100).toFixed(1)}%`).join(", ")})`}function Vo(e){const{stops:t}=st(e),a=[];for(let n=0;n<Ct;n++){const o=t[Math.min(n,t.length-1)],i=xt(o.color);a.push([i[0],i[1],i[2],o.t])}return{stops:a,count:t.length}}const Xo=`
  #define FX_GRAD_MAX ${Ct}
...
`,Un=[{id:"glow",label:"Glow / Deep Glow",group:"Effect",icon:'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"><circle cx="8" cy="8" r="2.6"/><path d="M8 1.4v2M8 12.6v2M1.4 8h2M12.6 8h2M3.4 3.4l1.4 1.4M11.2 11.2l1.4 1.4M3.4 12.6l1.4-1.4M11.2 4.8l1.4-1.4"/></svg>',params:[{key:"threshold",label:"Threshold",min:0,max:1,step:.01,default:.55},{key:"intensity",label:"Intensity",min:0,max:3,step:.02,default:1.1},{key:"radius",label:"Radius",min:.5,max:6,step:.05,default:2.2},{key:"steps",label:"Steps (Quality)",min:2,max:8,step:1,default:4}],passes:[{key:"glow",fragmentShader:`
        ...
        `,updateUniforms(e,t){const{stops:a,count:n}=Vo(t.gradient);for(let o=0;o<a.length;o++)e.uGradStops.value[o].set(a[o][0],a[o][1],a[o][2],a[o][3]);e.uGradCount.value=n,e.uContrast.value=t.contrast,e.uInvert.value=t.invert?1:0,e.uMix.value=t.mix}}]},{id:"uvNoise",label:"UV Noise",group:"Distort",icon:'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.2"><circle cx="4.5" cy="5" r="1.6"/><circle cx="11" cy="4.5" r="1.1"/><circle cx="10" cy="10.5" r="2"/><circle cx="4" cy="11" r="1.2"/></svg>',params:[{key:"noiseType",label:"Noise Type",type:"select",default:"cloud",options:vn},{key:"amount",label:"Amount",min:0,max:.15,step:.001,default:.035},{key:"scale",label:"Scale",min:1,max:30,step:.5,default:5},{key:"speed",label:"Speed",min:0,max:3,step:.02,default:.4}],passes:[{key:"uvNoise",fragmentShader:`
          uniform sampler2D tDiffuse;
          uniform float uAmount;
          uniform float uScale;
          uniform float uSpeed;
        ...
        `,updateUniforms(e,t){e.uAngle.value=t.angle,e.uAmount.value=t.amount,e.uSteps.value=t.steps,e.uRandomness.value=t.randomness}}]},{id:"uvBlur",label:"UV Blur",group:"Blur",icon:'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.2"><path d="M1.5 5.5c1.2-1.6 2.4-1.6 3.6 0s2.4 1.6 3.6 0 2.4-1.6 3.6 0" opacity="0.4"/><path d="M1.5 8.5c1.2-1.6 2.4-1.6 3.6 0s2.4 1.6 3.6 0 2.4-1.6 3.6 0" opacity="0.7"/><path d="M1.5 11.5c1.2-1.6 2.4-1.6 3.6 0s2.4 1.6 3.6 0 2.4-1.6 3.6 0" opacity="1"/></svg>',params:[{key:"followDistort",label:"Sync Distort",type:"toggle",default:!0},{key:"strength",label:"Strength",min:0,max:.15,step:.001,default:.05},{key:"noiseType",label:"Noise Type",type:"select",default:"cloud",options:vn},{key:"scale",label:"Scale",min:1,max:30,step:.5,default:5},{key:"speed",label:"Speed",min:0,max:3,step:.02,default:.4}],passes:[{key:"uvBlur",fragmentShader:`
          uniform sampler2D tDiffuse;
        ...
        `,updateUniforms(e,t,a){e.uMode.value=t.flowType==="radial"?1:t.flowType==="weave"?2:t.flowType==="noise"?3:0,e.uAngle.value=t.flowAngle,e.uArc.value=t.lightAngle,e.uFrequency.value=t.frequency,e.uStrength.value=t.strength,e.uJitter.value=t.organic,e.uSpeed.value=t.speed,e.uRoughness.value=t.contentFollow,e.uFalloff.value=t.contentRelief,e.uShadowHue.value=t.shadowHue,e.uHighlightHue.value=t.highlightHue,e.uSaturation.value=t.saturation,e.uChroma.value=t.colorize,e.uContrast.value=t.punch,e.uMix.value=t.mix,e.uTime.value=a}}]}];function Pe(e){return Un.find(t=>t.id===e)||null}function Ko(e){if(!e||!e.stack||!e.instance)return null;const t=e.stack.indexOf(e.instance);if(t<0)return null;for(let a=t-1;a>=0;a--){const n=e.stack[a];if(!n.enabled)continue;const o=Pe(n.defId);if(o&&o.group==="Distort")return{inst:n,def:o}}return null}function Na(e){const t=Pe(e);if(!t)return{};const a={};return t.params.forEach(n=>{a[n.key]=n.default&&typeof n.default=="object"?JSON.parse(JSON.stringify(n.default)):n.default}),a}const yn=`
  uniform sampler2D tDiffuse;
  varying vec2 vUv;
  void main() { gl_FragColor = texture2D(tDiffuse, vUv); }
`;class Yo{constructor(t){this.canvas=t,this.renderer=new T.WebGLRenderer({canvas:t,alpha:!1,antialias:!1,preserveDrawingBuffer:!0}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),this.renderer.debug.onShaderError=(a,n,o,i)=>{const l=a.getShaderInfoLog(o),s=a.getShaderInfoLog(i),c=a.getProgramInfoLog(n);console.error(`[postfx] Shader compile/link error:
--- vertex log ---
`+l+`
--- fragment log ---
`+s+`
--- program log ---
`+c)},t.addEventListener("webglcontextlost",this._onContextLost=a=>{a.preventDefault(),console.error("[postfx] WebGL context lost on compositor canvas.")}),t.addEventListener("webglcontextrestored",this._onContextRestored=()=>{console.warn("[postfx] WebGL context restored on compositor canvas.")}),this.scene=new T.Scene,this.camera=new T.OrthographicCamera(-1,1,1,-1,0,1),this.quad=new T.Mesh(new T.PlaneGeometry(2,2),new T.ShaderMaterial({vertexShader:hn,fragmentShader:yn,uniforms:{tDiffuse:{value:null}}})),this.scene.add(this.quad),this.materialCache=new Map,this.canvasTexture=null,this.sourceCanvas=null,this.sourceWidth=0,this.sourceHeight=0,this.uniformResolutionScale=1,this.rtA=null,this.rtB=null,this.width=0,this.height=0}_materialFor(t){let a=this.materialCache.get(t.key);if(a||(a=new T.ShaderMaterial({vertexShader:hn,fragmentShader:t.fragmentShader||yn,uniforms:{tDiffuse:{value:null},uResolution:{value:new T.Vector2(1,1)},uTime:{value:0},uThreshold:{value:.5},uIntensity:{value:1},uRadius:{value:1},uSteps:{value:4},uAmount:{value:0},uBlend:{value:0},uBlur:{value:0},uBulge:{value:0},uPinch:{value:0},uUseCurve:{value:0},uEdge:{value:0},uScale:{value:1},uSpeed:{value:0},uDirection:{value:new T.Vector2(1,0)},uSize:{value:8},uDotSize:{value:8},uAngle:{value:0},uMono:{value:0},uVariation:{value:.35},uStrength:{value:.35},uOffset:{value:.5},uShadowHue:{value:220},uHighlightHue:{value:40},uSaturation:{value:.65},uMix:{value:.85},uCurvePoints:{value:Array.from({length:we},()=>new T.Vector4(0,0,0,0))},uCurveTans:{value:Array.from({length:we},()=>new T.Vector4(0,0,0,0))},uCurveCount:{value:2},uEdgeShape:{value:0},uEdgeSoftness:{value:.35},uNoiseType:{value:0},uSpin:{value:0},tImage:{value:null},uHasImage:{value:0},uMode:{value:0},tDistortImage:{value:null},uHasImageDistort:{value:0},uGradStops:{value:Array.from({length:Ct},()=>new T.Vector4(0,0,0,0))},uGradCount:{value:2},uContrast:{value:0},uBrightness:{value:0},uBlackPoint:{value:0},uWhitePoint:{value:1},uGamma:{value:1},uHighlights:{value:0},uShadows:{value:0},uHueShift:{value:0},uSatScale:{value:1},uLightness:{value:0},uInvert:{value:0},uShape:{value:0},uColorMode:{value:0},uInkColor:{value:new T.Vector3(0,0,0)},uPaperColor:{value:new T.Vector3(1,1,1)},uRandomness:{value:0},uArc:{value:0},uArcPosition:{value:.5},uRoughness:{value:0},uChroma:{value:0},uCenter:{value:new T.Vector2(.5,.5)},uBlades:{value:0},uFocusPos:{value:.5},uFocusWidth:{value:.2},uFrequency:{value:8},uFalloff:{value:1},uTiltX:{value:0},uTiltY:{value:0},uJitter:{value:0},uStock:{value:1},uGrain:{value:.45},uGrainSize:{value:1.4},uGrainAnimated:{value:1},uHalation:{value:.55},uHaloSize:{value:3.2},uFade:{value:.08},uTemperature:{value:0},uTintShift:{value:0},uVignette:{value:.4},uBrushType:{value:0},uBrushSize:{value:9},uStrokeStrength:{value:.72},uDetail:{value:.55},uEdgeBlend:{value:.6},uStrokePresence:{value:.65}}}),this.materialCache.set(t.key,a)),t.key==="oilPaint"){const n=a.uniforms;n.uBrushType||(n.uBrushType={value:0}),n.uBrushSize||(n.uBrushSize={value:9}),n.uStrokeStrength||(n.uStrokeStrength={value:.72}),n.uDetail||(n.uDetail={value:.55}),n.uEdgeBlend||(n.uEdgeBlend={value:.6}),n.uStrokePresence||(n.uStrokePresence={value:.65}),n.uMix||(n.uMix={value:.85})}return a}getInstanceTexture(t){if(!t)return null;const a=t.params&&t.params.image;if(!a)return t._glTex&&(t._glTex.dispose(),t._glTex=null,t._glTexUrl=null),null;if(t._glTex&&t._glTexUrl===a)return t._glTex;t._glTex&&t._glTex.dispose();const n=new Image,o=new T.Texture(n);return o.minFilter=T.LinearFilter,o.magFilter=T.LinearFilter,o.generateMipmaps=!1,n.onload=()=>{o.needsUpdate=!0},n.src=a,t._glTex=o,t._glTexUrl=a,o}setSource(t){this.sourceCanvas!==t&&(this._recreateCanvasTexture(t),this._debugLoggedThisSource=!1)}_recreateCanvasTexture(t){this.sourceCanvas=t,this.canvasTexture&&this.canvasTexture.dispose(),this.canvasTexture=t?new T.CanvasTexture(t):null,this.canvasTexture&&(this.canvasTexture.minFilter=T.LinearFilter,this.canvasTexture.magFilter=T.LinearFilter,this.canvasTexture.generateMipmaps=!1),this.sourceWidth=t?t.width:0,this.sourceHeight=t?t.height:0}resize(t,a){if(t<=0||a<=0||this.width===t&&this.height===a)return;this.width=t,this.height=a,this.renderer.setSize(t,a,!1);const n=this.renderer.getPixelRatio(),o=Math.max(1,Math.floor(t*n)),i=Math.max(1,Math.floor(a*n));this.rtA&&this.rtA.dispose(),this.rtB&&this.rtB.dispose(),this.rtA=new T.WebGLRenderTarget(o,i,{depthBuffer:!1,stencilBuffer:!1}),this.rtB=new T.WebGLRenderTarget(o,i,{depthBuffer:!1,stencilBuffer:!1})}renderFrame(t,a){if(!this.canvasTexture||!this.rtA||!this.rtB)return;const n=this.sourceCanvas?this.sourceCanvas.width:0,o=this.sourceCanvas?this.sourceCanvas.height:0;(n!==this.sourceWidth||o!==this.sourceHeight)&&this._recreateCanvasTexture(this.sourceCanvas),this.canvasTexture.needsUpdate=!0;const i=[];t.forEach(u=>{if(!u.enabled)return;const d=Pe(u.defId);d&&d.passes.forEach(f=>i.push({pass:f,params:u.params,instance:u}))});const l=[this.rtA,this.rtB];let s=this.canvasTexture,c=0;if(i.length===0){const u=this.quad.material;u.uniforms.tDiffuse.value=s,this.renderer.setRenderTarget(null),this.renderer.render(this.scene,this.camera);return}i.forEach(({pass:u,params:d,instance:f},p)=>{const h=p===i.length-1,v=this._materialFor(u);v.uniforms.tDiffuse.value=s;const m=Math.max(1e-6,this.uniformResolutionScale||1);v.uniforms.uResolution.value.set(this.rtA.width/m,this.rtA.height/m),u.updateUniforms(v.uniforms,d,a,{instance:f,compositor:this,stack:t}),this.quad.material=v;const g=h?null:l[c%2];this.renderer.setRenderTarget(g),this.renderer.render(this.scene,this.camera),h||(s=g.texture,c+=1)})}captureAtScale(t,a,n){if(!this.width||!this.height)return null;const o=this.renderer.getPixelRatio(),i=this.rtA,l=this.rtB,s=Math.max(.01,Number(n)||1),c=o*s,u=Math.max(1,Math.floor(this.width*c)),d=Math.max(1,Math.floor(this.height*c));this.renderer.setPixelRatio(c),this.renderer.setSize(this.width,this.height,!1),this.rtA=new T.WebGLRenderTarget(u,d,{depthBuffer:!1,stencilBuffer:!1}),this.rtB=new T.WebGLRenderTarget(u,d,{depthBuffer:!1,stencilBuffer:!1});let f=null;try{this.uniformResolutionScale=s,this.renderFrame(t,a),f=this.canvas.toDataURL("image/png")}finally{this.uniformResolutionScale=1,this.rtA.dispose(),this.rtB.dispose(),this.rtA=i,this.rtB=l,this.renderer.setPixelRatio(o),this.renderer.setSize(this.width,this.height,!1),this.renderFrame(t,a)}return f?{dataUrl:f,width:u,height:d}:null}dispose(){this.materialCache.forEach(t=>t.dispose()),this.materialCache.clear(),this.canvasTexture&&this.canvasTexture.dispose(),this.rtA&&this.rtA.dispose(),this.rtB&&this.rtB.dispose(),this._onContextLost&&this.canvas.removeEventListener("webglcontextlost",this._onContextLost),this._onContextRestored&&this.canvas.removeEventListener("webglcontextrestored",this._onContextRestored),this.renderer.dispose()}}const Jo="/assets/Default-DtKDocRU.png",_a="shaderops:active-profile:v1",Oa="shaderops:profiles:v1",$t="shaderops:profile:",Nn="shaderops-profile",Zo=1;function _(){return window.localStorage}function Qo(e,t){try{const a=JSON.parse(e);return a&&typeof a=="object"?a:t}catch{return t}}function ei(e){return String(e||"").trim().replace(/\s+/g," ").slice(0,48)}function ti(){return`profile-${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}function ct(){const e=Qo(_().getItem(Oa),[]);return Array.isArray(e)?e.filter(t=>t&&typeof t.id=="string"&&typeof t.name=="string"):[]}function Dt(){const e=_().getItem(_a);return ct().find(t=>t.id===e)||null}function _n(e){const t=ei(e);if(!t)throw new Error("A profile name is required.");const a={id:ti(),name:t,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()},n=[...ct(),a];return _().setItem(Oa,JSON.stringify(n)),_().setItem(_a,a.id),a}function za(e){const t=ct().find(a=>a.id===e);if(!t)throw new Error("This profile is not available on this computer.");return _().setItem(_a,t.id),t}function Ha(){return Dt()?.id||"default"}function Bt(e,t=Ha()){return`${$t}${t}:${e}`}function ai(e){const t=ct(),a=t.find(n=>n.id===e);a&&(a.updatedAt=new Date().toISOString(),_().setItem(Oa,JSON.stringify(t)))}function ni(){const e=Ha();return{getItem(t){const a=Bt(t,e),n=_().getItem(a);if(n!==null)return n;const o=_().getItem(t);return o!==null&&_().setItem(a,o),o},setItem(t,a){_().setItem(Bt(t,e),String(a)),ai(e)},removeItem(t){_().removeItem(Bt(t,e))},key(t){const a=`${$t}${e}:`,n=[];for(let o=0;o<_().length;o++){const i=_().key(o);i?.startsWith(a)&&n.push(i.slice(a.length))}return n[t]??null},get length(){const t=`${$t}${e}:`;let a=0;for(let n=0;n<_().length;n++)_().key(n)?.startsWith(t)&&(a+=1);return a}}}function oi(e=Ha()){const t=ct().find(o=>o.id===e);if(!t)throw new Error("This profile is not available on this computer.");const a=`${$t}${e}:`,n={};for(let o=0;o<_().length;o++){const i=_().key(o);i?.startsWith(a)&&(n[i.slice(a.length)]=_().getItem(i))}return{format:Nn,version:Zo,exportedAt:new Date().toISOString(),profile:{name:t.name,createdAt:t.createdAt},entries:n}}function ii(e,t){if(!e||e.format!==Nn||!e.entries||typeof e.entries!="object")throw new Error("This is not a valid ShaderOps profile recovery file.");const a=_n(e.profile?.name||"Recovered Profile");return Object.entries(e.entries).forEach(([n,o])=>{typeof n=="string"&&typeof o=="string"&&_().setItem(Bt(n,a.id),o)}),a}const k=ni(),On="shaderops:project-previews:v1",Ut="shaderops:selected-project:v1",zn="shaderops:filters:v1",Hn="shaderops:favorites:v1",qn="shaderops:project-order:v1",Gn="shaderops:filter-add-order:v1",qa="shaderops:filter-rail-collapsed:v1",Wn="shaderops:curve-popup-size:v1",jn="shaderops-state",ka=1,ri=400,li="shaderops:image-loader:v1:",ut="shaderops://image/default",He="Default",Lt=[];function si(e){const t=e.ownerDocument,a=t.createElement("div");a.className="w-pill";const n=t.createElement("div");n.className="w-pill__fill",a.appendChild(n);let o=null;const i=()=>{const s=e.dataset.pillMode||"",c=`${e.value}|${s}`;if(c===o)return;o=c;const u=Number(e.min)||0,d=Number(e.max)||100,f=Number(e.value),p=d===u?0:Math.min(1,Math.max(0,(f-u)/(d-u)));if(s==="center-zero"&&u<0&&d>0){const h=Math.min(1,Math.max(0,(0-u)/(d-u))),v=Math.min(p,h),m=Math.abs(p-h);a.classList.add("w-pill--center"),a.style.setProperty("--pill-center",`${(h*100).toFixed(3)}%`),n.classList.toggle("is-tip-left",p<h),n.style.left=`${(v*100).toFixed(3)}%`,n.style.width=`${(m*100).toFixed(3)}%`;return}a.classList.remove("w-pill--center"),a.style.removeProperty("--pill-center"),n.classList.remove("is-tip-left"),n.style.left="0%",n.style.width=`${(p*100).toFixed(3)}%`};i();const l=(s,c)=>{const u=a.getBoundingClientRect(),d=Number(e.min)||0,f=Number(e.max)||100,p=Number(e.step)||1,h=u.width===0?0:Math.min(1,Math.max(0,(s-u.left)/u.width));let v=d+h*(f-d);v=Math.round(v/p)*p,v=Math.min(f,Math.max(d,v)),e.value=String(Number(v.toFixed(6))),e.dispatchEvent(new Event("input",{bubbles:!0})),c||e.dispatchEvent(new Event("change",{bubbles:!0})),i()};return a.addEventListener("pointerdown",s=>{s.preventDefault(),a.setPointerCapture(s.pointerId),l(s.clientX,!0);const c=d=>l(d.clientX,!0),u=d=>{a.removeEventListener("pointermove",c),a.removeEventListener("pointerup",u),a.removeEventListener("pointercancel",u),l(d.clientX,!1)};a.addEventListener("pointermove",c),a.addEventListener("pointerup",u),a.addEventListener("pointercancel",u)}),e.insertAdjacentElement("beforebegin",a),e.style.display="none",e.dataset.pillMounted="1",{slider:e,paint:i}}function Ga(e){if(!e)return;e.querySelectorAll('.control-row input[type="range"], .filter-param-row input[type="range"]').forEach(a=>{a.dataset.pillMounted||Lt.push(si(a))})}(function(){const t=()=>{for(let a=Lt.length-1;a>=0;a--){const n=Lt[a];if(!n.slider.isConnected){Lt.splice(a,1);continue}n.paint()}requestAnimationFrame(t)};requestAnimationFrame(t)})();const ci=document.getElementById("app");document.documentElement.classList.toggle("app-client-shell",navigator.userAgent.includes("Electron"));ci.innerHTML=`
...
`;const r={projects:[],selectedId:null,previews:{},captureInFlight:!1,prewarmQueue:[],prewarmActive:!1,filterStacks:{},filterPreviewOn:{},filterHistory:{},navPage:0,favorites:[]},oe=document.getElementById("projectList"),Sa=document.getElementById("projectTitle"),Ca=document.getElementById("projectMethod"),L=document.getElementById("projectFrame"),Da=document.getElementById("deleteProjectButton"),Xt=document.getElementById("navGridButton"),Ye=document.getElementById("navPager"),ui=document.getElementById("navPagerLabel"),j=document.getElementById("navGridPanel"),Wa=document.getElementById("navGridBackdrop"),Ea=document.getElementById("navGridFav"),Ma=document.getElementById("navGrid2d"),Ba=document.getElementById("navGrid3d"),ja=document.getElementById("shaderStage"),I=document.getElementById("fxCanvas"),Va=document.getElementById("filterRail"),di=document.getElementById("filterRailGear"),fi=document.getElementById("filterRailCollapse"),Kt=document.getElementById("filterAddButton"),J=document.getElementById("filterAddMenu"),N=document.getElementById("filterStackList"),pi=document.getElementById("filterStackEmpty"),Nt=document.getElementById("filterPreviewToggle"),Vn=document.getElementById("filterExportButton"),me=document.getElementById("filterCopyButton"),mi=document.getElementById("profileButton"),hi=document.getElementById("profileButtonName"),Pt=document.getElementById("profileOverlay"),vi=document.getElementById("profileDialogTitle"),gi=document.getElementById("profileDialogDescription"),bt=document.getElementById("profileNameInput"),ma=document.getElementById("profileExistingList"),nt=document.getElementById("profileDialogStatus"),Xn=document.getElementById("profileContinueButton"),Kn=document.getElementById("profileDownloadButton"),bi=document.getElementById("profileRestoreLabel"),La=document.getElementById("profileRestoreInput"),_t=document.getElementById("exportSizeOverlay"),yi=document.getElementById("exportSizeCurrent"),Pa=document.getElementById("exportSizeOptions"),xi=document.getElementById("exportSizeCancel"),K=document.getElementById("exportBatchCount"),_e=document.getElementById("exportBatchScale"),wi=document.getElementById("exportBatchMode"),At=document.getElementById("exportBatchRun"),xn=document.getElementById("exportBatchStatus"),wn=document.getElementById("exportBatchPathName"),Aa=document.getElementById("exportBatchChoosePath"),Xa=document.getElementById("exportBatchClearPath"),Je=document.getElementById("deleteConfirmOverlay"),ki=document.getElementById("deleteConfirmMessage"),Si=document.getElementById("deleteConfirmButton"),Ci=document.getElementById("deleteConfirmCancel"),dt=document.getElementById("unifiedPanel"),Di=document.getElementById("unifiedPanelGear"),Tt=document.getElementById("unifiedPanelGroups"),Yn=document.getElementById("globalCheckpoints"),Ei=document.getElementById("unifiedDiceButton"),Mi=document.getElementById("unifiedWaveButton"),It=document.getElementById("unifiedPauseButton"),Bi=document.getElementById("unifiedUndoButton"),Li=document.getElementById("unifiedRedoButton"),ha=document.getElementById("unifiedCheckpointSlots"),Jn=document.getElementById("unifiedCheckpointAddShell");document.getElementById("unifiedCheckpointAdd");const Pi=document.getElementById("topbarReloadButton"),re=document.getElementById("thumbHoverPreview"),Ai=document.getElementById("thumbHoverPreviewTitle"),Zn=document.getElementById("thumbHoverPreviewHero"),kn=document.getElementById("thumbHoverPreviewCheckpoints");let Qn="settings";function Ti(){hi.textContent=Dt()?.name||"Profile"}function Ii(e){try{za(e),window.location.reload()}catch(t){nt.textContent=t instanceof Error?t.message:"Unable to switch profile."}}function Ri(){const e=ct();ma.replaceChildren(),ma.hidden=e.length===0,e.forEach(t=>{const a=document.createElement("button");a.type="button",a.className="profile-existing-list__item",a.textContent=t.name,a.title=`Switch to ${t.name}`,a.addEventListener("click",()=>Ii(t.id)),ma.appendChild(a)})}function eo(e){Qn=e;const t=Dt(),a=e==="onboarding";vi.textContent=a?"Welcome to ShaderOps":"Profile & recovery",gi.textContent=a?"Choose a name once. Your favorites, checkpoints, looks, and filters save automatically on this computer.":`Working as ${t?.name||"this profile"}. Your work is stored locally and saves automatically.`,bt.value="",bt.placeholder=a?"Your name":"Create another profile",Xn.textContent=a?"Continue":"Create profile",Kn.hidden=a||!t,bi.hidden=a,nt.textContent="",Ri(),Pt.hidden=!1,window.setTimeout(()=>bt.focus(),0)}function to(){try{const e=_n(bt.value);za(e.id),window.location.reload()}catch(e){nt.textContent=e instanceof Error?e.message:"Enter a profile name to continue."}}function Fi(){try{const e=Dt(),t=new Blob([JSON.stringify(oi(),null,2)],{type:"application/json"}),a=URL.createObjectURL(t),n=document.createElement("a");n.href=a,n.download=`${(e?.name||"shaderops-profile").replace(/[^\w.-]+/g,"-")}.shaderops-profile.json`,n.click(),URL.revokeObjectURL(a),nt.textContent="Recovery file downloaded."}catch(e){nt.textContent=e instanceof Error?e.message:"Unable to create recovery file."}}async function $i(e){if(e)try{const t=ii(JSON.parse(await e.text()));za(t.id),window.location.reload()}catch(t){nt.textContent=t instanceof Error?t.message:"Unable to restore this recovery file."}finally{La.value=""}}mi.addEventListener("click",()=>eo("settings"));Xn.addEventListener("click",to);bt.addEventListener("keydown",e=>{e.key==="Enter"&&to()});Kn.addEventListener("click",Fi);La.addEventListener("change",()=>$i(La.files?.[0]));Pt.addEventListener("click",e=>{e.target===Pt&&Qn!=="onboarding"&&(Pt.hidden=!0)});Ti();Dt()||eo("onboarding");const Ka="shaderops:unified-panel-collapsed:v1",Sn=["Global","Color"],q=new Map,Xe=new Map;function ao(e){return!!(e&&e.bridged)}function qe(){const e=r.projects.find(t=>t.id===r.selectedId);return ao(e)?e.id:null}function Ae(e,t,a){L.contentWindow?.postMessage({type:"shaderops/action",projectId:e,action:t,payload:a},"*")}function je(e,t,a,n){L.contentWindow?.postMessage({type:"shaderops/set-param",projectId:e,id:t,value:a,commit:n},"*")}function Ot(e,t,a,n=!0){L.contentWindow?.postMessage({type:"shaderops/set-state",projectId:e,payload:{params:t,extras:a},commit:n},"*")}function Ui(e,t=1500){return new Promise(a=>{const n=()=>a(!0),o=Xe.get(e)||[];o.push(n),Xe.set(e,o),setTimeout(()=>{const i=Xe.get(e);!i||!i.includes(n)||(Xe.set(e,i.filter(l=>l!==n)),a(!1))},t)})}const Ta=new Map,Rt=new Map;function no(e){return`${li}${e}`}function Ia(){return{loaded:!0,name:He,sourcePath:ut}}function oo(e){if(!Me(e))return Ia();const t=e.loaded!==!1,a=typeof e.name=="string"&&e.name.trim()?e.name.trim():He,n=typeof e.sourcePath=="string"&&e.sourcePath.trim()?e.sourcePath.trim():ut;return t?{loaded:!0,name:a,sourcePath:n}:Ia()}function Ni(e,t){k.setItem(no(e),JSON.stringify(t))}function Ya(e,t){const a=oo(t);return Ta.set(e,a),Ni(e,a),a}function Yt(e){const t=Ta.get(e);if(t)return t;const a=fe(k.getItem(no(e)),null),n=oo(a);return Ta.set(e,n),n}function Jt(e){return Array.isArray(e)&&e.some(t=>t&&t.type==="image-loader")}function _i(e){return new Promise((t,a)=>{const n=new Image;n.onload=()=>{const i=Math.min(1,1024/Math.max(n.width,n.height)),l=Math.max(1,Math.floor(n.width*i)),s=Math.max(1,Math.floor(n.height*i)),c=document.createElement("canvas");c.width=l,c.height=s;const u=c.getContext("2d",{willReadFrequently:!0});u.drawImage(n,0,0,l,s),t({imageData:u.getImageData(0,0,l,s),dataUrl:c.toDataURL("image/png")})},n.onerror=()=>a(new Error(`Unable to decode image source: ${e.slice(0,64)}`)),n.src=e})}function Oi(e){return e===ut?Jo:e}async function zi(e){const t=typeof e=="string"&&e.trim()?e.trim():ut,a=t;if(!Rt.has(a)){const n=Oi(t);Rt.set(a,_i(n).then(({imageData:o})=>o))}return Rt.get(a)}async function Ja(e,t,a){if(!e||!a||!a.loaded||!a.sourcePath)return!1;const n=await zi(a.sourcePath);return e.postMessage({type:"shaderops/image-load",projectId:t,name:a.name||He,sourcePath:a.sourcePath,imageData:n},"*"),!0}async function zt(e,t=L.contentWindow){const a=Ya(e,Ia());await Ja(t,e,a),r.selectedId===e&&ae(e)}async function Hi(e,t=L.contentWindow){const a=Yt(e);try{if(await Ja(t,e,a)){r.selectedId===e&&ae(e);return}}catch(n){console.warn(`ShaderOps: failed to restore image source for ${e}, falling back to Default.`,n)}await zt(e,t)}async function qi(e,t,a,n=L.contentWindow){const o=typeof t=="string"?t.trim():"";if(!o){await zt(e,n);return}const i=Ya(e,{loaded:!0,name:a||He,sourcePath:o});try{await Ja(n,e,i)}catch(l){console.warn(`ShaderOps: checkpoint image path restore failed for ${e}; using Default.`,l),await zt(e,n);return}r.selectedId===e&&ae(e)}let ce=null;function Gi(e){ce&&ce.remove(),ce=document.createElement("input"),ce.type="file",ce.accept="image/*",ce.style.display="none",document.body.appendChild(ce),ce.addEventListener("change",()=>{const t=ce.files&&ce.files[0];if(!t)return;const a=URL.createObjectURL(t),n=new Image;n.onload=()=>{const i=Math.min(1,1024/Math.max(n.width,n.height)),l=Math.max(1,Math.floor(n.width*i)),s=Math.max(1,Math.floor(n.height*i)),c=document.createElement("canvas");c.width=l,c.height=s;const u=c.getContext("2d",{willReadFrequently:!0});u.drawImage(n,0,0,l,s);const d=u.getImageData(0,0,l,s),f=c.toDataURL("image/png");Ya(e,{loaded:!0,name:t.name||"image",sourcePath:f}),Rt.set(f,Promise.resolve(d)),L.contentWindow?.postMessage({type:"shaderops/image-load",projectId:e,name:t.name,sourcePath:f,imageData:d},"*"),URL.revokeObjectURL(a),r.selectedId===e&&ae(e)},n.onerror=()=>URL.revokeObjectURL(a),n.src=a}),ce.click()}function Wi(e){zt(e,L.contentWindow)}function io(e){It.querySelector(".icon-play").classList.toggle("is-hidden",!e),It.querySelector(".icon-pause").classList.toggle("is-hidden",!!e),It.title=e?"Resume (Space)":"Pause (Space)"}function ro(){dt.hidden=!1,Yn.hidden=!1}function va(){dt.hidden=!0,Yn.hidden=!0}function lo(e){return`shaderops:locked-controls:${e}`}function so(e){const t=fe(k.getItem(lo(e)),[]);return new Set(Array.isArray(t)?t:[])}function Ft(e,t){k.setItem(lo(e),JSON.stringify([...t]))}function ga(){return`<svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  </svg>`}function Zt(e){const t=q.get(e);if(!t)return;const a={};t.lockedIds.forEach(n=>{n in t.params&&(a[n]=t.params[n])}),t.pendingLockRestore=Object.keys(a).length?a:null,Ae(e,"randomizeAll")}function co(e){return`shaderops:unified-checkpoints:${e}`}function Ge(e){const t=fe(k.getItem(co(e)),null);return t&&Array.isArray(t.slots)?{slots:t.slots,nextId:t.nextId||t.slots.length+1,activeId:t.activeId??null}:{slots:[],nextId:1,activeId:null}}function Qt(e,t){k.setItem(co(e),JSON.stringify(t))}function uo(e,t){try{return JSON.parse(JSON.stringify(e))}catch{return t}}async function fo(e){return e!==r.selectedId||await la(),r.previews[e]||null}function Ra(e,t){const a=q.get(e);if(!a)return;const n=Ge(e),o=n.slots.find(s=>s.id===t);if(!o)return;const i={};Object.entries(o.values||{}).forEach(([s,c])=>{s in a.params&&(i[s]=c)}),Object.assign(a.params,i);const l=o.extras&&typeof o.extras=="object";l&&Object.assign(a.extras,o.extras),Ot(e,i,l?o.extras:void 0,!0),o.filters&&Array.isArray(o.filters.stack)&&(P(e),r.filterPreviewOn[e]=o.filters.previewOn!==!1,en(e,JSON.stringify(o.filters.stack))),Jt(a.schema)&&Object.prototype.hasOwnProperty.call(o,"imagePath")&&qi(e,o.imagePath,o.imageName,L.contentWindow),n.activeId=t,Qt(e,n),r.selectedId===e&&Za(e),Et(e)}async function ji(e,t){const a=q.get(e);if(!a)return;const n=Ge(e),o=n.slots.find(i=>i.id===t);if(o){if(o.values={...a.params},o.extras=uo(a.extras||{},{}),o.filters={stack:JSON.parse(ft(e)),previewOn:Te(e)},Jt(a.schema)){const i=Yt(e);o.imagePath=i.sourcePath||ut,o.imageName=i.name||He}o.preview=await fo(e),n.activeId=t,Qt(e,n),Et(e)}}function Vi(e,t){const a=Ge(e);a.slots=a.slots.filter(n=>n.id!==t),a.activeId===t&&(a.activeId=null),Qt(e,a),Et(e)}async function Xi(e){const t=q.get(e);if(!t)return;const a=Ge(e),n=a.nextId++,o=await fo(e),i={id:n,values:{...t.params},extras:uo(t.extras||{},{}),filters:{stack:JSON.parse(ft(e)),previewOn:Te(e)},preview:o};if(Jt(t.schema)){const l=Yt(e);i.imagePath=l.sourcePath||ut,i.imageName=l.name||He}a.slots.push(i),a.activeId=n,Qt(e,a),Et(e)}function po(e,{onTap:t,onHoldComplete:a,holdMs:n=800}={}){const o=e.querySelector(".ucp-ring");let i=null,l=!1,s=!1;const c=()=>{i&&(clearTimeout(i),i=null),e.classList.remove("holding")},u=p=>{p.button!==void 0&&p.button!==0||(l=!0,s=!1,e.classList.add("holding"),o&&o.style.setProperty("--ucp-ring-duration",`${n}ms`),i=setTimeout(()=>{s=!0,e.classList.remove("holding"),e.classList.add("completed"),setTimeout(()=>e.classList.remove("completed"),260),a?.()},n))},d=()=>{l&&(l=!1,c(),s||t?.())},f=()=>{l&&(l=!1,c())};e.addEventListener("pointerdown",u),e.addEventListener("pointerup",d),e.addEventListener("pointerleave",f),e.addEventListener("pointercancel",f)}let xe=null;function Ki(){return xe||(xe=document.createElement("div"),xe.className="ucp-menu",xe.hidden=!0,document.body.appendChild(xe),document.addEventListener("click",()=>Fa()),window.addEventListener("blur",()=>Fa()),xe)}function Fa(){xe&&(xe.hidden=!0)}function Yi(e,t,a){const n=Ki();n.innerHTML="",a.forEach(s=>{const c=document.createElement("button");c.type="button",c.className="ucp-menu-item",c.textContent=s.label,c.addEventListener("click",u=>{u.stopPropagation(),Fa(),s.onClick()}),n.appendChild(c)}),n.hidden=!1;const o=n.getBoundingClientRect(),i=Math.min(e,window.innerWidth-o.width-8),l=Math.min(t,window.innerHeight-o.height-8);n.style.left=`${Math.max(8,i)}px`,n.style.top=`${Math.max(8,l)}px`}function Et(e){ha.innerHTML="";const t=Ge(e);t.slots.forEach((a,n)=>{const o=document.createElement("span");o.className="ucp-btn-shell",t.activeId===a.id&&o.classList.add("is-active");const i=document.createElement("button");i.type="button",i.className="ucp-slot",i.textContent=String(n+1),i.title="Tap: load this checkpoint Â· Hold 0.8s: overwrite with the current look Â· Right-click: delete",o.appendChild(i);const l=document.createElementNS("http://www.w3.org/2000/svg","svg");l.setAttribute("viewBox","0 0 30 30"),l.setAttribute("class","ucp-ring"),l.setAttribute("aria-hidden","true");const s=document.createElementNS("http://www.w3.org/2000/svg","circle");s.setAttribute("cx","15"),s.setAttribute("cy","15"),s.setAttribute("r","13.3"),s.setAttribute("pathLength","100"),l.appendChild(s),o.appendChild(l),po(o,{onTap:()=>Ra(e,a.id),onHoldComplete:()=>{ji(e,a.id)}}),o.addEventListener("contextmenu",c=>{c.preventDefault(),Yi(c.clientX,c.clientY,[{label:"Delete checkpoint",onClick:()=>Vi(e,a.id)}])}),ha.appendChild(o)}),ha.appendChild(Jn)}function Ze(e,t){if(!e||!e.showIf)return!0;const a=e.showIf;if(typeof a=="function")try{return!!a(t||{})}catch{return!0}if(typeof a=="string")return!!(t||{})[a];if(Array.isArray(a))return a.every(n=>Ze({showIf:n},t));if(a&&typeof a=="object"){if(Array.isArray(a.all))return a.all.every(n=>Ze({showIf:n},t));if(Array.isArray(a.any))return a.any.some(n=>Ze({showIf:n},t));if(a.eq&&typeof a.eq=="object")return Object.entries(a.eq).every(([n,o])=>String((t||{})[n])===String(o));if(a.neq&&typeof a.neq=="object")return Object.entries(a.neq).every(([n,o])=>String((t||{})[n])!==String(o))}return!0}function ae(e){const t=q.get(e);if(!t)return;t.lockedIds||(t.lockedIds=so(e)),Tt.innerHTML="";const a=new Map;(t.schema||[]).filter(c=>!c.hidden&&Ze(c,t.params)).forEach(c=>{const u=c.group||"Controls";a.has(u)||a.set(u,[]),a.get(u).push(c)});const n=[...Sn.filter(c=>a.has(c)),...[...a.keys()].filter(c=>!Sn.includes(c))],o=`shaderops:unified-group-collapsed:${e}`,i=fe(k.getItem(o),{}),l=(c,u)=>{const d=document.createElement("button");d.type="button",d.className="shaderops-lock-button",d.innerHTML=ga();const f=()=>{const p=t.lockedIds.has(c);d.classList.toggle("is-locked",p),u&&u.classList.toggle("is-locked",p),d.title=p?"Unlock this value":"Lock this value (skip on All Random)"};return f(),d.addEventListener("click",p=>{p.preventDefault(),p.stopPropagation(),t.lockedIds.has(c)?t.lockedIds.delete(c):t.lockedIds.add(c),Ft(e,t.lockedIds),f()}),d},s=(c,u)=>{const d=String(c||"").trim(),f=String(u||"").trim();return f?`${d}
${f}`:d};n.forEach((c,u)=>{const d=a.get(c),f=document.createElement("div");f.className="unified-control-group";const p=c.toLowerCase();i[p]&&f.classList.add("is-collapsed");const h=document.createElement("h3");h.textContent=c,h.setAttribute("role","button"),h.setAttribute("tabindex","0");const v=()=>{f.classList.toggle("is-collapsed"),i[p]=f.classList.contains("is-collapsed"),k.setItem(o,JSON.stringify(i))};if(h.addEventListener("click",v),h.addEventListener("keydown",m=>{(m.key==="Enter"||m.key===" ")&&(m.preventDefault(),v())}),f.appendChild(h),u===0){const m=document.createElement("button");m.type="button",m.className="unified-panel-close",m.title="Collapse controls",m.innerHTML='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" aria-hidden="true"><path d="M3.5 3.5l9 9M12.5 3.5l-9 9"/></svg>',m.addEventListener("click",g=>{g.preventDefault(),g.stopPropagation(),mo()}),h.appendChild(m)}d.forEach(m=>{const g=document.createElement("div");g.dataset.controlId=m.id;const S=document.createElement("label"),D=String(m.label||m.id);if(S.textContent=D,S.title=s(D,m.hint),m.type==="shape-stack"){g.className="filter-param-row filter-param-row--shape-stack";const b=document.createElement("div");b.className="shaderops-shape-stack";const A=Array.isArray(m.shapes)?m.shapes:[],$=t.params[m.selectedParam],w=A.find(ee=>String(ee.value)===String($))||null,E=A.filter(ee=>Number(t.params[ee.enabledParam])>.5),Y=document.createElement("button");if(Y.type="button",Y.className="shaderops-shape-stack-trigger",Y.textContent=w?`${w.label} Â· ${E.length} active`:`${E.length} active`,Y.addEventListener("click",()=>{t.openShapeStackId=t.openShapeStackId===m.id?null:m.id,ae(e)}),b.appendChild(Y),t.openShapeStackId===m.id){const ee=document.createElement("div");ee.className="shaderops-shape-stack-menu",A.forEach(x=>{const H=document.createElement("div");H.className="shaderops-shape-stack-item",w&&String(w.value)===String(x.value)&&H.classList.add("is-selected");const te=document.createElement("input");te.type="checkbox",te.checked=Number(t.params[x.enabledParam])>.5,te.addEventListener("click",M=>M.stopPropagation()),te.addEventListener("change",()=>{const M={[x.enabledParam]:te.checked?1:0};if(te.checked)M[m.selectedParam]=x.value;else if(String(t.params[m.selectedParam])===String(x.value)){const vt=A.find(De=>De!==x&&Number(t.params[De.enabledParam])>.5);M[m.selectedParam]=vt?vt.value:0}Object.assign(t.params,M),Ot(e,M,void 0,!0),ae(e)});const Ce=document.createElement("button");Ce.type="button",Ce.className="shaderops-shape-stack-item-button",Ce.textContent=x.label,Ce.addEventListener("click",()=>{const M={[x.enabledParam]:1,[m.selectedParam]:x.value};Object.assign(t.params,M),Ot(e,M,void 0,!0),ae(e)}),H.appendChild(te),H.appendChild(Ce),ee.appendChild(H)}),b.appendChild(ee)}if(w&&Array.isArray(w.controls)&&Number(t.params[w.enabledParam])>.5){const ee=document.createElement("div");ee.className="shaderops-shape-stack-detail",w.controls.filter(x=>!x.hidden&&Ze(x,t.params)).forEach(x=>{const H=document.createElement("div");H.dataset.controlId=x.id;const te=document.createElement("label"),Ce=String(x.label||x.id);if(te.textContent=Ce,te.title=s(Ce,x.hint),x.type==="select"){H.className="filter-param-row filter-param-row--select";const U=document.createElement("select");U.className="filter-param-select";const gt=t.params[x.id]??x.default??0;(x.options||[]).forEach($e=>{const Ue=document.createElement("option");Ue.value=String($e.value),Ue.textContent=$e.label,String($e.value)===String(gt)&&(Ue.selected=!0),U.appendChild(Ue)}),U.addEventListener("change",()=>{const $e=U.value,Ue=Number($e),mn=Number.isFinite(Ue)&&$e.trim()!==""?Ue:$e;t.params[x.id]=mn,je(e,x.id,mn,!0)});const Fe=document.createElement("span");Fe.className="shaderops-lock-wrap shaderops-lock-wrap--aux shaderops-lock-wrap--full",Fe.appendChild(U),Fe.appendChild(l(x.id,Fe)),H.appendChild(te),H.appendChild(Fe),ee.appendChild(H);return}H.className="filter-param-row";const M=document.createElement("input");M.type="range",M.min=String(x.min??0),M.max=String(x.max??1),M.step=String(x.step??.01),x.pillMode&&(M.dataset.pillMode=String(x.pillMode));const vt=t.params[x.id]??x.default??0;M.value=String(vt);const De=document.createElement("span");De.className="shaderops-lock-wrap";const Ie=document.createElement("input");Ie.type="number",Ie.step=M.step,Ie.value=String(vt);const Re=document.createElement("button");Re.type="button",Re.className="shaderops-lock-button",Re.innerHTML=ga();const pn=()=>{const U=t.lockedIds.has(x.id);Re.classList.toggle("is-locked",U),De.classList.toggle("is-locked",U),Re.title=U?"Unlock this value":"Lock this value (skip on All Random)"};pn(),Re.addEventListener("click",U=>{U.preventDefault(),U.stopPropagation(),t.lockedIds.has(x.id)?t.lockedIds.delete(x.id):t.lockedIds.add(x.id),Ft(e,t.lockedIds),pn()});const fa=(U,gt)=>{t.params[x.id]=U,je(e,x.id,U,gt)};M.addEventListener("input",()=>{const U=Number(M.value);Ie.value=M.value,fa(U,!1)}),M.addEventListener("change",()=>{fa(Number(M.value),!0)}),Ie.addEventListener("change",()=>{let U=Number(Ie.value);Number.isFinite(U)||(U=Number(M.value));const gt=Number(M.min),Fe=Number(M.max);M.value=String(Math.min(Fe,Math.max(gt,U))),fa(U,!0)}),De.appendChild(Ie),De.appendChild(Re),H.appendChild(te),H.appendChild(M),H.appendChild(De),ee.appendChild(H)}),b.appendChild(ee)}g.appendChild(S),g.appendChild(b),f.appendChild(g);return}if(m.type==="image-loader"){g.className="filter-param-row filter-param-row--image-loader";const b=Yt(e),A=document.createElement("button");A.type="button",A.className="image-loader-load",A.textContent="Load Image",A.title="Load an image â€” strokes will sample its colors",A.addEventListener("click",()=>Gi(e));const $=document.createElement("span");$.className="image-loader-name",$.textContent=b.loaded?b.name:He,$.title=b.loaded?b.name:"Using default image";const w=document.createElement("button");w.type="button",w.className="image-loader-clear",w.textContent="✕",w.title="Reset to Default image",w.hidden=!b.loaded,w.addEventListener("click",()=>Wi(e));const E=document.createElement("span");E.className="image-loader-wrap",E.appendChild(A),E.appendChild($),E.appendChild(w),g.appendChild(S),g.appendChild(E),f.appendChild(g);return}if(m.type==="toggle"){g.className="filter-param-row filter-param-row--toggle";const b=Number(t.params[m.id]??m.default??0)>.5,A=document.createElement("label");A.className="filter-param-switch",A.innerHTML=`
        ...
        `;const $=A.querySelector(".filter-param-toggle");$.addEventListener("change",()=>{const E=$.checked?1:0;t.params[m.id]=E,je(e,m.id,E,!0),ae(e)});const w=document.createElement("span");w.className="shaderops-lock-wrap shaderops-lock-wrap--aux",w.appendChild(A),w.appendChild(l(m.id,w)),g.appendChild(S),g.appendChild(w),f.appendChild(g);return}if(m.type==="select"){g.className="filter-param-row filter-param-row--select";const b=document.createElement("select");b.className="filter-param-select";const A=t.params[m.id]??m.default??0;(m.options||[]).forEach(w=>{const E=document.createElement("option");E.value=String(w.value),E.textContent=w.label,String(w.value)===String(A)&&(E.selected=!0),b.appendChild(E)}),b.addEventListener("change",()=>{const w=b.value,E=Number(w),Y=Number.isFinite(E)&&w.trim()!==""?E:w;t.params[m.id]=Y,je(e,m.id,Y,!0),ae(e)});const $=document.createElement("span");$.className="shaderops-lock-wrap shaderops-lock-wrap--aux shaderops-lock-wrap--full",$.appendChild(b),$.appendChild(l(m.id,$)),g.appendChild(S),g.appendChild($),f.appendChild(g);return}g.className="filter-param-row";const y=document.createElement("input");y.type="range",y.min=String(m.min??0),y.max=String(m.max??1),y.step=String(m.step??.01),m.pillMode&&(y.dataset.pillMode=String(m.pillMode));const V=t.params[m.id]??m.default??0;y.value=String(V);const le=document.createElement("span");le.className="shaderops-lock-wrap";const Q=document.createElement("input");Q.type="number",Q.step=y.step,Q.value=String(V);const se=document.createElement("button");se.type="button",se.className="shaderops-lock-button",se.innerHTML=ga();const ht=()=>{const b=t.lockedIds.has(m.id);se.classList.toggle("is-locked",b),le.classList.toggle("is-locked",b),se.title=b?"Unlock this value":"Lock this value (skip on All Random)"};ht(),se.addEventListener("click",b=>{b.preventDefault(),b.stopPropagation(),t.lockedIds.has(m.id)?t.lockedIds.delete(m.id):t.lockedIds.add(m.id),Ft(e,t.lockedIds),ht()});const We=(b,A)=>{t.params[m.id]=b,je(e,m.id,b,A)};y.addEventListener("input",()=>{const b=Number(y.value);Q.value=y.value,We(b,!1)}),y.addEventListener("change",()=>{We(Number(y.value),!0)}),Q.addEventListener("change",()=>{let b=Number(Q.value);Number.isFinite(b)||(b=Number(y.value));const A=Number(y.min),$=Number(y.max);y.value=String(Math.min($,Math.max(A,b))),We(b,!0)}),le.appendChild(Q),le.appendChild(se),g.appendChild(S),g.appendChild(y),g.appendChild(le),f.appendChild(g)}),Tt.appendChild(f)}),Ga(Tt),io(!!t.extras.paused),Et(e)}function Za(e){const t=q.get(e);if(t){if((t.schema||[]).some(a=>a.type==="shape-stack")){ae(e);return}Tt.querySelectorAll(".filter-param-row").forEach(a=>{const n=a.dataset.controlId;if(!(n in t.params))return;const o=a.querySelector('input[type="range"]'),i=a.querySelector('input[type="number"]'),l=a.querySelector("select.filter-param-select"),s=a.querySelector("input.filter-param-toggle"),c=t.params[n];o&&document.activeElement!==o&&(o.value=String(c)),i&&document.activeElement!==i&&(i.value=String(c)),l&&document.activeElement!==l&&(l.value=String(c)),s&&document.activeElement!==s&&(s.checked=Number(c)>.5)}),io(!!t.extras.paused)}}function Ji(e,t=null){const{type:a,projectId:n}=e;if(n){if(a==="shaderops/ready"){const o=Array.isArray(e.schema)?e.schema:[];if(q.set(n,{schema:o,params:{...e.values||{}},extras:{...e.extras||{}},lockedIds:so(n)}),Jt(o)){const i=t&&typeof t.postMessage=="function"?t:L.contentWindow;Hi(n,i)}r.selectedId===n&&(ae(n),ro(),Qe())}else if(a==="shaderops/values-changed"){const o=q.get(n);if(!o)return;if(e.values&&Object.assign(o.params,e.values),e.extras&&Object.assign(o.extras,e.extras),o.pendingLockRestore){const l=o.pendingLockRestore;o.pendingLockRestore=null,Object.entries(l).forEach(([s,c])=>{o.params[s]=c,je(n,s,c,!0)})}const i=Xe.get(n);i&&i.length&&(Xe.set(n,[]),i.forEach(l=>{try{l()}catch{}})),r.selectedId===n&&Za(n)}else if(a==="shaderops/keydown"){if(r.selectedId!==n)return;e.key==="r"?Zt(n):e.key==="space"&&Ae(n,"togglePause")}}}Di.addEventListener("click",()=>{dt.classList.remove("is-collapsed"),k.setItem(Ka,"0")});function mo(){dt.classList.add("is-collapsed"),k.setItem(Ka,"1")}dt.addEventListener("dblclick",e=>{e.target.closest(".unified-panel-body")||mo()});Ei.addEventListener("click",()=>{const e=qe();e&&Zt(e)});Mi.addEventListener("click",()=>{const e=qe();e&&Ae(e,"rerollSeed")});It.addEventListener("click",()=>{const e=qe();e&&Ae(e,"togglePause")});Bi.addEventListener("click",()=>{const e=qe();e&&Ae(e,"undo")});Li.addEventListener("click",()=>{const e=qe();e&&Ae(e,"redo")});Pi?.addEventListener("click",()=>{window.location.reload()});po(Jn,{onHoldComplete:()=>{const e=qe();e&&Xi(e)}});document.addEventListener("keydown",e=>{const t=qe();t&&(e.target?.matches("input, textarea, select, button")||((e.key==="r"||e.key==="R")&&!e.metaKey&&!e.ctrlKey&&!e.altKey?(e.preventDefault(),Zt(t)):e.code==="Space"&&(e.preventDefault(),Ae(t,"togglePause"))))});k.getItem(Ka)==="1"&&dt.classList.add("is-collapsed");function fe(e,t){if(e==null)return t;try{const a=JSON.parse(e);return a??t}catch{return t}}function Me(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}function Zi(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";let t="";for(let a=0;a<3;a++)t+=e[Math.floor(Math.random()*e.length)];return t}function ho(e,t=""){const a=new Date,n=String(a.getFullYear()),o=String(a.getMonth()+1).padStart(2,"0"),i=String(a.getDate()).padStart(2,"0"),l=String(a.getHours()).padStart(2,"0"),s=String(a.getMinutes()).padStart(2,"0"),c=String(a.getSeconds()).padStart(2,"0"),u=String(t||"").trim(),d=u?`-${u}`:"";return`${e||"shader"}-${n}${o}${i}-${l}${s}${c}${d}-${Zi()}.png`}function Qi(e){const t=q.get(e),a=JSON.parse(ft(e));return{source:"shaderops-png-state",schemaVersion:ka,exportedAt:new Date().toISOString(),projectId:e,bridge:{params:t?{...t.params}:{},extras:t?{...t.extras}:{},lockedIds:t&&t.lockedIds?[...t.lockedIds]:[]},filters:{previewOn:Te(e),stack:Array.isArray(a)?a:[]}}}function er(e,t=2500){return q.has(e)?Promise.resolve(!0):new Promise(a=>{const n=performance.now(),o=()=>{if(q.has(e)){a(!0);return}if(performance.now()-n>=t){a(!1);return}requestAnimationFrame(o)};o()})}const Oe=new Uint8Array([137,80,78,71,13,10,26,10]),Ht=new TextEncoder,vo=new TextDecoder,tr=(()=>{const e=new Uint32Array(256);for(let t=0;t<256;t++){let a=t;for(let n=0;n<8;n++)a=a&1?3988292384^a>>>1:a>>>1;e[t]=a>>>0}return e})();function ar(e){let t=4294967295;for(let a=0;a<e.length;a++)t=tr[(t^e[a])&255]^t>>>8;return(t^4294967295)>>>0}function nr(e,t){const a=new Uint8Array(12+t.length),n=new DataView(a.buffer);n.setUint32(0,t.length),a.set(e,4),a.set(t,8);const o=new Uint8Array(4+t.length);return o.set(e,0),o.set(t,4),n.setUint32(8+t.length,ar(o)),a}function or(e){const t=e.reduce((o,i)=>o+i.length,0),a=new Uint8Array(t);let n=0;for(const o of e)a.set(o,n),n+=o.length;return a}function ir(e){if(!e||typeof e!="string")return null;const t=e.indexOf(",");if(t===-1)return null;const a=e.slice(t+1),n=atob(a),o=new Uint8Array(n.length);for(let i=0;i<n.length;i++)o[i]=n.charCodeAt(i);return o}function rr(e,t){const a=Ht.encode(e),n=Ht.encode(t),o=new Uint8Array(a.length+5+n.length);o.set(a,0);let i=a.length;return o[i++]=0,o[i++]=0,o[i++]=0,o[i++]=0,o[i++]=0,o.set(n,i),o}function lr(e,t,a){if(!e||e.length<12)throw new Error("PNG data is empty.");for(let u=0;u<Oe.length;u++)if(e[u]!==Oe[u])throw new Error("Exported image is not a valid PNG.");const n=Ht.encode(t),o=Ht.encode("iTXt"),i=nr(o,rr(t,a)),l=[Oe];let s=Oe.length,c=!1;for(;s+12<=e.length;){const d=new DataView(e.buffer,e.byteOffset+s,8).getUint32(0),f=s+4,p=s+8,h=d+12;if(s+h>e.length)throw new Error("PNG chunk stream is truncated.");const v=e.subarray(f,f+4),m=e.subarray(p,p+d),S=v[0]===105&&v[1]===84&&v[2]===88&&v[3]===116&&m.length>=n.length+1&&m.subarray(0,n.length).every((y,V)=>y===n[V])&&m[n.length]===0,D=v[0]===73&&v[1]===69&&v[2]===78&&v[3]===68;S||(!c&&D&&(l.push(i),c=!0),l.push(e.subarray(s,s+h))),s+=h}return c||l.push(i),or(l)}function ba(e,t){let a=t;for(;a<e.length&&e[a]!==0;)a+=1;return{text:vo.decode(e.subarray(t,a)),next:a+1}}function sr(e,t){if(!e||e.length<12)return null;for(let n=0;n<Oe.length;n++)if(e[n]!==Oe[n])return null;let a=Oe.length;for(;a+12<=e.length;){const o=new DataView(e.buffer,e.byteOffset+a,8).getUint32(0),i=a+4,l=a+8,s=o+12;if(a+s>e.length)return null;const c=e.subarray(i,i+4),u=e.subarray(l,l+o),d=String.fromCharCode(c[0],c[1],c[2],c[3]);if(d==="iTXt"){const f=ba(u,0);if(f.text===t&&f.next+3<=u.length){const p=u[f.next];let h=f.next+2;if(h=ba(u,h).next,h=ba(u,h).next,p===0&&h<=u.length)return vo.decode(u.subarray(h))}}if(d==="IEND")break;a+=s}return null}function cr(e){return Me(e)?{stack:(Array.isArray(e.stack)?e.stack:[]).map(n=>!Me(n)||typeof n.defId!="string"||!Pe(n.defId)?null:{instanceId:typeof n.instanceId=="string"?n.instanceId:`f${Date.now()}_${yo++}`,defId:n.defId,enabled:n.enabled!==!1,collapsed:!!n.collapsed,params:{...Na(n.defId),...Me(n.params)?n.params:{}}}).filter(Boolean),previewOn:e.previewOn!==!1}:null}async function ur(e){if(!Me(e))throw new Error("PNG metadata is invalid JSON.");const t=Number(e.schemaVersion)||1;t>ka&&console.warn(`PNG state schema v${t} is newer than this app (v${ka}); applying compatible fields only.`);const a=typeof e.projectId=="string"?e.projectId:null,o=a&&r.projects.some(c=>c.id===a)?a:r.selectedId;if(!o)throw new Error("No target project is available for restore.");if(r.selectedId!==o&&await ln(o),!await er(o))throw new Error("Project controls are not ready yet. Please try dropping the PNG again.");const l=q.get(o);if(l&&Me(e.bridge)){const c=Me(e.bridge.params)?{...e.bridge.params}:{},u=Me(e.bridge.extras)?{...e.bridge.extras}:void 0;Ot(o,c,u,!0),Object.assign(l.params,c),u&&Object.assign(l.extras,u),Array.isArray(e.bridge.lockedIds)&&(l.lockedIds=new Set(e.bridge.lockedIds.filter(d=>typeof d=="string")),Ft(o,l.lockedIds)),r.selectedId===o&&Za(o)}const s=cr(e.filters);s&&(r.filterStacks[o]=s.stack,r.filterPreviewOn[o]=s.previewOn,pe(),r.selectedId===o&&R()),be()}async function dr(e){if(!e||!/\.png$/i.test(e.name||""))return!1;const t=new Uint8Array(await e.arrayBuffer()),a=sr(t,jn);if(!a)return!1;const n=fe(a,null);if(!n)throw new Error("PNG state chunk exists but contains invalid JSON.");return await ur(n),!0}function fr(){const e=fe(k.getItem(On),{});r.previews=e&&typeof e=="object"&&!Array.isArray(e)?e:{}}function pr(){const e=fe(k.getItem(Hn),[]);r.favorites=Array.isArray(e)?e:[]}function go(){k.setItem(Hn,JSON.stringify(r.favorites))}function Qa(){k.setItem(qn,JSON.stringify(r.projects.map(e=>e.id)))}function mr(){const e=fe(k.getItem(qn),null);if(!Array.isArray(e)||e.length===0)return;const t=new Map(r.projects.map(i=>[i.id,i])),a=e.map(i=>t.get(i)).filter(Boolean),n=new Set(a.map(i=>i.id)),o=r.projects.filter(i=>!n.has(i.id));r.projects=[...a,...o]}function hr(){const e=fe(k.getItem(Gn),null);r.filterAddOrder=e&&typeof e=="object"?e:{}}function vr(){k.setItem(Gn,JSON.stringify(r.filterAddOrder))}function gr(e,t){const a=r.filterAddOrder&&r.filterAddOrder[e];if(!Array.isArray(a)||a.length===0)return t;const n=new Map(t.map(s=>[s.id,s])),o=a.map(s=>n.get(s)).filter(Boolean),i=new Set(o.map(s=>s.id)),l=t.filter(s=>!i.has(s.id));return[...o,...l]}function ea(){const e={...r.previews};let t=Object.keys(e);for(let a=0;a<=t.length;a++)try{k.setItem(On,JSON.stringify(e));return}catch(n){const o=t.find(i=>i!==r.selectedId&&e[i]);if(!o){console.warn("ShaderOps: preview storage quota exceeded; skipping persistence this cycle.",n);return}delete e[o],t=t.filter(i=>i!==o)}}function bo(e,t=320,a=.72){return new Promise(n=>{if(!e||typeof e!="string"||!e.startsWith("data:image")){n(e);return}const o=new Image;o.onload=()=>{const i=Math.min(1,t/(o.width||t)),l=Math.max(1,Math.round((o.width||t)*i)),s=Math.max(1,Math.round((o.height||t)*i));try{const c=document.createElement("canvas");c.width=l,c.height=s,c.getContext("2d").drawImage(o,0,0,l,s),n(c.toDataURL("image/jpeg",a))}catch{n(e)}},o.onerror=()=>n(e),o.src=e})}function br(){const e=fe(k.getItem(zn),{}),t=e&&typeof e=="object"&&!Array.isArray(e)?e:{};Object.entries(t).forEach(([a,n])=>{if(!n||typeof n!="object")return;const o=Array.isArray(n.stack)?n.stack:[];r.filterStacks[a]=o.map(i=>!i||typeof i!="object"?i:{...i,params:{...Na(i.defId),...i.params}}),r.filterPreviewOn[a]=n.previewOn!==!1}),Va.classList.toggle("collapsed",k.getItem(qa)==="1")}function pe(){const e={};Object.keys(r.filterStacks).forEach(t=>{e[t]={stack:r.filterStacks[t],previewOn:r.filterPreviewOn[t]!==!1}}),k.setItem(zn,JSON.stringify(e))}function G(e){return r.filterStacks[e]||(r.filterStacks[e]=[]),r.filterStacks[e]}function Te(e){return r.filterPreviewOn[e]!==!1}function Cn(e){return e?Te(e)&&G(e).some(t=>t&&t.enabled):!1}function ta(e){return r.filterHistory[e]||(r.filterHistory[e]={undoStack:[],redoStack:[],suppress:!1,limit:100}),r.filterHistory[e]}function ft(e){return JSON.stringify(G(e))}function P(e,t){if(!e)return;const a=ta(e);if(a.suppress)return;const n=ft(e);a.undoStack[a.undoStack.length-1]!==n&&(a.undoStack.push(n),a.undoStack.length>a.limit&&a.undoStack.shift(),a.redoStack.length=0)}function en(e,t){const a=ta(e);let n;try{n=JSON.parse(t)}catch{return}a.suppress=!0,r.filterStacks[e]=n,r.filterPreviewOn[e]===void 0&&(r.filterPreviewOn[e]=!0),pe(),R(),!C.hidden&&z&&r.selectedId===e&&de(),!B.hidden&&O&&r.selectedId===e&&Se(),a.suppress=!1}function yr(e){if(!e)return;const t=ta(e);if(t.undoStack.length===0)return;const a=ft(e),n=t.undoStack.pop();t.redoStack.push(a),en(e,n)}function xr(e){if(!e)return;const t=ta(e);if(t.redoStack.length===0)return;const a=ft(e),n=t.redoStack.pop();t.undoStack.push(a),en(e,n)}let yo=1;function wr(e,t){if(!Pe(t))return;P(e),G(e).unshift({instanceId:`f${Date.now()}_${yo++}`,defId:t,enabled:!0,collapsed:!1,params:Na(t)}),r.filterPreviewOn[e]===void 0&&(r.filterPreviewOn[e]=!0),pe(),R()}function kr(e,t){const a=G(e),n=a.findIndex(o=>o.instanceId===t);n!==-1&&(P(e),a.splice(n,1),pe(),R())}function Sr(e,t){const n=G(e).find(o=>o.instanceId===t);n&&(P(e),n.enabled=!n.enabled,pe(),R())}function Cr(e,t){const n=G(e).find(o=>o.instanceId===t);n&&(n.collapsed=!n.collapsed,pe(),R())}function ke(e,t,a,n,o){const l=G(e).find(s=>s.instanceId===t);l&&(o||P(e),l.params[a]=n,pe())}const Dr={oilPaint:{key:"preset",values:{custom:null,paletteKnife:{brushType:"palette",brushSize:10.5,strokeStrength:.84,detail:.74,edgeBlend:.33,strokePresence:.86,mix:.92},softBrush:{brushType:"round",brushSize:14,strokeStrength:.62,detail:.52,edgeBlend:.72,strokePresence:.56,mix:.78}}},filmEmulation:{key:"stock",values:{neutral:{grain:.35,grainSize:1.1,grainAnimated:!0,halation:.25,haloSize:2.6,contrast:.05,saturation:1,fade:.02,temperature:0,tint:0,vignette:.25},portra:{grain:.45,grainSize:1.4,grainAnimated:!0,halation:.55,haloSize:3.2,contrast:.12,saturation:1,fade:.08,temperature:0,tint:0,vignette:.4},velvia:{grain:.38,grainSize:1.2,grainAnimated:!0,halation:.4,haloSize:2.8,contrast:.28,saturation:1.45,fade:.05,temperature:.05,tint:.03,vignette:.45},trix:{grain:.9,grainSize:1,grainAnimated:!0,halation:.2,haloSize:2.3,contrast:.45,saturation:0,fade:.1,temperature:-.02,tint:.02,vignette:.55},cinestill:{grain:.65,grainSize:1.8,grainAnimated:!0,halation:1.4,haloSize:4.5,contrast:.18,saturation:1.05,fade:.1,temperature:-.2,tint:.05,vignette:.5},bleach:{grain:.5,grainSize:1.3,grainAnimated:!0,halation:.35,haloSize:2.8,contrast:.6,saturation:.55,fade:.03,temperature:0,tint:0,vignette:.62}}}};function Er(e,t,a,n){const i=G(e).find(c=>c.instanceId===t);if(!i)return;const l=Dr[i.defId||i.filterId];if(!l||l.key!==a)return;const s=l.values?.[String(n)];!s||typeof s!="object"||Object.entries(s).forEach(([c,u])=>{ke(e,t,c,u,!0)})}const Dn=["Color","Distort","Blur","Effect"];function Mr(){const e=new Map;Un.forEach(a=>{const n=a.group||"Other";e.has(n)||e.set(n,[]),e.get(n).push(a)});const t=[...Dn.filter(a=>e.has(a)),...[...e.keys()].filter(a=>!Dn.includes(a))];J.innerHTML=t.map(a=>`
        ...
        </div>`).join(""),J.querySelectorAll(".filter-add-grid[data-group]").forEach(a=>{Br(a,a.dataset.group)})}function Br(e,t){let a=null;e.addEventListener("dragstart",n=>{const o=n.target.closest(".filter-add-option");if(!o){n.preventDefault();return}a=o,o.classList.add("dragging"),n.dataTransfer.effectAllowed="move",n.dataTransfer.setData("text/plain",o.dataset.filterId)}),e.addEventListener("dragover",n=>{if(!a)return;n.preventDefault(),n.dataTransfer.dropEffect="move";const o=n.target.closest(".filter-add-option");if(!o||o===a){o||e.appendChild(a);return}const i=o.getBoundingClientRect();n.clientX<i.left+i.width/2?o.parentNode.insertBefore(a,o):o.parentNode.insertBefore(a,o.nextSibling)}),e.addEventListener("drop",n=>{if(n.preventDefault(),!a)return;const o=[...e.querySelectorAll(".filter-add-option")].map(i=>i.dataset.filterId);r.filterAddOrder[t]=o,vr()}),e.addEventListener("dragend",()=>{a=null,e.querySelectorAll(".filter-add-option.dragging").forEach(n=>n.classList.remove("dragging"))})}document.body.appendChild(J);function xo(){const e=Kt.getBoundingClientRect(),t=J.querySelectorAll(".filter-add-group").length||4,a=t*150+(t-1)*14+20,n=Math.max(320,Math.min(a,window.innerWidth-16));let o=e.right-n;o=Math.max(8,Math.min(o,window.innerWidth-n-8)),J.style.width=`${n}px`,J.style.left=`${o}px`,J.style.top=`${e.bottom+6}px`}function Lr(){xo(),J.hidden=!1,Kt.classList.add("open")}function aa(){J.hidden=!0,Kt.classList.remove("open")}window.addEventListener("resize",()=>{J.hidden||xo()});function wo(e,t,a,n=48){let o="";for(let i=0;i<=n;i++){const l=i/n,s=Go(e,l),c=l*t,u=(1-s)*a;o+=i===0?`M${c.toFixed(2)},${u.toFixed(2)}`:` L${c.toFixed(2)},${u.toFixed(2)}`}return o}function ko(e,t,a,n,o,i=56){const l=Math.max(0,Math.min(.99,e)),s=Math.max(l+.001,Math.min(1,a)),c=Math.max(.05,t);let u="";for(let d=0;d<=i;d++){const f=d/i,p=Math.max(0,Math.min(1,(f-l)/(s-l))),h=Math.pow(p,1/c),v=f*n,m=(1-h)*o;u+=d===0?`M${v.toFixed(2)},${m.toFixed(2)}`:` L${v.toFixed(2)},${m.toFixed(2)}`}return u}function So(e,t,a){const n=Math.max(0,Math.min(.99,e)),o=Math.max(n+.001,Math.min(1,a)),i=Math.max(.05,t),l=n+(o-n)*Math.pow(.5,i);return{black:n,mid:Math.max(n,Math.min(o,l)),white:o}}function tn(e){if(!e)return;const t=N.querySelector(`.filter-levels-graph[data-instance-id="${e}"]`);if(!t)return;const a=(m,g)=>{const S=N.querySelector(`input[data-instance-id="${e}"][data-param-key="${m}"]`),D=S?Number(S.value):g;return Number.isFinite(D)?D:g},n=a("blackPoint",0),o=a("gamma",1),i=a("whitePoint",1),l=t.querySelector(".filter-levels-curve"),s=t.querySelector(".filter-levels-marker--black"),c=t.querySelector(".filter-levels-marker--mid"),u=t.querySelector(".filter-levels-marker--white"),d=t.querySelector('.filter-levels-handle[data-handle="black"]'),f=t.querySelector('.filter-levels-handle[data-handle="mid"]'),p=t.querySelector('.filter-levels-handle[data-handle="white"]');if(!l||!s||!c||!u)return;const h=ko(n,o,i,100,46,56),v=So(n,o,i);l.setAttribute("d",h),s.setAttribute("x1",(v.black*100).toFixed(2)),s.setAttribute("x2",(v.black*100).toFixed(2)),c.setAttribute("x1",(v.mid*100).toFixed(2)),c.setAttribute("x2",(v.mid*100).toFixed(2)),u.setAttribute("x1",(v.white*100).toFixed(2)),u.setAttribute("x2",(v.white*100).toFixed(2)),d&&(d.style.left=`${(v.black*100).toFixed(2)}%`),f&&(f.style.left=`${(v.mid*100).toFixed(2)}%`),p&&(p.style.left=`${(v.white*100).toFixed(2)}%`)}function ya(e,t,a){ke(r.selectedId,e,t,a,!0),N.querySelectorAll(`input[data-instance-id="${e}"][data-param-key="${t}"]`).forEach(n=>{n.value=a})}function Pr(e,t){const a=e.params[t.key];if(t.type==="select"){const n=(t.options||[]).map(o=>`<option value="${o.value}" ${a===o.value?"selected":""}>${o.label}</option>`).join("");return`
      ...
      </div>`}if(t.type==="curve"){const n=St(a),o=wo(n,100,100,40);return`
      ...
      </div>`}if(t.type==="gradient"){const n=st(a),o=$n(n);return`
      ...
      </div>`}if(t.type==="levelsGraph"){const n=Number.isFinite(e.params[t.blackKey])?e.params[t.blackKey]:0,o=Number.isFinite(e.params[t.gammaKey])?e.params[t.gammaKey]:1,i=Number.isFinite(e.params[t.whiteKey])?e.params[t.whiteKey]:1,l=ko(n,o,i,100,46,56),s=So(n,o,i);return`
      <div class="filter-param-row filter-param-row--levels-graph">
        ...
        <div class="filter-levels-graph" data-instance-id="${e.instanceId}">
          <svg viewBox="0 0 100 46" preserveAspectRatio="none" class="filter-levels-svg" aria-hidden="true">
            ...
            <path class="filter-levels-curve" d="${l}"></path>
    ...
    <div class="filter-param-row">
    ...
    </div>`}function R(){const e=r.selectedId,t=e?G(e):[];if(pi.style.display=t.length===0?"block":"none",Nt.checked=e?Te(e):!1,Nt.disabled=!e,Vn.disabled=!e,me.disabled=!e,N.innerHTML=t.map((a,n)=>{const o=Pe(a.defId);if(!o)return"";const i=o.params.filter(l=>Ze(l,a.params)).map(l=>Pr(a,l)).join("");return`
      ...
      </div>`}).join(""),z&&!C.hidden){const a=N.querySelector(`[data-action="open-curve"][data-instance-id="${z.instanceId}"][data-param-key="${z.paramKey}"]`);a?(z.trigger=a,dn()):ca()}if(O&&!B.hidden){const a=N.querySelector(`[data-action="open-gradient"][data-instance-id="${O.instanceId}"][data-param-key="${O.paramKey}"]`);a?(O.trigger=a,Uo()):sa()}Ga(N),N.querySelectorAll(".filter-levels-graph[data-instance-id]").forEach(a=>{tn(a.dataset.instanceId)}),Ar()}let En=null;function Ar(){clearTimeout(En),En=setTimeout(Tr,220)}async function an(e){if(!e||!ve||r.selectedId!==e)return!1;const t=G(e).filter(i=>i.enabled);if(I.style.display==="none"||!Te(e)||t.length===0)return!1;const a=[...t].reverse(),n=ve.captureAtScale(a,Gt,1);if(!n)return!1;const o=await bo(n.dataUrl);return r.selectedId!==e?!1:(r.previews[e]=o,ea(),Mo(e),!0)}function Tr(){const e=r.selectedId;e&&an(e).then(t=>{t||la()})}function na(e){const t=["linear-gradient(135deg,#2a3f88 0%,#18274f 100%)","linear-gradient(135deg,#5d2a83 0%,#251749 100%)","linear-gradient(135deg,#85481e 0%,#3a2112 100%)","linear-gradient(135deg,#165b67 0%,#0f2e35 100%)"];return t[e%t.length]}function Co(e){const t=e.entry.includes("?")?"&":"?";return`${e.entry}${t}project=${encodeURIComponent(e.id)}`}function Do(e,t){if(!e||e.getElementById("shaderopsUiEnhancements")||!e.getElementById("app")&&!e.body)return;const a=e.createElement("style");a.id="shaderopsUiEnhancements",a.textContent=`
  ...
  `,e.head?.appendChild(a),Ga(e);const n=e.getElementById("allRandomButton");n&&!n.querySelector("svg")&&(n.textContent="",n.title="All random (R)",n.innerHTML=`
      <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <rect x="1.5" y="1.5" width="13" height="13" rx="3" stroke="currentColor" stroke-width="1.3"></rect>
        <circle cx="5" cy="5" r="1.15" fill="currentColor"></circle>
        <circle cx="11" cy="5" r="1.15" fill="currentColor"></circle>
      ...
      <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <path d="M1 9c1.4-3 2.8-4.5 4.2-4.5S7.6 7 9 7s3.6-2.5 5-2.5S16.4 6 16.4 9" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"></path>
      </svg>`);const i=e.getElementById("saveButton");i&&(i.style.display="none"),n&&!e.body?.dataset.shaderopsRandomShortcut&&(e.body&&(e.body.dataset.shaderopsRandomShortcut="1"),e.addEventListener("keydown",d=>{d.key!=="r"&&d.key!=="R"||d.metaKey||d.ctrlKey||d.altKey||d.target?.matches("input, textarea, select, button")||(d.preventDefault(),n.click())}));const l=e.querySelector(".controls");if(!l)return;const s=`shaderops:control-groups:${t}`,c=fe(k.getItem(s),{});l.querySelectorAll(".control-group").forEach((d,f)=>{const p=d.querySelector("h3");if(!p)return;const h=p.textContent.trim().toLowerCase()||`group-${f}`;c[h]===!0&&d.classList.add("is-collapsed"),p.setAttribute("role","button"),p.setAttribute("tabindex","0");const v=()=>{d.classList.toggle("is-collapsed"),c[h]=d.classList.contains("is-collapsed"),k.setItem(s,JSON.stringify(c))};p.addEventListener("click",v),p.addEventListener("keydown",m=>{(m.key==="Enter"||m.key===" ")&&(m.preventDefault(),v())})});const u=e.getElementById("pauseButton");if(u){const d=()=>{const f=/\bresume\b/i.test(u.textContent);u.dataset.shaderopsState=f?"paused":"playing",u.title=f?"Resume (Space)":"Pause (Space)"};d(),u.addEventListener("click",()=>setTimeout(d,0)),e.addEventListener("keydown",f=>{f.code!=="Space"||f.target?.matches("input, textarea, select, button")||(f.preventDefault(),u.click())})}}function nn(e){return!e||e.type!=="shaderops/preview"||!e.projectId?null:e.image||e.dataUrl||null}async function Ir(e){try{return(await fetch(e.entry,{method:"HEAD",cache:"no-store"})).ok}catch{return!1}}const Rr=51;function Eo(){const e=Ye.hidden;Ye.hidden=!0;const t=oe.clientHeight;return Ye.hidden=e,t?Math.max(1,Math.floor((t+5)/Rr)):r.projects.length||1}function be(){if(r.projects.length===0){oe.innerHTML='<div class="thumb-empty">No projects</div>',Ye.hidden=!0,oe.classList.remove("paged");return}const e=Eo(),t=Math.max(1,Math.ceil(r.projects.length/e));r.navPage=Math.min(Math.max(0,r.navPage),t-1);const a=t>1;oe.classList.toggle("paged",a),Ye.hidden=!a,a&&(ui.textContent=`${r.navPage+1} / ${t}`);const n=a?r.navPage*e:0,o=a?n+e:r.projects.length;oe.innerHTML=r.projects.map((i,l)=>({project:i,index:l})).slice(n,o).map(({project:i,index:l})=>{const s=i.id===r.selectedId,c=r.previews[i.id],u=c?`background-image:url('${c}');background-size:cover;`:`background:${na(l)};`;return`
        ...
        </button>`}).join("")}function Mo(e){if(!e)return;const t=r.projects.findIndex(i=>i.id===e);if(t===-1)return;const a=r.previews[e],n=a?`background-image:url('${a}');background-size:cover;`:`background:${na(t)};`,o=CSS.escape(e);document.querySelectorAll(`[data-project-id="${o}"]`).forEach(i=>i.setAttribute("style",n))}let yt=null,ue=null,ot=null,Mn="rail",Z=[],Be=0;function oa(){yt&&(clearTimeout(yt),yt=null)}function ye(){oa(),ue=null,ot=null,Z=[],Be=0,re.hidden=!0}function Fr(e){return r.projects.find(t=>t.id===e)||null}function $r(e,t){const a=Ge(e);return a.slots.length?a.slots.map((n,o)=>{const i=typeof n.preview=="string"&&n.preview?n.preview:null,l=i?`background-image:url('${i}');background-size:cover;background-position:center;`:t+"opacity:0.42;",s=i?`background-image:url('${i}');background-size:cover;background-position:center;`:t;return{slotId:n.id,image:i,thumbStyle:l,heroStyle:s,title:i?`Checkpoint ${o+1}`:`Checkpoint ${o+1} (no snapshot yet)`}}):[]}function Bo(){if(!Z.length){kn.innerHTML='<span class="thumb-hover-preview__empty">No checkpoints</span>';return}kn.innerHTML=Z.map((e,t)=>`<span class="thumb-hover-preview__cp${e.image?"":" thumb-hover-preview__cp--empty"}${t===Be?" is-active":""}" style="${e.thumbStyle}" title="${e.title}"></span>`).join("")}function Ur(e,t){const a=re.getBoundingClientRect(),n=e.getBoundingClientRect(),o=10,i=window.innerWidth-a.width-8,l=window.innerHeight-a.height-8;let s=n.right+o,c=n.top+n.height*.5-a.height*.5;if(t==="effect-panel"){const u=j.hidden?n:j.getBoundingClientRect();s=u.right+o,s>i&&(s=u.left-a.width-o)}else s>i&&(s=n.left-a.width-o);re.style.left=`${Math.max(8,Math.min(s,i))}px`,re.style.top=`${Math.max(8,Math.min(c,l))}px`}function Nr(e,t,a){const n=Fr(t);if(!n)return;const o=Math.max(0,r.projects.findIndex(u=>u.id===t)),i=`background:${na(o)};`,l=r.previews[t]||null,s=l?`background-image:url('${l}');background-size:cover;background-position:center;`:i;Z=$r(t,i),Be=0;const c=Z[0]?.heroStyle||s;Ai.textContent=n.name,Zn.setAttribute("style",c),Bo(),re.dataset.source=a,re.hidden=!1,Ur(e,a)}function Lo(e,t,a){oa(),ue=e,ot=t,Mn=a,yt=setTimeout(()=>{yt=null,!(!ue||!ue.isConnected)&&Nr(ue,ot,Mn)},ri)}function Po(e){if(!Z.length)return;Be=(Be+e+Z.length)%Z.length;const t=Z[Be]?.heroStyle;t&&Zn.setAttribute("style",t),Bo()}function Ao(e,t){if(ot!==e||Z.length===0||t&&ue&&ue.dataset.projectId!==t.dataset.projectId)return null;const a=Z[Be]?.slotId;return a||(Ge(e).slots[Be]?.id??null)}function To(e,t){if(!t)return;if(q.has(e)){Ra(e,t);return}let a=0;const n=setInterval(()=>{if(a+=1,q.has(e)){clearInterval(n),Ra(e,t);return}a>30&&clearInterval(n)},50)}function _r(e){const t=r.projects.findIndex(n=>n.id===e);if(t===-1)return;const a=Eo();r.navPage=Math.floor(t/a),be()}const Or='<svg viewBox="0 0 16 16" fill="currentColor" aria-hidden="true"><path d="M8 1.4l1.98 4.02 4.44.65-3.21 3.13.76 4.42L8 11.55l-3.97 2.07.76-4.42-3.21-3.13 4.44-.65z"/></svg>',zr='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.1" stroke-linejoin="round" aria-hidden="true"><path d="M8 1.4l1.98 4.02 4.44.65-3.21 3.13.76 4.42L8 11.55l-3.97 2.07.76-4.42-3.21-3.13 4.44-.65z"/></svg>';function xa(e,t){const a=e.id===r.selectedId,n=r.favorites.includes(e.id),o=r.previews[e.id],i=o?`background-image:url('${o}');background-size:cover;`:`background:${na(t)};`;return`
    ...
    </div>`}function qt(e){return!e||typeof e!="object"?!1:Array.isArray(e.tags)&&e.tags.some(t=>String(t).toLowerCase()==="3d")?!0:/\b3d\b/i.test(String(e.engine||""))}function ia(){const e=Ea.closest(".nav-grid-section"),t=r.favorites.map(c=>r.projects.find(u=>u.id===c)).filter(Boolean);e.classList.toggle("empty",t.length===0),Ea.innerHTML=t.map(c=>xa(c,r.projects.indexOf(c))).join("");const a=new Set(r.favorites),n=Ma.closest(".nav-grid-section"),o=Ba.closest(".nav-grid-section"),i=r.projects.filter(c=>!a.has(c.id)),l=i.filter(c=>!qt(c)),s=i.filter(c=>qt(c));n&&n.classList.toggle("empty",l.length===0),o&&o.classList.toggle("empty",s.length===0),Ma.innerHTML=l.map(c=>xa(c,r.projects.indexOf(c))).join(""),Ba.innerHTML=s.map(c=>xa(c,r.projects.indexOf(c))).join("")}function Io(){const e=new Set(r.favorites),t=r.favorites.map(n=>r.projects.find(o=>o.id===n)).filter(Boolean),a=r.projects.filter(n=>!e.has(n.id));r.projects=[...t,...a]}function Hr(e){const t=r.favorites.indexOf(e);t===-1?r.favorites.push(e):r.favorites.splice(t,1),go(),Io(),Qa(),ia(),be()}function qr(){ia(),j.hidden=!1,Wa.hidden=!1,Xt.classList.add("active")}function ra(){j.hidden||(j.hidden=!0,Wa.hidden=!0,Xt.classList.remove("active"),ye())}function on(e,t){let a=null,n=null;e.addEventListener("dragstart",o=>{if(o.target.closest("[data-fav-toggle]")){o.preventDefault();return}const i=o.target.closest(".nav-grid-thumb");if(!i){o.preventDefault();return}a=i.dataset.projectId,n=i,i.classList.add("dragging"),o.dataTransfer.effectAllowed="move",o.dataTransfer.setData("text/plain",a)}),e.addEventListener("dragover",o=>{if(!n)return;o.preventDefault(),o.dataTransfer.dropEffect="move";const i=o.target.closest(".nav-grid-thumb");if(!i||i===n){i||e.appendChild(n);return}const l=i.getBoundingClientRect();o.clientX<l.left+l.width/2?i.parentNode.insertBefore(n,i):i.parentNode.insertBefore(n,i.nextSibling)}),e.addEventListener("drop",o=>{if(o.preventDefault(),!a)return;const i=[...e.querySelectorAll(".nav-grid-thumb")].map(l=>l.dataset.projectId);t(i)}),e.addEventListener("dragend",()=>{a=null,n=null,e.querySelectorAll(".nav-grid-thumb.dragging").forEach(o=>o.classList.remove("dragging"))})}function rn(){const e=r.projects.find(t=>t.id===r.selectedId);if(!e){Sa.textContent="No project selected",Ca.textContent="â€”",L.src="about:blank",Da.disabled=!0,va();return}Sa.textContent=e.name,Ca.textContent=e.engine,L.classList.add("frame-swapping"),L.src=Co(e),Da.disabled=!1,k.setItem(Ut,e.id),$a=null,R(),ao(e)?(va(),q.get(e.id)&&(ae(e.id),ro()),requestAnimationFrame(()=>requestAnimationFrame(Qe))):(va(),Gr(L,e.id))}function Qe(){L.classList.remove("frame-swapping")}function Gr(e,t){let a=0;const n=()=>{if(e!==L||r.selectedId!==t)return;a+=1;let o=null;try{o=e.contentDocument}catch{o=null}if(o&&o.readyState!=="loading"&&(o.getElementById("app")||o.body)){try{Do(o,t)}catch(i){console.warn("ShaderOps: unable to install project UI enhancements (early).",i)}requestAnimationFrame(()=>requestAnimationFrame(Qe));return}a<300?requestAnimationFrame(n):Qe()};requestAnimationFrame(n),setTimeout(Qe,1500)}window.addEventListener("message",async e=>{const t=e.data;if(t&&typeof t.type=="string"&&t.type.startsWith("shaderops/")&&(t.type==="shaderops/ready"||t.type==="shaderops/values-changed"||t.type==="shaderops/keydown")){Ji(t,e.source||null);return}const a=nn(e.data);if(!a)return;const{projectId:n}=e.data;n&&n!==r.selectedId&&Cn(n)&&r.previews[n]||n===r.selectedId&&n&&Cn(n)&&(await an(n)||r.previews[n])||(r.previews[n]=await bo(a),ea(),Mo(n))});function la(){if(r.captureInFlight)return Promise.resolve();const e=r.projects.find(a=>a.id===r.selectedId),t=L.contentWindow;return!e||!t?Promise.resolve():an(e.id).then(a=>{if(!a)return r.captureInFlight=!0,new Promise(n=>{const o=setTimeout(()=>{window.removeEventListener("message",i),r.captureInFlight=!1,n()},1500),i=l=>{nn(l.data)&&l.data.projectId===e.id&&(clearTimeout(o),window.removeEventListener("message",i),r.captureInFlight=!1,n())};window.addEventListener("message",i),t.postMessage({type:"shaderops/request-preview",projectId:e.id},"*")})})}async function Wr(e){return new Promise(t=>{const a=document.createElement("iframe");a.style.cssText="position:fixed;width:2px;height:2px;opacity:0;pointer-events:none;left:-9999px;top:-9999px;border:none;",document.body.appendChild(a);let n=!1;const o=()=>{n||(n=!0,clearTimeout(i),window.removeEventListener("message",l),a.remove(),t())},i=setTimeout(o,1e4),l=s=>{nn(s.data)&&s.data.projectId===e.id&&o()};window.addEventListener("message",l),a.addEventListener("load",()=>{setTimeout(()=>{try{a.contentWindow?.postMessage({type:"shaderops/request-preview",projectId:e.id},"*")}catch{o()}},2500)}),a.src=Co(e)})}async function jr(){if(!r.prewarmActive){for(r.prewarmActive=!0;r.prewarmQueue.length>0;){const e=r.prewarmQueue.shift();r.previews[e.id]||await Wr(e)}r.prewarmActive=!1}}async function ln(e){e!==r.selectedId&&(await la(),r.selectedId=e,be(),rn())}L.addEventListener("load",()=>{const e=r.projects.find(t=>t.id===r.selectedId);if(e){try{Do(L.contentDocument,e.id)}catch(t){console.warn("ShaderOps: unable to install project UI enhancements.",t)}Qe(),setTimeout(()=>{try{L.contentWindow?.postMessage({type:"shaderops/request-preview",projectId:e.id},"*")}catch{}},2e3)}});async function Vr(){const e=await fetch("/registry.json",{cache:"no-store"});if(!e.ok)throw new Error(`Unable to load registry (${e.status})`);const t=await e.json(),a=Array.isArray(t.projects)?t.projects:[],n=await Promise.all(a.map(c=>Ir(c)));r.projects=a.filter((c,u)=>n[u]),mr();const o=new Set(r.projects.map(c=>c.id));let i=!1;Object.keys(r.previews).forEach(c=>{o.has(c)||(delete r.previews[c],i=!0)}),i&&ea();const l=k.getItem(Ut),s=r.projects.find(c=>c.id===l)?l:r.projects[0]?.id??null;r.selectedId=s,be(),rn(),r.prewarmQueue=r.projects.filter(c=>!r.previews[c.id]),r.prewarmQueue.length>0&&setTimeout(jr,3e3)}async function Xr(e){if(r.projects.find(a=>a.id===e))try{r.selectedId===e&&(await la(),L.src="about:blank",await new Promise(o=>{let i=!1;const l=()=>{i||(i=!0,L.removeEventListener("load",s),clearTimeout(c),o())},s=()=>l(),c=setTimeout(l,1200);L.addEventListener("load",s,{once:!0})}));const a=await fetch(`/api/projects/${encodeURIComponent(e)}`,{method:"DELETE"}),n=await a.json().catch(()=>({}));if(!a.ok){const o=n?.detail?`: ${n.detail}`:"",i=n?.error?`${n.error}${o}`:`Delete failed (${a.status})`;throw new Error(i)}if(r.projects=r.projects.filter(o=>o.id!==e),delete r.previews[e],ea(),r.selectedId===e){const o=r.projects[0]?.id??null;r.selectedId=o,o?k.setItem(Ut,o):k.removeItem(Ut)}r.prewarmQueue=r.prewarmQueue.filter(o=>o.id!==e),be(),rn()}catch(a){const n=a instanceof Error?a.message:String(a);window.alert(`Unable to delete project: ${n}`)}}oe.addEventListener("click",async e=>{const t=e.target.closest("[data-project-id]");if(!t)return;const a=t.dataset.projectId,n=Ao(a,t);await ln(a),To(a,n),ye()});oe.addEventListener("pointerover",e=>{const t=e.target.closest(".project-thumb[data-project-id]");!t||!oe.contains(t)||Lo(t,t.dataset.projectId,"rail")});oe.addEventListener("pointerout",e=>{const t=e.target.closest(".project-thumb[data-project-id]");if(!t)return;const a=e.relatedTarget;a&&(t.contains(a)||re.contains(a))||(oa(),ue===t&&ye())});oe.addEventListener("pointerleave",e=>{const t=e.relatedTarget;t&&re.contains(t)||ye()});function Bn(e){r.navPage+=e,be()}function Ro(e){oe.classList.contains("paged")&&(e.preventDefault(),e.deltaY>0?Bn(1):e.deltaY<0&&Bn(-1))}oe.addEventListener("wheel",e=>{const t=e.target.closest(".project-thumb[data-project-id]");if(t&&!re.hidden&&ue===t&&ot===t.dataset.projectId&&Z.length>0){e.preventDefault();const a=Math.abs(e.deltaY)>=Math.abs(e.deltaX)?e.deltaY:e.deltaX;a!==0&&Po(a>0?1:-1);return}Ro(e)},{passive:!1});Ye.addEventListener("wheel",Ro,{passive:!1});let Ln=null;window.addEventListener("resize",()=>{clearTimeout(Ln),Ln=setTimeout(be,120),ye()});Xt.addEventListener("click",e=>{e.stopPropagation(),j.hidden?qr():ra()});j.addEventListener("click",e=>{const t=e.target.closest("[data-fav-toggle]");if(t){e.stopPropagation(),Hr(t.dataset.favToggle);return}const a=e.target.closest(".nav-grid-thumb[data-project-id]");if(!a)return;const n=a.dataset.projectId,o=Ao(n,a);ra(),_r(n),ln(n).then(()=>{To(n,o)}),ye()});j.addEventListener("pointerover",e=>{if(j.hidden)return;const t=e.target.closest(".nav-grid-thumb[data-project-id]");!t||!j.contains(t)||Lo(t,t.dataset.projectId,"effect-panel")});j.addEventListener("pointerout",e=>{const t=e.target.closest(".nav-grid-thumb[data-project-id]");if(!t)return;const a=e.relatedTarget;a&&(t.contains(a)||re.contains(a))||(oa(),ue===t&&ye())});j.addEventListener("pointerleave",e=>{const t=e.relatedTarget;t&&re.contains(t)||ye()});j.addEventListener("wheel",e=>{const t=e.target.closest(".nav-grid-thumb[data-project-id]");if(!t||re.hidden||ue!==t||ot!==t.dataset.projectId||Z.length===0)return;e.preventDefault(),e.stopPropagation();const a=Math.abs(e.deltaY)>=Math.abs(e.deltaX)?e.deltaY:e.deltaX;a!==0&&Po(a>0?1:-1)},{passive:!1});Wa.addEventListener("click",()=>ra());document.addEventListener("click",e=>{j.hidden||j.contains(e.target)||Xt.contains(e.target)||ra()});document.addEventListener("dragstart",()=>ye());window.addEventListener("blur",()=>ye());on(Ea,e=>{r.favorites=e,go(),Io(),Qa(),ia(),be()});function Fo(e,t){const a=new Set(r.favorites),n=r.favorites.map(f=>r.projects.find(p=>p.id===f)).filter(Boolean),o=r.projects.filter(f=>!a.has(f.id)&&!qt(f)),i=r.projects.filter(f=>!a.has(f.id)&&qt(f)),l=new Map(r.projects.map(f=>[f.id,f])),s=e.map(f=>l.get(f)).filter(Boolean),c=t==="3d"?i.length:o.length;if(s.length!==c)return;const u=t==="2d"?s:o,d=t==="3d"?s:i;r.projects=[...n,...u,...d],Qa(),ia(),be()}on(Ma,e=>Fo(e,"2d"));on(Ba,e=>Fo(e,"3d"));Da.addEventListener("click",()=>{if(!r.selectedId)return;const e=r.projects.find(t=>t.id===r.selectedId);ki.textContent=e?`Delete "${e.name}"? This removes its files permanently and cannot be undone.`:"This removes its files permanently and cannot be undone.",Je.hidden=!1});Ci.addEventListener("click",()=>{Je.hidden=!0});Je.addEventListener("click",e=>{e.target===Je&&(Je.hidden=!0)});Si.addEventListener("click",()=>{Je.hidden=!0,r.selectedId&&Xr(r.selectedId)});window.addEventListener("beforeunload",()=>{const e=L.contentWindow,t=r.projects.find(a=>a.id===r.selectedId);!e||!t||e.postMessage({type:"shaderops/request-preview",projectId:t.id},"*")});let ve=null,$a=null,Gt=0,Pn=performance.now()/1e3;const Ve=document.createElement("canvas"),An=Ve.getContext("2d",{willReadFrequently:!1});function Kr(){return ve||(ve=new Yo(I),ve)}let Ua=null;const Ke=new Map;let Tn=null;function Yr(e,t){if(e){Tn!==e&&(Ke.clear(),Tn=e);for(const[a,n]of t){let o=Ke.get(a);o||(o=e.createElement("canvas"),o.className="fx-underlay-item",o.style.cssText="position:fixed;pointer-events:none;z-index:1;display:none;",e.body.appendChild(o),Ke.set(a,o)),o.style.display="block",o.style.left=`${n.x}px`,o.style.top=`${n.y}px`,o.style.width=`${n.w}px`,o.style.height=`${n.h}px`}for(const[a,n]of Ke)t.has(a)||(n.style.display="none")}}function Jr(e,t){const a=e.width||0,n=e.height||0;if(!(a<=0||n<=0))for(const[o,i]of Ke){if(i.style.display==="none")continue;const l=parseFloat(i.style.width)||0,s=parseFloat(i.style.height)||0;if(l<=0||s<=0)continue;const c=Math.max(1,Math.round(l*t)),u=Math.max(1,Math.round(s*t));i.width!==c&&(i.width=c),i.height!==u&&(i.height=u);const d=Math.max(0,Math.min(a-1,Math.round(parseFloat(i.style.left)*t))),f=Math.max(0,Math.min(n-1,Math.round(parseFloat(i.style.top)*t))),p=Math.max(1,Math.min(a-d,c)),h=Math.max(1,Math.min(n-f,u)),v=i.getContext("2d");if(v)try{v.clearRect(0,0,c,u),v.drawImage(e,d,f,p,h,0,0,c,u)}catch{}}}function Zr(e,t,a){const n=[],o=new Map,i=0;try{if(e)for(const f of["hud","panelToggleDock","shaderopsCheckpoints","shaderopsCheckpointMenu"]){const p=e.getElementById(f);if(!p)continue;const h=e.defaultView?.getComputedStyle(p);if(h?.display==="none"||h?.visibility==="hidden"||h?.contentVisibility==="hidden")continue;const v=p.getBoundingClientRect();if(v.width>0&&v.height>0){const m=v.left-i,g=v.top-i,S=Math.max(0,m),D=Math.max(0,g),y=Math.min(t,m+v.width+i*2),V=Math.min(a,g+v.height+i*2);y>S&&V>D&&(n.push({x:S,y:D,w:y-S,h:V-D}),o.set(f,{x:S,y:D,w:y-S,h:V-D}))}}}catch{}Yr(e,o);const l=`${t}x${a}|`+n.map(f=>`${f.x},${f.y},${f.w},${f.h}`).join(";");if(l===Ua)return;if(Ua=l,I.style.clipPath="none",!n.length){I.style.maskImage="none",I.style.webkitMaskImage="none";return}const s=[];for(const f of n){let p=f;for(let h=s.length-1;h>=0;h--){const v=s[h];if(p.x<v.x+v.w&&p.x+p.w>v.x&&p.y<v.y+v.h&&p.y+p.h>v.y){const g=Math.min(p.x,v.x),S=Math.min(p.y,v.y),D=Math.max(p.x+p.w,v.x+v.w),y=Math.max(p.y+p.h,v.y+v.h);p={x:g,y:S,w:D-g,h:y-S},s.splice(h,1)}}s.push(p)}const c=s.map(f=>`<rect x="${f.x}" y="${f.y}" width="${f.w}" height="${f.h}" fill="#000"/>`).join(""),u=`<svg xmlns="http://www.w3.org/2000/svg" width="${t}" height="${a}"><defs><mask id="m" maskUnits="userSpaceOnUse" x="0" y="0" width="${t}" height="${a}"><rect x="0" y="0" width="${t}" height="${a}" fill="#fff"/><g>${c}</g></mask></defs></svg>`,d=`url("data:image/svg+xml,${encodeURIComponent(u)}#m")`;I.style.maskImage=d,I.style.webkitMaskImage=d,I.style.maskMode="luminance",I.style.maskRepeat="no-repeat",I.style.webkitMaskRepeat="no-repeat",I.style.maskSize="100% 100%",I.style.webkitMaskSize="100% 100%"}function $o(){requestAnimationFrame($o);const e=performance.now()/1e3,t=Math.max(0,Math.min(.1,e-Pn));Pn=e;const a=r.selectedId,o=(a?G(a):[]).filter(D=>D.enabled),i=a?Te(a):!1,l=!!a&&i&&o.length>0,s=a?q.get(a):null;a&&s?.extras?.paused||(Gt+=t);let u=null;try{u=L.contentDocument||null}catch{u=null}let d=null;try{d=u?.querySelector("canvas")||null}catch{d=null}if(!l||!d){I.style.display!=="none"&&(I.style.display="none"),(I.style.clipPath!=="none"||I.style.maskImage)&&(I.style.clipPath="none",I.style.maskImage="none",I.style.webkitMaskImage="none",Ua=null);for(const D of Ke.values())D.style.display="none";return}I.style.display!=="block"&&(I.style.display="block");const f=Kr();d!==$a&&($a=d,f.setSource(Ve));const p=d.width||1,h=d.height||1;(Ve.width!==p||Ve.height!==h)&&(Ve.width=p,Ve.height=h);try{An.clearRect(0,0,p,h),An.drawImage(d,0,0,p,h)}catch{}const v=ja.getBoundingClientRect(),m=Math.max(1,Math.round(v.width)),g=Math.max(1,Math.round(v.height));(f.width!==m||f.height!==g)&&f.resize(m,g),Zr(u,m,g);const S=[...o].reverse();f.renderFrame(S,Gt),Jr(I,f.renderer.getPixelRatio())}requestAnimationFrame($o);hr();Mr();Kt.addEventListener("click",e=>{e.stopPropagation(),J.hidden?Lr():aa()});J.addEventListener("click",e=>{const t=e.target.closest(".filter-add-option");!t||!r.selectedId||(wr(r.selectedId,t.dataset.filterId),aa())});document.addEventListener("click",e=>{const t=e.target.closest(".filter-add-wrap"),a=e.target.closest("#filterAddMenu");!J.hidden&&!t&&!a&&aa()});document.addEventListener("keydown",e=>{e.key==="Escape"&&aa()});N.addEventListener("click",e=>{const t=e.target.closest("[data-action]");if(!t||!r.selectedId)return;const{action:a,instanceId:n,paramKey:o}=t.dataset;if(a==="collapse")Cr(r.selectedId,n);else if(a==="remove")kr(r.selectedId,n);else if(a==="upload-image"){const i=t.closest(".filter-param-row").querySelector(".filter-image-input");i&&i.click()}else a==="clear-image"?(P(r.selectedId),ke(r.selectedId,n,o,null),R()):a==="open-curve"?ol(n,o,t.dataset.label,t):a==="open-gradient"&&al(n,o,t.dataset.label,t)});let wt=null;N.addEventListener("pointerdown",e=>{const t=e.target.closest(".filter-levels-handle[data-instance-id][data-handle]");if(!t||!r.selectedId)return;const a=t.closest(".filter-levels-graph");if(!a)return;e.preventDefault(),e.stopPropagation();const n=t.dataset.instanceId,o=`levelsgraph:${n}`;ge!==o&&(P(r.selectedId),ge=o),wt={instanceId:n,handle:t.dataset.handle,graph:a}});N.addEventListener("change",e=>{const t=e.target;if(r.selectedId)if(t.matches('[data-action="toggle"]'))Sr(r.selectedId,t.dataset.instanceId);else if(t.classList.contains("filter-param-toggle"))P(r.selectedId),ke(r.selectedId,t.dataset.instanceId,t.dataset.paramKey,t.checked),R();else if(t.classList.contains("filter-param-select"))P(r.selectedId),ke(r.selectedId,t.dataset.instanceId,t.dataset.paramKey,t.value),Er(r.selectedId,t.dataset.instanceId,t.dataset.paramKey,t.value),R();else if(t.classList.contains("filter-param-color")){const a=`color:${t.dataset.instanceId}:${t.dataset.paramKey}`;ge!==a&&P(r.selectedId),ke(r.selectedId,t.dataset.instanceId,t.dataset.paramKey,t.value),ge=null}else if(t.classList.contains("filter-image-input")){const a=t.files&&t.files[0];if(!a)return;const{instanceId:n,paramKey:o}=t.dataset,i=new FileReader;i.onload=()=>{P(r.selectedId),ke(r.selectedId,n,o,i.result),R()},i.readAsDataURL(a)}else(t.classList.contains("filter-param-range")||t.classList.contains("filter-param-number")||t.classList.contains("filter-param-color"))&&(ge=null)});let ge=null;N.addEventListener("input",e=>{const t=e.target;if(r.selectedId){if(t.classList.contains("filter-param-range")||t.classList.contains("filter-param-number")){const{instanceId:a,paramKey:n}=t.dataset,o=Number(t.value),i=`${a}:${n}`;ge!==i&&(P(r.selectedId),ge=i),ke(r.selectedId,a,n,o,!0),N.querySelectorAll(`[data-instance-id="${a}"][data-param-key="${n}"]`).forEach(l=>{l!==t&&(l.value=o)}),tn(a)}else if(t.classList.contains("filter-param-color")){const{instanceId:a,paramKey:n}=t.dataset,o=`color:${a}:${n}`;ge!==o&&(P(r.selectedId),ge=o),ke(r.selectedId,a,n,t.value,!0)}}});window.addEventListener("pointermove",e=>{if(!wt||!r.selectedId)return;const{instanceId:t,handle:a,graph:n}=wt,o=n.getBoundingClientRect();if(o.width<=1)return;const i=Math.max(0,Math.min(1,(e.clientX-o.left)/o.width)),l=(d,f)=>{const p=N.querySelector(`input[data-instance-id="${t}"][data-param-key="${d}"]`),h=p?Number(p.value):f;return Number.isFinite(h)?h:f};let s=l("blackPoint",0),c=l("gamma",1),u=l("whitePoint",1);if(a==="black")s=Math.max(0,Math.min(u-.001,i)),ya(t,"blackPoint",s);else if(a==="white")u=Math.max(s+.001,Math.min(1,i)),ya(t,"whitePoint",u);else{const d=Math.max(0,Math.min(.99,s)),f=Math.max(d+.001,Math.min(1,u)),p=Math.max(.001,Math.min(.999,(i-d)/(f-d)));c=Math.max(.2,Math.min(3,Math.log(p)/Math.log(.5))),ya(t,"gamma",c)}tn(t)});window.addEventListener("pointerup",()=>{wt&&(wt=null,ge=null)});let Wt=null,Ne=null;N.addEventListener("dragstart",e=>{const t=e.target.closest(".filter-item");if(!t||!e.target.closest(".filter-name")){e.preventDefault();return}Wt=t.dataset.instanceId,Ne=t,t.classList.add("dragging"),e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",Wt);const a=t.getBoundingClientRect();e.dataTransfer.setDragImage(t,e.clientX-a.left,e.clientY-a.top)});N.addEventListener("dragover",e=>{if(!Ne)return;e.preventDefault(),e.dataTransfer.dropEffect="move";const t=e.target.closest(".filter-item");if(!t||t===Ne){t||N.appendChild(Ne);return}const a=t.getBoundingClientRect();e.clientY<a.top+a.height/2?t.parentNode.insertBefore(Ne,t):t.parentNode.insertBefore(Ne,t.nextSibling)});N.addEventListener("drop",e=>{if(e.preventDefault(),!r.selectedId||!Wt)return;const t=G(r.selectedId),a=[...N.querySelectorAll(".filter-item")].map(i=>i.dataset.instanceId),n=new Map(t.map(i=>[i.instanceId,i])),o=a.map(i=>n.get(i)).filter(Boolean);o.length===t.length&&(o.some((l,s)=>l!==t[s])&&P(r.selectedId),t.length=0,t.push(...o),pe()),R()});N.addEventListener("dragend",()=>{Wt=null,Ne=null,N.querySelectorAll(".filter-item.dragging, .filter-item.drag-over").forEach(e=>{e.classList.remove("dragging","drag-over")})});const Qr={w:320,h:240};function el(){try{const e=k.getItem(Wn),t=e?JSON.parse(e):null;if(t&&typeof t.w=="number"&&typeof t.h=="number")return t}catch{}return{...Qr}}let Le=el();function tl(){k.setItem(Wn,JSON.stringify(Le))}const C=document.createElement("div");C.id="curvePopup";C.className="curve-popup";C.hidden=!0;C.innerHTML=`
...
`;document.body.appendChild(C);const ie=document.createElement("div");ie.id="curvePointMenu";ie.className="curve-point-menu";ie.hidden=!0;ie.innerHTML=`
...
`;document.body.appendChild(ie);const B=document.createElement("div");B.id="gradientPopup";B.className="curve-popup gradient-popup";B.hidden=!0;B.innerHTML=`
  <div class="curve-popup-header">
    <span class="curve-popup-title"></span>
    <div class="curve-popup-header-actions">
...
`;document.body.appendChild(B);let O=null,et=null,F=null;function sn(e){return Math.min(1,Math.max(0,e))}function cn(){return!O||!r.selectedId?null:G(r.selectedId).find(t=>t.instanceId===O.instanceId)||null}function pt(){const e=cn();return!e||!O?null:st(e.params[O.paramKey])}function mt(e){const t=cn();!t||!O||(t.params[O.paramKey]={stops:e},pe())}function Uo(){if(B.hidden||!O||!O.trigger)return;const e=O.trigger.getBoundingClientRect(),t=B.offsetWidth||300,a=B.offsetHeight||140;let n=e.right-t,o=e.top-a-10;o<8&&(o=e.bottom+10),n=Math.min(Math.max(8,n),window.innerWidth-t-8),o=Math.min(Math.max(8,o),window.innerHeight-a-8),B.style.left=`${n}px`,B.style.top=`${o}px`}function Se(){const e=pt(),t=B.querySelector(".gradient-popup-track"),a=B.querySelector(".gradient-popup-editor");if(!(!e||!t))if(F!==null&&(F<0||F>=e.stops.length)&&(F=null),t.style.background=$n(e),t.innerHTML=e.stops.map((n,o)=>`<button type="button" class="gradient-popup-handle${o===F?" active":""}"
      style="left:${(n.t*100).toFixed(2)}%; background:${n.color}" data-stop-index="${o}" title="${n.color}"></button>`).join(""),F!==null){const n=e.stops[F];a.hidden=!1,a.querySelector(".gradient-popup-color").value=n.color,a.querySelector(".gradient-popup-pos").value=Math.round(n.t*100),a.querySelector(".gradient-popup-delete").disabled=e.stops.length<=2}else a.hidden=!0}function al(e,t,a,n){O={instanceId:e,paramKey:t,trigger:n},F=null,B.querySelector(".curve-popup-title").textContent=a||"Gradient",B.hidden=!1,Uo(),Se()}function sa(){B.hidden=!0,O=null,et=null,F=null}function nl(){const e=cn();if(!e||!O)return;const t=Pe(e.defId),a=t&&t.params.find(o=>o.key===O.paramKey);if(!a)return;const n=st(a.default);P(r.selectedId),F=null,mt(n.stops.map(o=>({...o}))),Se(),R()}B.querySelector(".gradient-popup-close").addEventListener("click",sa);B.querySelector(".gradient-popup-reset").addEventListener("click",nl);B.querySelector(".gradient-popup-bar").addEventListener("pointerdown",e=>{const t=e.target.closest(".gradient-popup-handle");t&&(F=Number(t.dataset.stopIndex),et=F,P(r.selectedId),Se(),e.preventDefault())});B.querySelector(".gradient-popup-bar").addEventListener("dblclick",e=>{if(e.target.closest(".gradient-popup-handle"))return;const t=pt(),a=e.currentTarget;if(!t)return;const n=a.getBoundingClientRect(),o=sn((e.clientX-n.left)/n.width),i=jo(t,o),l=t.stops.map(c=>({...c})),s={t:o,color:i};l.push(s),l.sort((c,u)=>c.t-u.t),F=l.indexOf(s),P(r.selectedId),mt(l),Se(),R()});document.addEventListener("pointermove",e=>{if(et===null)return;const t=B.querySelector(".gradient-popup-bar"),a=pt();if(!t||!a)return;const n=t.getBoundingClientRect(),o=sn((e.clientX-n.left)/n.width),i=a.stops.map(s=>({...s})),l=i[et];l&&(l.t=o,i.sort((s,c)=>s.t-c.t),F=i.indexOf(l),et=F,mt(i),Se(),R())});document.addEventListener("pointerup",()=>{et=null});B.querySelector(".gradient-popup-color").addEventListener("input",e=>{const t=pt();if(!t||F===null)return;const a=t.stops.map(n=>({...n}));a[F].color=e.target.value,mt(a),Se(),R()});B.querySelector(".gradient-popup-color").addEventListener("change",()=>{P(r.selectedId)});B.querySelector(".gradient-popup-pos").addEventListener("change",e=>{const t=pt();if(!t||F===null)return;const a=t.stops.map(o=>({...o})),n=a[F];P(r.selectedId),n.t=sn(Number(e.target.value)/100),a.sort((o,i)=>o.t-i.t),F=a.indexOf(n),mt(a),Se(),R()});B.querySelector(".gradient-popup-delete").addEventListener("click",()=>{const e=pt();if(!e||F===null||e.stops.length<=2)return;const t=e.stops.filter((a,n)=>n!==F);P(r.selectedId),F=null,mt(t),Se(),R()});let z=null,it=null,rt=null,Ee=null,tt=null,W=null;function un(){return!z||!r.selectedId?null:G(r.selectedId).find(t=>t.instanceId===z.instanceId)||null}function ze(){const e=un();return e?St(e.params[z.paramKey]):null}function lt(e){const t=un();!t||!z||(t.params[z.paramKey]={points:e},pe())}function ol(e,t,a,n){z={instanceId:e,paramKey:t,trigger:n},W=null,C.querySelector(".curve-popup-title").textContent=a||"Curve",C.style.width=`${Le.w}px`,C.style.height=`${Le.h}px`,C.hidden=!1,dn(),de()}function ca(){C.hidden=!0,z=null,it=null,rt=null,W=null,kt()}function il(){const e=un();if(!e||!z)return;const t=Pe(e.defId),a=t&&t.params.find(i=>i.key===z.paramKey);if(!a)return;const o=St(a.default).points.map(i=>({...i}));W=null,P(r.selectedId),lt(o),de(),R()}function dn(){if(C.hidden||!z||!z.trigger)return;const e=z.trigger.getBoundingClientRect(),t=C.offsetWidth||Le.w,a=C.offsetHeight||Le.h;let n=e.right-t,o=e.top-a-10;o<8&&(o=e.bottom+10),n=Math.min(Math.max(8,n),window.innerWidth-t-8),o=Math.min(Math.max(8,o),window.innerHeight-a-8),C.style.left=`${n}px`,C.style.top=`${o}px`}function de(){const e=ze(),t=C.querySelector(".curve-popup-svg");if(!e||!t)return;const a=t.getBoundingClientRect(),n=Math.max(1,Math.round(a.width)||100),o=Math.max(1,Math.round(a.height)||100);t.setAttribute("viewBox",`0 0 ${n} ${o}`),W!==null&&(W<0||W>=e.points.length-1)&&(W=null);const i=wo(e,n,o,48);let l="";for(let p=1;p<4;p++){const h=p/4*n,v=p/4*o;l+=`<line class="curve-grid-line" x1="0" y1="${v.toFixed(2)}" x2="${n}" y2="${v.toFixed(2)}" />`,l+=`<line class="curve-grid-line" x1="${h.toFixed(2)}" y1="0" x2="${h.toFixed(2)}" y2="${o}" />`}const s=Math.min(n,o),c=Math.max(4.5,s*.03),u=Math.max(9,s*.05);let d="";for(let p=0;p<e.points.length-1;p++){const h=e.points[p];if(h.type==="constant"||p!==W)continue;const v=e.points[p+1],m=h.x*n,g=(1-h.y)*o,S=Math.max(v.x-h.x,1e-5),D=h.tanSet?h.tanDx:S/3,y=h.tanSet?h.tanDy:0;let V=D*n,le=-y*o;const Q=Math.hypot(V,le),se=Math.max(u*1.1,12);if(!h.tanSet)if(Q>1e-4&&Q<se){const E=se/Q;V*=E,le*=E}else Q<=1e-4&&(V=se,le=0);const ht=m+V,We=g+le,b=m-V,A=g-le;d+=`<line class="curve-handle-line" x1="${ht.toFixed(2)}" y1="${We.toFixed(2)}" x2="${b.toFixed(2)}" y2="${A.toFixed(2)}" />`;const $=u/2,w=(E,Y)=>`M ${E.toFixed(2)} ${(Y-$).toFixed(2)} L ${(E+$).toFixed(2)} ${Y.toFixed(2)} L ${E.toFixed(2)} ${(Y+$).toFixed(2)} L ${(E-$).toFixed(2)} ${Y.toFixed(2)} Z`;d+=`<path class="curve-handle-point" data-handle-index="${p}" d="${w(ht,We)}" />`,d+=`<path class="curve-handle-point" data-handle-index="${p}" d="${w(b,A)}" />`}const f=e.points.map((p,h)=>{const v=h===0||h===e.points.length-1,m=h===W,g=["curve-point",v?"curve-point--endpoint":"",p.type==="constant"?"curve-point--constant":"",m?"curve-point--active":""].filter(Boolean).join(" "),S=p.x*n,D=(1-p.y)*o;if(m){const y=c*1.7;return`<rect class="${g}" data-point-index="${h}" x="${(S-y/2).toFixed(2)}" y="${(D-y/2).toFixed(2)}" width="${y.toFixed(2)}" height="${y.toFixed(2)}" />`}return`<circle class="${g}" data-point-index="${h}" cx="${S.toFixed(2)}" cy="${D.toFixed(2)}" r="${c.toFixed(2)}" />`}).join("");t.innerHTML=`${l}${d}<path class="curve-popup-path" d="${i}" />${f}`}C.querySelector(".curve-popup-close").addEventListener("click",ca);C.querySelector(".curve-popup-reset").addEventListener("click",il);C.querySelector(".curve-popup-svg").addEventListener("pointerdown",e=>{const t=e.currentTarget,a=e.target.closest(".curve-handle-point"),n=e.target.closest(".curve-point"),o=ze();if(o){if(a){const i=Number(a.dataset.handleIndex);P(r.selectedId),rt={index:i},W=i,t.setPointerCapture(e.pointerId),e.stopPropagation();return}if(n){const i=Number(n.dataset.pointIndex);P(r.selectedId),it={index:i},i<o.points.length-1&&o.points[i].type!=="constant"?W=i:W=null,t.setPointerCapture(e.pointerId),e.stopPropagation(),de();return}W!==null&&(W=null,de())}});C.querySelector(".curve-popup-svg").addEventListener("dblclick",e=>{const t=e.target.closest(".curve-point"),a=ze();if(!a)return;if(e.preventDefault(),t){const u=Number(t.dataset.pointIndex),d=a.points.map(f=>({...f}));d[u].type=d[u].type==="constant"?"bezier":"constant",P(r.selectedId),lt(d),de(),R();return}if(e.target.closest(".curve-handle-point"))return;const o=C.querySelector(".curve-popup-svg").getBoundingClientRect(),i=Math.min(1,Math.max(0,(e.clientX-o.left)/o.width)),l=Math.min(1,Math.max(0,1-(e.clientY-o.top)/o.height)),s=a.points.map(u=>({...u}));s.push({x:i,y:l,type:"bezier",tanDx:0,tanDy:0,tanSet:!1}),s.sort((u,d)=>u.x-d.x),P(r.selectedId),lt(s);const c=s.findIndex(u=>u.x===i&&u.y===l);W=c<s.length-1?c:null,de(),R()});C.querySelector(".curve-popup-svg").addEventListener("contextmenu",e=>{const t=e.target.closest(".curve-point");if(!t)return;e.preventDefault(),tt=Number(t.dataset.pointIndex);const a=ze(),n=a&&(tt===0||tt===a.points.length-1);ie.querySelector('[data-action="delete"]').disabled=!!n,ie.style.left=`${e.clientX}px`,ie.style.top=`${e.clientY}px`,ie.hidden=!1});function kt(){ie.hidden=!0,tt=null}ie.addEventListener("click",e=>{const t=e.target.closest("button[data-action]");if(!t||t.disabled||tt===null){kt();return}const a=ze();if(a){const n=a.points.map(l=>({...l})),o=tt,i=o===0||o===n.length-1;t.dataset.action==="type-bezier"?n[o].type="bezier":t.dataset.action==="type-constant"?n[o].type="constant":t.dataset.action==="delete"&&!i&&n.length>2&&n.splice(o,1),P(r.selectedId),lt(n),de(),R()}kt()});C.querySelector(".curve-popup-resize").addEventListener("pointerdown",e=>{Ee={startX:e.clientX,startY:e.clientY,startW:Le.w,startH:Le.h},e.target.setPointerCapture(e.pointerId),e.preventDefault()});document.addEventListener("pointermove",e=>{if(it){const t=ze(),a=C.querySelector(".curve-popup-svg");if(!t||!a)return;const n=a.getBoundingClientRect(),o=t.points.map(u=>({...u})),i=it.index,l=i===0||i===o.length-1,s=Math.min(1,Math.max(0,1-(e.clientY-n.top)/n.height));let c=o[i].x;if(!l){const u=o[i-1].x+.001,d=o[i+1].x-.001;c=Math.min(d,Math.max(u,(e.clientX-n.left)/n.width))}o[i]={...o[i],x:c,y:s},lt(o),de(),R()}else if(rt){const t=ze(),a=C.querySelector(".curve-popup-svg");if(!t||!a)return;const n=a.getBoundingClientRect(),o=t.points.map(y=>({...y})),i=rt.index,l=o[i],s=o[i+1];if(!l||!s)return;const c=n.width,u=n.height,d=l.x*c,f=(1-l.y)*u,p=e.clientX-n.left,h=e.clientY-n.top;let v=(p-d)/c,m=-(h-f)/u;const S=Math.max(.001,Math.hypot(s.x-l.x,s.y-l.y))*1.5,D=Math.hypot(v,m);if(D>S){const y=S/D;v*=y,m*=y}o[i]={...l,tanDx:v,tanDy:m,tanSet:!0},lt(o),de(),R()}else if(Ee){const t=Math.max(240,Math.min(720,Ee.startW+(e.clientX-Ee.startX))),a=Math.max(160,Math.min(560,Ee.startH+(e.clientY-Ee.startY)));Le={w:t,h:a},C.style.width=`${t}px`,C.style.height=`${a}px`,de()}});document.addEventListener("pointerup",()=>{it&&(it=null),rt&&(rt=null),Ee&&(Ee=null,tl())});document.addEventListener("click",e=>{!C.hidden&&!e.target.closest("#curvePopup")&&!e.target.closest('[data-action="open-curve"]')&&!e.target.closest("#curvePointMenu")&&ca(),!ie.hidden&&!e.target.closest("#curvePointMenu")&&kt(),!B.hidden&&!e.target.closest("#gradientPopup")&&!e.target.closest('[data-action="open-gradient"]')&&sa()});document.addEventListener("keydown",e=>{e.key==="Escape"&&(ca(),kt(),sa())});document.addEventListener("keydown",e=>{const t=e.key.toLowerCase();if(!(e.ctrlKey||e.metaKey)||t!=="z"||!r.selectedId)return;const a=e.target;a&&(a.tagName==="INPUT"||a.tagName==="TEXTAREA")&&a.type==="text"||(e.preventDefault(),e.shiftKey?xr(r.selectedId):yr(r.selectedId))});window.addEventListener("resize",dn);Nt.addEventListener("change",()=>{r.selectedId&&(r.filterPreviewOn[r.selectedId]=Nt.checked,pe(),R())});function No(){return!ve||!r.selectedId||I.style.display==="none"||!Te(r.selectedId)?!1:G(r.selectedId).some(e=>e.enabled)}function fn(e){if(No()){const c=[...G(r.selectedId).filter(u=>u.enabled)].reverse();return ve.captureAtScale(c,Gt,e)}const t=L.contentDocument,a=t?t.querySelector("canvas"):null;if(!a||!a.width||!a.height)return null;const n=Math.round(a.width*e),o=Math.round(a.height*e),i=document.createElement("canvas");return i.width=n,i.height=o,i.getContext("2d").drawImage(a,0,0,n,o),{dataUrl:i.toDataURL("image/png"),width:n,height:o}}function rl(e,t){const a=URL.createObjectURL(e),n=document.createElement("a");n.href=a,n.download=t,n.click(),setTimeout(()=>URL.revokeObjectURL(a),1e3)}function _o(e,t){const a=Qi(e),n=ir(t.dataUrl);if(!n)return console.warn("Failed to read exported PNG data for metadata embedding."),null;let o;try{const i=lr(n,jn,JSON.stringify(a));o=new Blob([i],{type:"image/png"})}catch(i){console.warn("Failed to embed state metadata into PNG export; downloading raw image.",i),o=new Blob([n],{type:"image/png"})}return o}function ll(e,t,a){const n=_o(e,t);return n?(rl(n,a),!0):!1}function jt(e,t,a,n){const o=Number(e);return Number.isFinite(o)?Math.min(a,Math.max(t,o)):n}function Oo(e){return new Promise(t=>setTimeout(t,e))}async function sl(){if(typeof window.showDirectoryPicker!="function")throw new Error("Directory picker is not supported in this runtime.");return window.showDirectoryPicker({mode:"readwrite"})}async function cl(e,t,a){const o=await(await e.getFileHandle(t,{create:!0})).createWritable();await o.write(a),await o.close()}async function ul(e=140){await new Promise(t=>requestAnimationFrame(()=>requestAnimationFrame(t))),e>0&&await Oo(e)}let at=!1;const ua=new Map;function ne(e,t="neutral"){xn.textContent=e||"",xn.dataset.tone=t}function In(e){const t=Math.floor(jt(e,1,200,1));K.value=String(t)}function Rn(e){const t=jt(e,.1,4,1);_e.value=String(Number(t.toFixed(1)))}function da(e){const t=e?ua.get(e):null;wn.textContent=t?t.name:"Not set",wn.title=t?t.name:"No folder selected",Xa.disabled=!t}function dl(){const e=Number(K.value);K.dataset.prevValue=String(Number.isFinite(e)?e:8),K.addEventListener("input",()=>{const t=Number(K.dataset.prevValue||"8"),a=Number(K.value);if(!Number.isFinite(a))return;let n=a;Number.isFinite(t)&&Math.abs(a-(t+1))<1e-9?n=t*2:Number.isFinite(t)&&Math.abs(a-(t-1))<1e-9&&(n=t/2),In(n),K.dataset.prevValue=K.value}),K.addEventListener("change",()=>{In(Number(K.value||8)),K.dataset.prevValue=K.value}),_e.addEventListener("input",()=>{Rn(Number(_e.value||1))}),_e.addEventListener("change",()=>{Rn(Number(_e.value||1))})}Vn.addEventListener("click",()=>{r.selectedId&&pl()});me.addEventListener("click",async()=>{if(!r.selectedId||me.disabled)return;const e=fn(1);if(e)try{const t=await(await fetch(e.dataUrl)).blob();await navigator.clipboard.write([new ClipboardItem({"image/png":t})]),fl()}catch(t){console.warn("[filter] copy to clipboard failed:",t)}});function fl(){const e=me.dataset.baseTitle||me.title;me.dataset.baseTitle=e,me.classList.add("copied"),me.title="Copied!",setTimeout(()=>{me.classList.remove("copied"),me.title=e},1200)}function pl(){let e,t;if(No())e=ve.width,t=ve.height;else{const a=L.contentDocument,n=a?a.querySelector("canvas"):null;e=n?n.width:I.width,t=n?n.height:I.height}yi.textContent=`${Math.round(e)} × ${Math.round(t)} px`,ne(""),At.disabled=!1,da(r.selectedId),_t.hidden=!1}function Vt(){at||(_t.hidden=!0)}Pa.addEventListener("click",e=>{const t=e.target.closest(".export-size-option");if(!t||!r.selectedId)return;const a=Number(t.dataset.scale)||1,n=r.selectedId,o=fn(a);if(!o){Vt();return}const i=ho(n);ll(n,o,i),Vt()});At.addEventListener("click",async()=>{if(!r.selectedId||at)return;const e=r.selectedId,t=Math.floor(jt(K.value,1,200,1)),a=jt(_e.value,.1,4,1),n=wi.value==="seed"?"seed":"all-random";K.value=String(t),_e.value=String(Number(a.toFixed(2)));const o=ua.get(e);if(!o){ne("Please set Batch Path first.","warn");return}at=!0,At.disabled=!0,Aa.disabled=!0,Xa.disabled=!0,Pa.querySelectorAll(".export-size-option").forEach(s=>{s.disabled=!0}),ne(`Preparing batch export (${t})â€¦`);let i=0,l=0;try{for(let s=0;s<t;s++){if(r.selectedId!==e){ne("Batch stopped: selected effect changed.","warn");break}ne(`Rendering ${s+1}/${t}â€¦`),n==="all-random"?Zt(e):Ae(e,"rerollSeed"),await Ui(e,1800),await ul();const c=fn(a);if(!c){l+=1;continue}const u=`batch-${String(s+1).padStart(3,"0")}`,d=ho(e,u),f=_o(e,c);if(!f)l+=1;else try{await cl(o,d,f),i+=1}catch(p){console.warn("Batch export write failed:",p),l+=1}await Oo(60)}}finally{at=!1,At.disabled=!1,Aa.disabled=!1,da(r.selectedId),Pa.querySelectorAll(".export-size-option").forEach(c=>{c.disabled=!1});const s=l>0?"warn":"ok";ne(`Done: ${i} exported${l?`, ${l} failed`:""}.`,s)}});Aa.addEventListener("click",async()=>{const e=r.selectedId;if(!(!e||at)){ne("Selecting folderâ€¦");try{const t=await sl();ua.set(e,t),da(e),ne("Batch path set.","ok")}catch(t){console.warn("Batch export folder selection failed:",t);const a=t&&typeof t=="object"&&"name"in t?String(t.name):"";if(a==="AbortError"){ne("Folder selection cancelled.","warn");return}if(a==="NotAllowedError"||a==="SecurityError"){ne("Folder access was blocked. Please allow folder access and try again.","warn");return}const n=t instanceof Error&&t.message?t.message:"Unknown error";ne(`Failed to set folder: ${n}`,"warn")}}});Xa.addEventListener("click",()=>{const e=r.selectedId;!e||at||(ua.delete(e),da(e),ne("Batch path cleared."))});dl();xi.addEventListener("click",Vt);_t.addEventListener("click",e=>{e.target===_t&&Vt()});ja.addEventListener("dragover",e=>{(e.dataTransfer?.types?Array.from(e.dataTransfer.types):[]).includes("Files")&&(e.preventDefault(),e.dataTransfer.dropEffect="copy")});ja.addEventListener("drop",async e=>{if(!e.dataTransfer?.files?.length)return;e.preventDefault();const t=[...e.dataTransfer.files].find(a=>/image\/png/i.test(a.type)||/\.png$/i.test(a.name));if(t)try{await dr(t)||console.info("Dropped PNG has no embedded ShaderOps state metadata.")}catch(a){console.warn("Failed to restore ShaderOps state from dropped PNG:",a)}});fi.addEventListener("click",()=>{Va.classList.add("collapsed"),k.setItem(qa,"1")});di.addEventListener("click",()=>{Va.classList.remove("collapsed"),k.setItem(qa,"0")});fr();pr();br();Vr().catch(e=>{Sa.textContent="Registry load failed",Ca.textContent=e.message});
