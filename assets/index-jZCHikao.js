...
`,Bn=[{value:"value",label:"Value"},{value:"cloud",label:"Cloud"},{value:"voronoi",label:"Voronoi"},{value:"ridged",label:"Ridged"},{value:"warp",label:"Domain Warp"},{value:"turbulence",label:"Turbulence"}],hi={value:0,cloud:1,voronoi:2,ridged:3,warp:4,turbulence:5};function ka(e){return hi[e]??1}const Se=8,Tn=`
  #define FX_CURVE_MAX ${Se}
...
`;function he(e){return Math.min(1,Math.max(0,Number.isFinite(e)?e:0))}function Ba(e,t,a){return Math.min(a,Math.max(t,Number.isFinite(e)?e:0))}function vi(e,t,a,n,o){let i=he(o);for(let r=0;r<8;r++){const s=1-i,c=s*s*s*e+3*s*s*i*t+3*s*i*i*a+i*i*i*n-o,u=3*s*s*(t-e)+6*s*i*(a-t)+3*i*i*(n-a);if(Math.abs(u)<1e-6)break;i=he(i-c/u)}return i}function gi(e){if(typeof e.handleAngle=="number"&&typeof e.handleDist=="number"&&e.handleDist>0){const t=e.handleDist*.33;return{tanDx:Math.cos(e.handleAngle)*t,tanDy:Math.sin(e.handleAngle)*t,tanSet:!0}}return typeof e.bend=="number"&&e.bend!==0?{tanDx:0,tanDy:Ba(e.bend,-1,1)*.25,tanSet:!0}:{tanDx:0,tanDy:0,tanSet:!1}}function Bt(e){if(e&&Array.isArray(e.points)&&e.points.length>=2){const t=e.points.map(a=>{const o=a.tanSet&&typeof a.tanDx=="number"&&typeof a.tanDy=="number"?{tanDx:a.tanDx,tanDy:a.tanDy,tanSet:!0}:gi(a);return{x:he(a.x),y:he(a.y),type:a.type==="constant"?"constant":"bezier",tanDx:o.tanSet?o.tanDx:0,tanDy:o.tanSet?o.tanDy:0,tanSet:!!o.tanSet}}).sort((a,n)=>a.x-n.x).slice(0,Se);return t[0]={...t[0],x:0},t[t.length-1]={...t[t.length-1],x:1},{points:t}}return e&&typeof e.x=="number"&&typeof e.y=="number"?{points:[{x:0,y:0,type:"bezier",tanDx:0,tanDy:0,tanSet:!1},{x:he(e.x),y:he(e.y),type:"bezier",tanDx:0,tanDy:0,tanSet:!1},{x:1,y:1,type:"bezier",tanDx:0,tanDy:0,tanSet:!1}]}:{points:[{x:0,y:0,type:"bezier",tanDx:0,tanDy:0,tanSet:!1},{x:1,y:1,type:"bezier",tanDx:0,tanDy:0,tanSet:!1}]}}function yi(e,t){const{points:a}=Bt(e),n=he(t);for(let o=0;o<a.length-1;o++){const i=a[o],r=a[o+1];if(n>=i.x&&(n<r.x||o===a.length-2)){if(i.type==="constant")return i.y;const s=Math.max(r.x-i.x,1e-5),c=Ba(i.tanSet?i.x+i.tanDx:i.x+s/3,i.x,r.x),u=i.tanSet?i.y+i.tanDy:i.y,d=Ba(r.tanSet?r.x-r.tanDx:r.x-s/3,i.x,r.x),f=r.tanSet?r.y-r.tanDy:r.y,p=vi(i.x,c,d,r.x,n),h=1-p;return h*h*h*i.y+3*h*h*p*u+3*h*p*p*f+p*p*p*r.y}}return a[a.length-1].y}function Ln(e){const{points:t}=Bt(e),a=[],n=[];for(let o=0;o<Se;o++){const i=t[Math.min(o,t.length-1)];a.push([i.x,i.y,i.type==="constant"?1:0,0]),n.push([i.tanDx||0,i.tanDy||0,i.tanSet?1:0,0])}return{points:a,tans:n,count:t.length}}const Tt=8;function Zn(e){const t=typeof e=="string"?/^#?([0-9a-fA-F]{6})$/.exec(e.trim()):null;return t?`#${t[1].toLowerCase()}`:"#ffffff"}function It(e){const t=Zn(e).slice(1);return[parseInt(t.slice(0,2),16)/255,parseInt(t.slice(2,4),16)/255,parseInt(t.slice(4,6),16)/255]}function bi([e,t,a]){const n=o=>Math.round(he(o)*255).toString(16).padStart(2,"0");return`#${n(e)}${n(t)}${n(a)}`}function gt(e){let t=e&&Array.isArray(e.stops)?e.stops:null;(!t||t.length<2)&&(t=[{t:0,color:"#1b2a6b"},{t:1,color:"#ffcf6b"}]);const a=t.map(n=>({t:he(Number(n&&n.t)),color:Zn(n&&n.color)})).sort((n,o)=>n.t-o.t).slice(0,Tt);return a.length<2&&a.push({t:1,color:"#ffffff"}),{stops:a}}function xi(e,t){const{stops:a}=gt(e),n=he(t);if(n<=a[0].t)return a[0].color;if(n>=a[a.length-1].t)return a[a.length-1].color;for(let o=0;o<a.length-1;o++){const i=a[o],r=a[o+1];if(n>=i.t&&n<=r.t){const s=Math.max(r.t-i.t,1e-5),c=(n-i.t)/s,u=It(i.color),d=It(r.color);return bi([u[0]+(d[0]-u[0])*c,u[1]+(d[1]-u[1])*c,u[2]+(d[2]-u[2])*c])}}return a[a.length-1].color}function Qn(e){const{stops:t}=gt(e);return`linear-gradient(90deg, ${t.map(a=>`${a.color} ${(a.t*100).toFixed(1)}%`).join(", ")})`}function wi(e){const{stops:t}=gt(e),a=[];for(let n=0;n<Tt;n++){const o=t[Math.min(n,t.length-1)],i=It(o.color);a.push([i[0],i[1],i[2],o.t])}return{stops:a,count:t.length}}const ki=`
  #define FX_GRAD_MAX ${Tt}
...
`,eo=[{id:"glow",label:"Glow / Deep Glow",group:"Effect",icon:'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"><circle cx="8" cy="8" r="2.6"/><path d="M8 1.4v2M8 12.6v2M1.4 8h2M12.6 8h2M3.4 3.4l1.4 1.4M11.2 11.2l1.4 1.4M3.4 12.6l1.4-1.4M11.2 4.8l1.4-1.4"/></svg>',params:[{key:"threshold",label:"Threshold",min:0,max:1,step:.01,default:.55},{key:"intensity",label:"Intensity",min:0,max:3,step:.02,default:1.1},{key:"radius",label:"Radius",min:.5,max:6,step:.05,default:2.2},{key:"steps",label:"Steps (Quality)",min:2,max:8,step:1,default:4}],passes:[{key:"glow",fragmentShader:`
        ...
        `,updateUniforms(e,t){const{stops:a,count:n}=wi(t.gradient);for(let o=0;o<a.length;o++)e.uGradStops.value[o].set(a[o][0],a[o][1],a[o][2],a[o][3]);e.uGradCount.value=n,e.uContrast.value=t.contrast,e.uInvert.value=t.invert?1:0,e.uMix.value=t.mix}}]},{id:"uvNoise",label:"UV Noise",group:"Distort",icon:'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.2"><circle cx="4.5" cy="5" r="1.6"/><circle cx="11" cy="4.5" r="1.1"/><circle cx="10" cy="10.5" r="2"/><circle cx="4" cy="11" r="1.2"/></svg>',params:[{key:"noiseType",label:"Noise Type",type:"select",default:"cloud",options:Bn},{key:"amount",label:"Amount",min:0,max:.15,step:.001,default:.035},{key:"scale",label:"Scale",min:1,max:30,step:.5,default:5},{key:"speed",label:"Speed",min:0,max:3,step:.02,default:.4}],passes:[{key:"uvNoise",fragmentShader:`
          uniform sampler2D tDiffuse;
          uniform float uAmount;
          uniform float uScale;
          uniform float uSpeed;
        ...
        `,updateUniforms(e,t){e.uAngle.value=t.angle,e.uAmount.value=t.amount,e.uSteps.value=t.steps,e.uRandomness.value=t.randomness}}]},{id:"uvBlur",label:"UV Blur",group:"Blur",icon:'<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.2"><path d="M1.5 5.5c1.2-1.6 2.4-1.6 3.6 0s2.4 1.6 3.6 0 2.4-1.6 3.6 0" opacity="0.4"/><path d="M1.5 8.5c1.2-1.6 2.4-1.6 3.6 0s2.4 1.6 3.6 0 2.4-1.6 3.6 0" opacity="0.7"/><path d="M1.5 11.5c1.2-1.6 2.4-1.6 3.6 0s2.4 1.6 3.6 0 2.4-1.6 3.6 0" opacity="1"/></svg>',params:[{key:"followDistort",label:"Sync Distort",type:"toggle",default:!0},{key:"strength",label:"Strength",min:0,max:.15,step:.001,default:.05},{key:"noiseType",label:"Noise Type",type:"select",default:"cloud",options:Bn},{key:"scale",label:"Scale",min:1,max:30,step:.5,default:5},{key:"speed",label:"Speed",min:0,max:3,step:.02,default:.4}],passes:[{key:"uvBlur",fragmentShader:`
          uniform sampler2D tDiffuse;
        ...
        `,updateUniforms(e,t,a){e.uMode.value=t.flowType==="radial"?1:t.flowType==="weave"?2:t.flowType==="noise"?3:0,e.uAngle.value=t.flowAngle,e.uArc.value=t.lightAngle,e.uFrequency.value=t.frequency,e.uStrength.value=t.strength,e.uJitter.value=t.organic,e.uSpeed.value=t.speed,e.uRoughness.value=t.contentFollow,e.uFalloff.value=t.contentRelief,e.uShadowHue.value=t.shadowHue,e.uHighlightHue.value=t.highlightHue,e.uSaturation.value=t.saturation,e.uChroma.value=t.colorize,e.uContrast.value=t.punch,e.uMix.value=t.mix,e.uTime.value=a}}]}];function Re(e){return eo.find(t=>t.id===e)||null}function Si(e){if(!e||!e.stack||!e.instance)return null;const t=e.stack.indexOf(e.instance);if(t<0)return null;for(let a=t-1;a>=0;a--){const n=e.stack[a];if(!n.enabled)continue;const o=Re(n.defId);if(o&&o.group==="Distort")return{inst:n,def:o}}return null}function Za(e){const t=Re(e);if(!t)return{};const a={};return t.params.forEach(n=>{a[n.key]=n.default&&typeof n.default=="object"?JSON.parse(JSON.stringify(n.default)):n.default}),a}const Rn=`
  uniform sampler2D tDiffuse;
  varying vec2 vUv;
  void main() { gl_FragColor = texture2D(tDiffuse, vUv); }
`;class Ci{constructor(t){this.canvas=t,this.renderer=new L.WebGLRenderer({canvas:t,alpha:!1,antialias:!1,preserveDrawingBuffer:!0}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),this.renderer.debug.onShaderError=(a,n,o,i)=>{const r=a.getShaderInfoLog(o),s=a.getShaderInfoLog(i),c=a.getProgramInfoLog(n);console.error(`[postfx] Shader compile/link error:
--- vertex log ---
`+r+`
--- fragment log ---
`+s+`
--- program log ---
`+c)},t.addEventListener("webglcontextlost",this._onContextLost=a=>{a.preventDefault(),console.error("[postfx] WebGL context lost on compositor canvas.")}),t.addEventListener("webglcontextrestored",this._onContextRestored=()=>{console.warn("[postfx] WebGL context restored on compositor canvas.")}),this.scene=new L.Scene,this.camera=new L.OrthographicCamera(-1,1,1,-1,0,1),this.quad=new L.Mesh(new L.PlaneGeometry(2,2),new L.ShaderMaterial({vertexShader:An,fragmentShader:Rn,uniforms:{tDiffuse:{value:null}}})),this.scene.add(this.quad),this.materialCache=new Map,this.canvasTexture=null,this.sourceCanvas=null,this.sourceWidth=0,this.sourceHeight=0,this.uniformResolutionScale=1,this.rtA=null,this.rtB=null,this.width=0,this.height=0}_materialFor(t){let a=this.materialCache.get(t.key);if(a||(a=new L.ShaderMaterial({vertexShader:An,fragmentShader:t.fragmentShader||Rn,uniforms:{tDiffuse:{value:null},uResolution:{value:new L.Vector2(1,1)},uTime:{value:0},uThreshold:{value:.5},uIntensity:{value:1},uRadius:{value:1},uSteps:{value:4},uAmount:{value:0},uBlend:{value:0},uBlur:{value:0},uBulge:{value:0},uPinch:{value:0},uUseCurve:{value:0},uEdge:{value:0},uScale:{value:1},uSpeed:{value:0},uDirection:{value:new L.Vector2(1,0)},uSize:{value:8},uDotSize:{value:8},uAngle:{value:0},uMono:{value:0},uVariation:{value:.35},uStrength:{value:.35},uOffset:{value:.5},uShadowHue:{value:220},uHighlightHue:{value:40},uSaturation:{value:.65},uMix:{value:.85},uCurvePoints:{value:Array.from({length:Se},()=>new L.Vector4(0,0,0,0))},uCurveTans:{value:Array.from({length:Se},()=>new L.Vector4(0,0,0,0))},uCurveCount:{value:2},uEdgeShape:{value:0},uEdgeSoftness:{value:.35},uNoiseType:{value:0},uSpin:{value:0},tImage:{value:null},uHasImage:{value:0},uMode:{value:0},tDistortImage:{value:null},uHasImageDistort:{value:0},uGradStops:{value:Array.from({length:Tt},()=>new L.Vector4(0,0,0,0))},uGradCount:{value:2},uContrast:{value:0},uBrightness:{value:0},uBlackPoint:{value:0},uWhitePoint:{value:1},uGamma:{value:1},uHighlights:{value:0},uShadows:{value:0},uHueShift:{value:0},uSatScale:{value:1},uLightness:{value:0},uInvert:{value:0},uShape:{value:0},uColorMode:{value:0},uInkColor:{value:new L.Vector3(0,0,0)},uPaperColor:{value:new L.Vector3(1,1,1)},uRandomness:{value:0},uArc:{value:0},uArcPosition:{value:.5},uRoughness:{value:0},uChroma:{value:0},uCenter:{value:new L.Vector2(.5,.5)},uBlades:{value:0},uFocusPos:{value:.5},uFocusWidth:{value:.2},uFrequency:{value:8},uFalloff:{value:1},uTiltX:{value:0},uTiltY:{value:0},uJitter:{value:0},uStock:{value:1},uGrain:{value:.45},uGrainSize:{value:1.4},uGrainAnimated:{value:1},uHalation:{value:.55},uHaloSize:{value:3.2},uFade:{value:.08},uTemperature:{value:0},uTintShift:{value:0},uVignette:{value:.4},uBrushType:{value:0},uBrushSize:{value:9},uStrokeStrength:{value:.72},uDetail:{value:.55},uEdgeBlend:{value:.6},uStrokePresence:{value:.65}}}),this.materialCache.set(t.key,a)),t.key==="oilPaint"){const n=a.uniforms;n.uBrushType||(n.uBrushType={value:0}),n.uBrushSize||(n.uBrushSize={value:9}),n.uStrokeStrength||(n.uStrokeStrength={value:.72}),n.uDetail||(n.uDetail={value:.55}),n.uEdgeBlend||(n.uEdgeBlend={value:.6}),n.uStrokePresence||(n.uStrokePresence={value:.65}),n.uMix||(n.uMix={value:.85})}return a}getInstanceTexture(t){if(!t)return null;const a=t.params&&t.params.image;if(!a)return t._glTex&&(t._glTex.dispose(),t._glTex=null,t._glTexUrl=null),null;if(t._glTex&&t._glTexUrl===a)return t._glTex;t._glTex&&t._glTex.dispose();const n=new Image,o=new L.Texture(n);return o.minFilter=L.LinearFilter,o.magFilter=L.LinearFilter,o.generateMipmaps=!1,n.onload=()=>{o.needsUpdate=!0},n.src=a,t._glTex=o,t._glTexUrl=a,o}setSource(t){this.sourceCanvas!==t&&(this._recreateCanvasTexture(t),this._debugLoggedThisSource=!1)}_recreateCanvasTexture(t){this.sourceCanvas=t,this.canvasTexture&&this.canvasTexture.dispose(),this.canvasTexture=t?new L.CanvasTexture(t):null,this.canvasTexture&&(this.canvasTexture.minFilter=L.LinearFilter,this.canvasTexture.magFilter=L.LinearFilter,this.canvasTexture.generateMipmaps=!1),this.sourceWidth=t?t.width:0,this.sourceHeight=t?t.height:0}resize(t,a){if(t<=0||a<=0||this.width===t&&this.height===a)return;this.width=t,this.height=a,this.renderer.setSize(t,a,!1);const n=this.renderer.getPixelRatio(),o=Math.max(1,Math.floor(t*n)),i=Math.max(1,Math.floor(a*n));this.rtA&&this.rtA.dispose(),this.rtB&&this.rtB.dispose(),this.rtA=new L.WebGLRenderTarget(o,i,{depthBuffer:!1,stencilBuffer:!1}),this.rtB=new L.WebGLRenderTarget(o,i,{depthBuffer:!1,stencilBuffer:!1})}renderFrame(t,a){if(!this.canvasTexture||!this.rtA||!this.rtB)return;const n=this.sourceCanvas?this.sourceCanvas.width:0,o=this.sourceCanvas?this.sourceCanvas.height:0;(n!==this.sourceWidth||o!==this.sourceHeight)&&this._recreateCanvasTexture(this.sourceCanvas),this.canvasTexture.needsUpdate=!0;const i=[];t.forEach(u=>{if(!u.enabled)return;const d=Re(u.defId);d&&d.passes.forEach(f=>i.push({pass:f,params:u.params,instance:u}))});const r=[this.rtA,this.rtB];let s=this.canvasTexture,c=0;if(i.length===0){const u=this.quad.material;u.uniforms.tDiffuse.value=s,this.renderer.setRenderTarget(null),this.renderer.render(this.scene,this.camera);return}i.forEach(({pass:u,params:d,instance:f},p)=>{const h=p===i.length-1,v=this._materialFor(u);v.uniforms.tDiffuse.value=s;const m=Math.max(1e-6,this.uniformResolutionScale||1);v.uniforms.uResolution.value.set(this.rtA.width/m,this.rtA.height/m),u.updateUniforms(v.uniforms,d,a,{instance:f,compositor:this,stack:t}),this.quad.material=v;const g=h?null:r[c%2];this.renderer.setRenderTarget(g),this.renderer.render(this.scene,this.camera),h||(s=g.texture,c+=1)})}captureAtScale(t,a,n){if(!this.width||!this.height)return null;const o=this.renderer.getPixelRatio(),i=this.rtA,r=this.rtB,s=Math.max(.01,Number(n)||1),c=o*s,u=Math.max(1,Math.floor(this.width*c)),d=Math.max(1,Math.floor(this.height*c));this.renderer.setPixelRatio(c),this.renderer.setSize(this.width,this.height,!1),this.rtA=new L.WebGLRenderTarget(u,d,{depthBuffer:!1,stencilBuffer:!1}),this.rtB=new L.WebGLRenderTarget(u,d,{depthBuffer:!1,stencilBuffer:!1});let f=null;try{this.uniformResolutionScale=s,this.renderFrame(t,a),f=this.canvas.toDataURL("image/png")}finally{this.uniformResolutionScale=1,this.rtA.dispose(),this.rtB.dispose(),this.rtA=i,this.rtB=r,this.renderer.setPixelRatio(o),this.renderer.setSize(this.width,this.height,!1),this.renderFrame(t,a)}return f?{dataUrl:f,width:u,height:d}:null}dispose(){this.materialCache.forEach(t=>t.dispose()),this.materialCache.clear(),this.canvasTexture&&this.canvasTexture.dispose(),this.rtA&&this.rtA.dispose(),this.rtB&&this.rtB.dispose(),this._onContextLost&&this.canvas.removeEventListener("webglcontextlost",this._onContextLost),this._onContextRestored&&this.canvas.removeEventListener("webglcontextrestored",this._onContextRestored),this.renderer.dispose()}}const Ei="/assets/Default-DtKDocRU.png",Ee="shaderops:active-profile:v1",je="shaderops:profiles:v1",dt="shaderops:profile:",to="shaderops-profile",Di=3,qt="shaderops:profile-default-migration:v2",Ve="shaderops:project-previews:v1",ao="shaderops:unified-checkpoints:",no="shaderops:image-loader:v1:",Ae="shaderops-cache:",Mi=`${Ae}checkpoint-previews:v1:`,Ii=`${Ae}project-previews:v2:`,Pi=`${Ae}project-revisions:v1:`,Ta="__deleted__:",oo=1;function y(){return window.localStorage}function ft(e,t){try{const a=JSON.parse(e);return a&&typeof a=="object"?a:t}catch{return t}}function io(e){return String(e||"").trim().replace(/\s+/g," ").slice(0,48)}function ro(){return`profile-${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}function Fe(){const e=ft(y().getItem(je),[]);return Array.isArray(e)?e.filter(t=>t&&typeof t.id=="string"&&typeof t.name=="string"):[]}function ye(){const e=y().getItem(Ee);return Fe().find(t=>t.id===e)||null}function Ai(){if(y().getItem(qt)==="1")return;const e=ye();if(!e)return;const t=`${dt}${e.id}:`,a=[];for(let n=0;n<y().length;n++){const o=y().key(n);o?.startsWith(t)&&a.push([o,o.slice(t.length),y().getItem(o)])}a.forEach(([n,o,i])=>{let r=i;o===Ve&&(r=lo(y().getItem(o),i)),y().removeItem(n),y().removeItem(o),y().setItem(o,r)}),y().setItem(qt,"1")}function Bi(e){const t=io(e);if(!t)throw new Error("A profile name is required.");const a={id:ro(),name:t,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()},n=[...Fe(),a];return y().setItem(je,JSON.stringify(n)),y().setItem(Ee,a.id),a}function Ti(e){const t=Fe();if(!t.some(o=>o.id===e))throw new Error("This profile is not available on this computer.");const a=`${dt}${e}:`;for(let o=y().length-1;o>=0;o--){const i=y().key(o);(i?.startsWith(a)||i?.startsWith(`${Mi}${e}:`)||i===`${Ii}${e}`||i===`${Pi}${e}`)&&y().removeItem(i)}const n=t.filter(o=>o.id!==e);return y().setItem(je,JSON.stringify(n)),y().getItem(Ee)===e&&(n[0]?y().setItem(Ee,n[0].id):y().removeItem(Ee)),n[0]||null}function Li(){for(let e=y().length-1;e>=0;e--){const t=y().key(e);(t===Ve||t?.endsWith(`:${Ve}`))&&y().removeItem(t)}}function Qa(e){const t=Fe().find(a=>a.id===e);if(!t)throw new Error("This profile is not available on this computer.");return y().setItem(Ee,t.id),t}function en(){return ye()?.id||"default"}function Gt(e,t=en()){return`${dt}${t}:${e}`}function La(e,t){return Gt(`${Ta}${e}`,t)}function lo(e,t){const a=ft(e,{}),n=ft(t,{});if(n?.version!==oo||!n.values)return JSON.stringify({...a,...n});const o={...a,...n.values};return Array.isArray(n.deleted)&&n.deleted.forEach(i=>delete o[i]),JSON.stringify(o)}function Ri(e,t){const a=ft(e,{}),n=ft(t,{}),o={};Object.entries(n).forEach(([r,s])=>{a[r]!==s&&(o[r]=s)});const i=Object.keys(a).filter(r=>!(r in n));return JSON.stringify({version:oo,values:o,deleted:i})}function tn(e,t){if(y().getItem(La(e,t))!==null)return null;const a=y().getItem(Gt(e,t)),n=y().getItem(e);return a===null?n:e===Ve?lo(n,a):a}function Ra(e){const t=new Set,a=`${dt}${e}:`;for(let n=0;n<y().length;n++){const o=y().key(n);if(o?.startsWith("shaderops:")&&!o.startsWith(Ae)&&!o.startsWith(dt)&&o!==Ee&&o!==je&&o!==qt)t.add(o);else if(o?.startsWith(a)){const i=o.slice(a.length);t.add(i.startsWith(Ta)?i.slice(Ta.length):i)}}return[...t].filter(n=>tn(n,e)!==null)}function Fn(e){const t=Fe(),a=t.find(n=>n.id===e);a&&(a.updatedAt=new Date().toISOString(),y().setItem(je,JSON.stringify(t)))}function Fi(){const e=en();return{getItem(t){return tn(t,e)},setItem(t,a){y().removeItem(La(t,e));const n=t===Ve?Ri(y().getItem(t),String(a)):String(a);y().setItem(Gt(t,e),n),Fn(e)},removeItem(t){y().removeItem(Gt(t,e)),y().setItem(La(t,e),"1"),Fn(e)},key(t){return Ra(e)[t]??null},get length(){return Ra(e).length}}}function $i(e=en()){const t=Fe().find(n=>n.id===e);if(!t)throw new Error("This profile is not available on this computer.");const a={};return Ra(e).forEach(n=>{if(n===Ve||n.startsWith(no))return;const o=tn(n,e);a[n]=n.startsWith(ao)?so(o):o}),{format:to,version:Di,exportedAt:new Date().toISOString(),profile:{name:t.name,createdAt:t.createdAt},entries:a}}function so(e){const t=ft(e,null);if(!t||!Array.isArray(t.slots))return e;const a=t.slots.map(n=>{if(!n||typeof n!="object")return n;const{preview:o,...i}=n;return typeof i.imagePath=="string"&&i.imagePath.startsWith("data:image/")&&(delete i.imagePath,delete i.imageName),i});return JSON.stringify({...t,slots:a})}function Ni(e){const t={...e.entries};for(const[a,n]of Object.entries(t))a===Ve||a.startsWith(no)?delete t[a]:a.startsWith(ao)&&(t[a]=so(n));return{...e,entries:t}}function Ui(e,t){if(!e||e.format!==to||!e.entries||typeof e.entries!="object")throw new Error("This is not a valid ShaderOps profile recovery file.");const a=Ni(e),n=Object.entries(a.entries).filter(([i,r])=>typeof i=="string"&&i.startsWith("shaderops:")&&!i.startsWith(Ae)&&!i.startsWith(dt)&&i!==Ee&&i!==je&&i!==qt&&typeof r=="string"),o=[];for(let i=0;i<y().length;i++){const r=y().key(i);r?.startsWith("shaderops:")&&!r.startsWith(Ae)&&o.push([r,y().getItem(r)])}try{o.forEach(([r])=>y().removeItem(r));for(let r=y().length-1;r>=0;r--){const s=y().key(r);s?.startsWith(Ae)&&y().removeItem(s)}n.forEach(([r,s])=>y().setItem(r,s));const i={id:ro(),name:io(t||e.profile?.name||"Recovered Profile"),createdAt:e.profile?.createdAt||new Date().toISOString(),updatedAt:new Date().toISOString()};return y().setItem(je,JSON.stringify([i])),y().setItem(Ee,i.id),i}catch(i){for(let r=y().length-1;r>=0;r--){const s=y().key(r);s?.startsWith("shaderops:")&&!s.startsWith(Ae)&&y().removeItem(s)}throw o.forEach(([r,s])=>y().setItem(r,s)),new Error(i instanceof DOMException&&i.name==="QuotaExceededError"?"This recovery file is larger than this browser allows. The previous workspace was restored.":"Unable to restore this recovery file. The previous workspace was restored.")}}Ai();Li();const E=Fi(),an=ye()?.id||"default",co=`shaderops-cache:project-previews:v2:${an}`,uo=`shaderops-cache:project-revisions:v1:${an}`,nn="shaderops-cache:checkpoint-previews:v1:",_i="shaderops-thumbnail-cache",le="entries",Wt="shaderops:selected-project:v1",fo="shaderops:filters:v1",po="shaderops:favorites:v1",mo="shaderops:project-order:v1",ho="shaderops:filter-add-order:v1",on="shaderops:filter-rail-collapsed:v1",vo="shaderops:curve-popup-size:v1",go="shaderops-state",Fa=1,Oi=400,zi="shaderops:image-loader:v1:",yt="shaderops://image/default",Ye="Default";function Hi(){return new Promise(e=>{if(!("indexedDB"in window)){e(null);return}const t=indexedDB.open(_i,1);t.onupgradeneeded=()=>{t.result.objectStoreNames.contains(le)||t.result.createObjectStore(le)},t.onsuccess=()=>e(t.result),t.onerror=()=>{console.warn("ShaderOps: IndexedDB thumbnail cache is unavailable.",t.error),e(null)}})}const Lt=Hi();async function $n(e,t){const a=await Lt;return a?new Promise(n=>{const o=a.transaction(le,"readonly").objectStore(le).get(e);o.onsuccess=()=>n(o.result??t),o.onerror=()=>n(t)}):t}async function $a(e,t){const a=await Lt;a&&await new Promise((n,o)=>{const i=a.transaction(le,"readwrite").objectStore(le).put(t,e);i.onsuccess=()=>n(),i.onerror=()=>o(i.error)})}async function Sa(e){const t=await Lt;t&&await new Promise(a=>{const o=t.transaction(le,"readwrite").objectStore(le).openCursor();o.onsuccess=()=>{const i=o.result;if(!i){a();return}String(i.key).startsWith(e)&&i.delete(),i.continue()},o.onerror=()=>a()})}async function qi(e){const t=await Lt;return t?new Promise(a=>{const n=[],o=t.transaction(le,"readonly").objectStore(le).openCursor();o.onsuccess=()=>{const i=o.result;if(!i){a(n);return}String(i.key).startsWith(e)&&n.push([String(i.key),i.value]),i.continue()},o.onerror=()=>a(n)}):[]}async function Gi(){const e=await Lt;e&&await new Promise(t=>{const a=e.transaction(le,"readwrite").objectStore(le).clear();a.onsuccess=()=>t(),a.onerror=()=>t()})}const aa=new Map,$t=[];function Wi(e){const t=e.ownerDocument,a=t.createElement("div");a.className="w-pill";const n=t.createElement("div");n.className="w-pill__fill",a.appendChild(n);let o=null;const i=()=>{const s=e.dataset.pillMode||"",c=`${e.value}|${s}`;if(c===o)return;o=c;const u=Number(e.min)||0,d=Number(e.max)||100,f=Number(e.value),p=d===u?0:Math.min(1,Math.max(0,(f-u)/(d-u)));if(s==="center-zero"&&u<0&&d>0){const h=Math.min(1,Math.max(0,(0-u)/(d-u))),v=Math.min(p,h),m=Math.abs(p-h);a.classList.add("w-pill--center"),a.style.setProperty("--pill-center",`${(h*100).toFixed(3)}%`),n.classList.toggle("is-tip-left",p<h),n.style.left=`${(v*100).toFixed(3)}%`,n.style.width=`${(m*100).toFixed(3)}%`;return}a.classList.remove("w-pill--center"),a.style.removeProperty("--pill-center"),n.classList.remove("is-tip-left"),n.style.left="0%",n.style.width=`${(p*100).toFixed(3)}%`};i();const r=(s,c)=>{const u=a.getBoundingClientRect(),d=Number(e.min)||0,f=Number(e.max)||100,p=Number(e.step)||1,h=u.width===0?0:Math.min(1,Math.max(0,(s-u.left)/u.width));let v=d+h*(f-d);v=Math.round(v/p)*p,v=Math.min(f,Math.max(d,v)),e.value=String(Number(v.toFixed(6))),e.dispatchEvent(new Event("input",{bubbles:!0})),c||e.dispatchEvent(new Event("change",{bubbles:!0})),i()};return a.addEventListener("pointerdown",s=>{s.preventDefault(),a.setPointerCapture(s.pointerId),r(s.clientX,!0);const c=d=>r(d.clientX,!0),u=d=>{a.removeEventListener("pointermove",c),a.removeEventListener("pointerup",u),a.removeEventListener("pointercancel",u),r(d.clientX,!1)};a.addEventListener("pointermove",c),a.addEventListener("pointerup",u),a.addEventListener("pointercancel",u)}),e.insertAdjacentElement("beforebegin",a),e.style.display="none",e.dataset.pillMounted="1",{slider:e,paint:i}}function rn(e){if(!e)return;e.querySelectorAll('.control-row input[type="range"], .filter-param-row input[type="range"]').forEach(a=>{a.dataset.pillMounted||$t.push(Wi(a))})}(function(){const t=()=>{for(let a=$t.length-1;a>=0;a--){const n=$t[a];if(!n.slider.isConnected){$t.splice(a,1);continue}n.paint()}requestAnimationFrame(t)};requestAnimationFrame(t)})();const ji=document.getElementById("app");document.documentElement.classList.toggle("app-client-shell",navigator.userAgent.includes("Electron"));ji.innerHTML=`
...
`;const l={projects:[],selectedId:null,previews:{},captureInFlight:!1,prewarmQueue:[],prewarmActive:!1,previewRevisions:{},currentProjectRevisions:{},filterStacks:{},filterPreviewOn:{},filterHistory:{},navPage:0,favorites:[]},oe=document.getElementById("projectList"),Na=document.getElementById("projectTitle"),Ua=document.getElementById("projectMethod"),D=document.getElementById("projectFrame"),_a=document.getElementById("deleteProjectButton"),na=document.getElementById("navGridButton"),ot=document.getElementById("navPager"),Vi=document.getElementById("navPagerLabel"),j=document.getElementById("navGridPanel"),ln=document.getElementById("navGridBackdrop"),Oa=document.getElementById("navGridFav"),za=document.getElementById("navGrid2d"),Ha=document.getElementById("navGrid3d"),sn=document.getElementById("shaderStage"),R=document.getElementById("fxCanvas"),cn=document.getElementById("filterRail"),Xi=document.getElementById("filterRailGear"),Ki=document.getElementById("filterRailCollapse"),oa=document.getElementById("filterAddButton"),J=document.getElementById("filterAddMenu"),_=document.getElementById("filterStackList"),Yi=document.getElementById("filterStackEmpty"),jt=document.getElementById("filterPreviewToggle"),yo=document.getElementById("filterExportButton"),me=document.getElementById("filterCopyButton"),Ji=document.getElementById("profileButton"),Zi=document.getElementById("profileButtonName"),Nt=document.getElementById("profileOverlay"),Qi=document.getElementById("profileDialogTitle"),er=document.getElementById("profileDialogDescription"),Dt=document.getElementById("profileNameInput"),Ca=document.getElementById("profileExistingList"),tr=document.getElementById("profileRestoreHint"),Xe=document.getElementById("profileDialogStatus"),bo=document.getElementById("profileContinueButton"),xo=document.getElementById("profileDownloadButton"),ar=document.getElementById("profileRestoreLabel"),qa=document.getElementById("profileRestoreInput"),Vt=document.getElementById("exportSizeOverlay"),nr=document.getElementById("exportSizeCurrent"),Ga=document.getElementById("exportSizeOptions"),or=document.getElementById("exportSizeCancel"),K=document.getElementById("exportBatchCount"),Ge=document.getElementById("exportBatchScale"),ir=document.getElementById("exportBatchMode"),Ut=document.getElementById("exportBatchRun"),Nn=document.getElementById("exportBatchStatus"),Un=document.getElementById("exportBatchPathName"),Wa=document.getElementById("exportBatchChoosePath"),un=document.getElementById("exportBatchClearPath"),it=document.getElementById("deleteConfirmOverlay"),rr=document.getElementById("deleteConfirmMessage"),lr=document.getElementById("deleteConfirmButton"),sr=document.getElementById("deleteConfirmCancel"),bt=document.getElementById("unifiedPanel"),cr=document.getElementById("unifiedPanelGear"),_t=document.getElementById("unifiedPanelGroups"),wo=document.getElementById("globalCheckpoints"),ur=document.getElementById("unifiedDiceButton"),dr=document.getElementById("unifiedWaveButton"),Ot=document.getElementById("unifiedPauseButton"),fr=document.getElementById("unifiedUndoButton"),pr=document.getElementById("unifiedRedoButton"),Ea=document.getElementById("unifiedCheckpointSlots"),ko=document.getElementById("unifiedCheckpointAddShell");document.getElementById("unifiedCheckpointAdd");const mr=document.getElementById("topbarReloadButton"),re=document.getElementById("thumbHoverPreview"),hr=document.getElementById("thumbHoverPreviewTitle"),So=document.getElementById("thumbHoverPreviewHero"),_n=document.getElementById("thumbHoverPreviewCheckpoints");let Co="settings";function vr(){Zi.textContent=ye()?.name||"Profile"}function gr(e){try{Qa(e),window.location.reload()}catch(t){Xe.textContent=t instanceof Error?t.message:"Unable to switch profile."}}function Eo(){const e=D.contentWindow;try{e?.ShaderOpsControls?.suspendPersistence?.()}catch{}l.selectedId&&e?.postMessage({type:"shaderops/suspend-persistence",projectId:l.selectedId},"*")}function Do(){const e=D.contentWindow;try{e?.ShaderOpsControls?.resumePersistence?.()}catch{}l.selectedId&&e?.postMessage({type:"shaderops/resume-persistence",projectId:l.selectedId},"*")}function Mo(){const e=Fe(),t=ye()?.id;Ca.replaceChildren(),Ca.hidden=e.length===0,e.forEach(a=>{const n=document.createElement("span");n.className=`profile-existing-list__item${a.id===t?" is-active":""}`;const o=document.createElement("button");o.type="button",o.className="profile-existing-list__switch",o.textContent=a.name,o.title=`Switch to ${a.name}`,o.addEventListener("click",()=>gr(a.id));const i=document.createElement("button");i.type="button",i.className="profile-existing-list__delete",i.textContent="×",i.title=`Delete ${a.name}`,i.setAttribute("aria-label",`Delete ${a.name}`),i.addEventListener("click",async()=>{if(!window.confirm(`Delete profile "${a.name}" from this browser?`))return;const r=a.id===ye()?.id;try{r&&Eo(),await Promise.all([Sa(`shaderops-cache:project-previews:v2:${a.id}`),Sa(`shaderops-cache:project-revisions:v1:${a.id}`),Sa(`${nn}${a.id}:`)]),Ti(a.id),r?window.location.reload():Mo()}catch(s){r&&Do(),Xe.textContent=s instanceof Error?s.message:"Unable to delete this profile."}}),n.append(o,i),Ca.appendChild(n)})}function Io(e){Co=e;const t=ye(),a=e==="onboarding";Qi.textContent=a?"Welcome to ShaderOps":"Profile & recovery",er.textContent=a?"Choose a name once. Your favorites, checkpoints, looks, and filters save automatically on this computer.":`Working as ${t?.name||"this profile"}. Your work is stored locally and saves automatically.`,Dt.value="",Dt.placeholder=a?"Your name":"Create another profile",bo.textContent=a?"Continue":"Create profile",xo.hidden=a||!t,ar.hidden=a,tr.hidden=a,Xe.textContent="",Mo(),Nt.hidden=!1,window.setTimeout(()=>Dt.focus(),0)}function Po(){try{const e=Bi(Dt.value);Qa(e.id),window.location.reload()}catch(e){Xe.textContent=e instanceof Error?e.message:"Enter a profile name to continue."}}function yr(){try{const e=ye(),t=new Blob([JSON.stringify($i(),null,2)],{type:"application/json"}),a=URL.createObjectURL(t),n=document.createElement("a");n.href=a,n.download=`${(e?.name||"shaderops-profile").replace(/[^\w.-]+/g,"-")}.shaderops-profile.json`,n.click(),URL.revokeObjectURL(a),Xe.textContent="Recovery file downloaded."}catch(e){Xe.textContent=e instanceof Error?e.message:"Unable to create recovery file."}}async function br(e){if(e)try{const t=JSON.parse(await e.text()),a=Fe().map(i=>i.name),n=a.length?` Existing profiles that will be replaced: ${a.join(", ")}.`:"";if(!window.confirm(`Restore this recovery file and replace all ShaderOps data in this browser?${n}`))return;await Gi(),aa.clear(),Eo();const o=Ui(t);Qa(o.id),window.location.reload()}catch(t){Do(),Xe.textContent=t instanceof Error?t.message:"Unable to restore this recovery file."}finally{qa.value=""}}Ji.addEventListener("click",()=>Io("settings"));bo.addEventListener("click",Po);Dt.addEventListener("keydown",e=>{e.key==="Enter"&&Po()});xo.addEventListener("click",yr);qa.addEventListener("change",()=>br(qa.files?.[0]));Nt.addEventListener("click",e=>{e.target===Nt&&Co!=="onboarding"&&(Nt.hidden=!0)});vr();ye()||Io("onboarding");const dn="shaderops:unified-panel-collapsed:v1",On=["Global","Color"],q=new Map,at=new Map;function Ao(e){return!!(e&&e.bridged)}function Je(){const e=l.projects.find(t=>t.id===l.selectedId);return Ao(e)?e.id:null}function $e(e,t,a){D.contentWindow?.postMessage({type:"shaderops/action",projectId:e,action:t,payload:a},"*")}function et(e,t,a,n){D.contentWindow?.postMessage({type:"shaderops/set-param",projectId:e,id:t,value:a,commit:n},"*")}function Xt(e,t,a,n=!0){D.contentWindow?.postMessage({type:"shaderops/set-state",projectId:e,payload:{params:t,extras:a},commit:n},"*")}function xr(e,t=1500){return new Promise(a=>{const n=()=>a(!0),o=at.get(e)||[];o.push(n),at.set(e,o),setTimeout(()=>{const i=at.get(e);!i||!i.includes(n)||(at.set(e,i.filter(r=>r!==n)),a(!1))},t)})}const ja=new Map,zt=new Map;function Bo(e){return`${zi}${e}`}function Va(){return{loaded:!0,name:Ye,sourcePath:yt}}function To(e){if(!Be(e))return Va();const t=e.loaded!==!1,a=typeof e.name=="string"&&e.name.trim()?e.name.trim():Ye,n=typeof e.sourcePath=="string"&&e.sourcePath.trim()?e.sourcePath.trim():yt;return t?{loaded:!0,name:a,sourcePath:n}:Va()}function wr(e,t){E.setItem(Bo(e),JSON.stringify(t))}function fn(e,t){const a=To(t);return ja.set(e,a),wr(e,a),a}function ia(e){const t=ja.get(e);if(t)return t;const a=be(E.getItem(Bo(e)),null),n=To(a);return ja.set(e,n),n}function ra(e){return Array.isArray(e)&&e.some(t=>t&&t.type==="image-loader")}function kr(e){return new Promise((t,a)=>{const n=new Image;n.onload=()=>{const i=Math.min(1,1024/Math.max(n.width,n.height)),r=Math.max(1,Math.floor(n.width*i)),s=Math.max(1,Math.floor(n.height*i)),c=document.createElement("canvas");c.width=r,c.height=s;const u=c.getContext("2d",{willReadFrequently:!0});u.drawImage(n,0,0,r,s),t({imageData:u.getImageData(0,0,r,s),dataUrl:c.toDataURL("image/png")})},n.onerror=()=>a(new Error(`Unable to decode image source: ${e.slice(0,64)}`)),n.src=e})}function Sr(e){return e===yt?Ei:e}async function Cr(e){const t=typeof e=="string"&&e.trim()?e.trim():yt,a=t;if(!zt.has(a)){const n=Sr(t);zt.set(a,kr(n).then(({imageData:o})=>o))}return zt.get(a)}async function pn(e,t,a){if(!e||!a||!a.loaded||!a.sourcePath)return!1;const n=await Cr(a.sourcePath);return e.postMessage({type:"shaderops/image-load",projectId:t,name:a.name||Ye,sourcePath:a.sourcePath,imageData:n},"*"),!0}async function Kt(e,t=D.contentWindow){const a=fn(e,Va());await pn(t,e,a),l.selectedId===e&&ae(e)}async function Er(e,t=D.contentWindow){const a=ia(e);try{if(await pn(t,e,a)){l.selectedId===e&&ae(e);return}}catch(n){console.warn(`ShaderOps: failed to restore image source for ${e}, falling back to Default.`,n)}await Kt(e,t)}async function Dr(e,t,a,n=D.contentWindow){const o=typeof t=="string"?t.trim():"";if(!o){await Kt(e,n);return}const i=fn(e,{loaded:!0,name:a||Ye,sourcePath:o});try{await pn(n,e,i)}catch(r){console.warn(`ShaderOps: checkpoint image path restore failed for ${e}; using Default.`,r),await Kt(e,n);return}l.selectedId===e&&ae(e)}let ue=null;function Mr(e){ue&&ue.remove(),ue=document.createElement("input"),ue.type="file",ue.accept="image/*",ue.style.display="none",document.body.appendChild(ue),ue.addEventListener("change",()=>{const t=ue.files&&ue.files[0];if(!t)return;const a=URL.createObjectURL(t),n=new Image;n.onload=()=>{const i=Math.min(1,1024/Math.max(n.width,n.height)),r=Math.max(1,Math.floor(n.width*i)),s=Math.max(1,Math.floor(n.height*i)),c=document.createElement("canvas");c.width=r,c.height=s;const u=c.getContext("2d",{willReadFrequently:!0});u.drawImage(n,0,0,r,s);const d=u.getImageData(0,0,r,s),f=c.toDataURL("image/png");fn(e,{loaded:!0,name:t.name||"image",sourcePath:f}),zt.set(f,Promise.resolve(d)),D.contentWindow?.postMessage({type:"shaderops/image-load",projectId:e,name:t.name,sourcePath:f,imageData:d},"*"),URL.revokeObjectURL(a),l.selectedId===e&&ae(e)},n.onerror=()=>URL.revokeObjectURL(a),n.src=a}),ue.click()}function Ir(e){Kt(e,D.contentWindow)}function Lo(e){Ot.querySelector(".icon-play").classList.toggle("is-hidden",!e),Ot.querySelector(".icon-pause").classList.toggle("is-hidden",!!e),Ot.title=e?"Resume (Space)":"Pause (Space)"}function Ro(){bt.hidden=!1,wo.hidden=!1}function Da(){bt.hidden=!0,wo.hidden=!0}function Fo(e){return`shaderops:locked-controls:${e}`}function $o(e){const t=be(E.getItem(Fo(e)),[]);return new Set(Array.isArray(t)?t:[])}function Ht(e,t){E.setItem(Fo(e),JSON.stringify([...t]))}function Ma(){return`<svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  </svg>`}function la(e){const t=q.get(e);if(!t)return;const a={};t.lockedIds.forEach(n=>{n in t.params&&(a[n]=t.params[n])}),t.pendingLockRestore=Object.keys(a).length?a:null,$e(e,"randomizeAll")}function No(e){return`shaderops:unified-checkpoints:${e}`}function Uo(e){const t=ye()?.id||"default";return`${nn}${t}:${e}`}function Ze(e){const t=be(E.getItem(No(e)),null);if(t&&Array.isArray(t.slots)){const a=aa.get(Uo(e))||{};return{slots:t.slots.map(n=>n&&typeof n=="object"&&typeof a?.[n.id]=="string"?{...n,preview:a[n.id]}:n),nextId:t.nextId||t.slots.length+1,activeId:t.activeId??null}}return{slots:[],nextId:1,activeId:null}}function sa(e,t){const a={},n=t.slots.map(i=>{if(!i||typeof i!="object")return i;typeof i.preview=="string"&&(a[i.id]=i.preview);const{preview:r,...s}=i;return s});E.setItem(No(e),JSON.stringify({...t,slots:n}));const o=Uo(e);aa.set(o,a),$a(o,a).catch(i=>{console.warn("ShaderOps: checkpoint preview cache is full; keeping checkpoint data without images.",i)})}function _o(e,t){try{return JSON.parse(JSON.stringify(e))}catch{return t}}async function Oo(e){return e!==l.selectedId||await va(),l.previews[e]||null}function Xa(e,t){const a=q.get(e);if(!a)return;const n=Ze(e),o=n.slots.find(s=>s.id===t);if(!o)return;const i={};Object.entries(o.values||{}).forEach(([s,c])=>{s in a.params&&(i[s]=c)}),Object.assign(a.params,i);const r=o.extras&&typeof o.extras=="object";r&&Object.assign(a.extras,o.extras),Xt(e,i,r?o.extras:void 0,!0),o.filters&&Array.isArray(o.filters.stack)&&(B(e),l.filterPreviewOn[e]=o.filters.previewOn!==!1,vn(e,JSON.stringify(o.filters.stack))),ra(a.schema)&&Object.prototype.hasOwnProperty.call(o,"imagePath")&&Dr(e,o.imagePath,o.imageName,D.contentWindow),n.activeId=t,sa(e,n),l.selectedId===e&&mn(e),Rt(e)}async function Pr(e,t){const a=q.get(e);if(!a)return;const n=Ze(e),o=n.slots.find(i=>i.id===t);if(o){if(o.values={...a.params},o.extras=_o(a.extras||{},{}),o.filters={stack:JSON.parse(xt(e)),previewOn:Ne(e)},ra(a.schema)){const i=ia(e);o.imagePath=i.sourcePath||yt,o.imageName=i.name||Ye}o.preview=await Oo(e),n.activeId=t,sa(e,n),Rt(e)}}function Ar(e,t){const a=Ze(e);a.slots=a.slots.filter(n=>n.id!==t),a.activeId===t&&(a.activeId=null),sa(e,a),Rt(e)}async function Br(e){const t=q.get(e);if(!t)return;const a=Ze(e),n=a.nextId++,o=await Oo(e),i={id:n,values:{...t.params},extras:_o(t.extras||{},{}),filters:{stack:JSON.parse(xt(e)),previewOn:Ne(e)},preview:o};if(ra(t.schema)){const r=ia(e);i.imagePath=r.sourcePath||yt,i.imageName=r.name||Ye}a.slots.push(i),a.activeId=n,sa(e,a),Rt(e)}function zo(e,{onTap:t,onHoldComplete:a,holdMs:n=800}={}){const o=e.querySelector(".ucp-ring");let i=null,r=!1,s=!1;const c=()=>{i&&(clearTimeout(i),i=null),e.classList.remove("holding")},u=p=>{p.button!==void 0&&p.button!==0||(r=!0,s=!1,e.classList.add("holding"),o&&o.style.setProperty("--ucp-ring-duration",`${n}ms`),i=setTimeout(()=>{s=!0,e.classList.remove("holding"),e.classList.add("completed"),setTimeout(()=>e.classList.remove("completed"),260),a?.()},n))},d=()=>{r&&(r=!1,c(),s||t?.())},f=()=>{r&&(r=!1,c())};e.addEventListener("pointerdown",u),e.addEventListener("pointerup",d),e.addEventListener("pointerleave",f),e.addEventListener("pointercancel",f)}let ke=null;function Tr(){return ke||(ke=document.createElement("div"),ke.className="ucp-menu",ke.hidden=!0,document.body.appendChild(ke),document.addEventListener("click",()=>Ka()),window.addEventListener("blur",()=>Ka()),ke)}function Ka(){ke&&(ke.hidden=!0)}function Lr(e,t,a){const n=Tr();n.innerHTML="",a.forEach(s=>{const c=document.createElement("button");c.type="button",c.className="ucp-menu-item",c.textContent=s.label,c.addEventListener("click",u=>{u.stopPropagation(),Ka(),s.onClick()}),n.appendChild(c)}),n.hidden=!1;const o=n.getBoundingClientRect(),i=Math.min(e,window.innerWidth-o.width-8),r=Math.min(t,window.innerHeight-o.height-8);n.style.left=`${Math.max(8,i)}px`,n.style.top=`${Math.max(8,r)}px`}function Rt(e){Ea.innerHTML="";const t=Ze(e);t.slots.forEach((a,n)=>{const o=document.createElement("span");o.className="ucp-btn-shell",t.activeId===a.id&&o.classList.add("is-active");const i=document.createElement("button");i.type="button",i.className="ucp-slot",i.textContent=String(n+1),i.title="Tap: load this checkpoint Â· Hold 0.8s: overwrite with the current look Â· Right-click: delete",o.appendChild(i);const r=document.createElementNS("http://www.w3.org/2000/svg","svg");r.setAttribute("viewBox","0 0 30 30"),r.setAttribute("class","ucp-ring"),r.setAttribute("aria-hidden","true");const s=document.createElementNS("http://www.w3.org/2000/svg","circle");s.setAttribute("cx","15"),s.setAttribute("cy","15"),s.setAttribute("r","13.3"),s.setAttribute("pathLength","100"),r.appendChild(s),o.appendChild(r),zo(o,{onTap:()=>Xa(e,a.id),onHoldComplete:()=>{Pr(e,a.id)}}),o.addEventListener("contextmenu",c=>{c.preventDefault(),Lr(c.clientX,c.clientY,[{label:"Delete checkpoint",onClick:()=>Ar(e,a.id)}])}),Ea.appendChild(o)}),Ea.appendChild(ko)}function rt(e,t){if(!e||!e.showIf)return!0;const a=e.showIf;if(typeof a=="function")try{return!!a(t||{})}catch{return!0}if(typeof a=="string")return!!(t||{})[a];if(Array.isArray(a))return a.every(n=>rt({showIf:n},t));if(a&&typeof a=="object"){if(Array.isArray(a.all))return a.all.every(n=>rt({showIf:n},t));if(Array.isArray(a.any))return a.any.some(n=>rt({showIf:n},t));if(a.eq&&typeof a.eq=="object")return Object.entries(a.eq).every(([n,o])=>String((t||{})[n])===String(o));if(a.neq&&typeof a.neq=="object")return Object.entries(a.neq).every(([n,o])=>String((t||{})[n])!==String(o))}return!0}function ae(e){const t=q.get(e);if(!t)return;t.lockedIds||(t.lockedIds=$o(e)),_t.innerHTML="";const a=new Map;(t.schema||[]).filter(c=>!c.hidden&&rt(c,t.params)).forEach(c=>{const u=c.group||"Controls";a.has(u)||a.set(u,[]),a.get(u).push(c)});const n=[...On.filter(c=>a.has(c)),...[...a.keys()].filter(c=>!On.includes(c))],o=`shaderops:unified-group-collapsed:${e}`,i=be(E.getItem(o),{}),r=(c,u)=>{const d=document.createElement("button");d.type="button",d.className="shaderops-lock-button",d.innerHTML=Ma();const f=()=>{const p=t.lockedIds.has(c);d.classList.toggle("is-locked",p),u&&u.classList.toggle("is-locked",p),d.title=p?"Unlock this value":"Lock this value (skip on All Random)"};return f(),d.addEventListener("click",p=>{p.preventDefault(),p.stopPropagation(),t.lockedIds.has(c)?t.lockedIds.delete(c):t.lockedIds.add(c),Ht(e,t.lockedIds),f()}),d},s=(c,u)=>{const d=String(c||"").trim(),f=String(u||"").trim();return f?`${d}
${f}`:d};n.forEach((c,u)=>{const d=a.get(c),f=document.createElement("div");f.className="unified-control-group";const p=c.toLowerCase();i[p]&&f.classList.add("is-collapsed");const h=document.createElement("h3");h.textContent=c,h.setAttribute("role","button"),h.setAttribute("tabindex","0");const v=()=>{f.classList.toggle("is-collapsed"),i[p]=f.classList.contains("is-collapsed"),E.setItem(o,JSON.stringify(i))};if(h.addEventListener("click",v),h.addEventListener("keydown",m=>{(m.key==="Enter"||m.key===" ")&&(m.preventDefault(),v())}),f.appendChild(h),u===0){const m=document.createElement("button");m.type="button",m.className="unified-panel-close",m.title="Collapse controls",m.innerHTML='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" aria-hidden="true"><path d="M3.5 3.5l9 9M12.5 3.5l-9 9"/></svg>',m.addEventListener("click",g=>{g.preventDefault(),g.stopPropagation(),Ho()}),h.appendChild(m)}d.forEach(m=>{const g=document.createElement("div");g.dataset.controlId=m.id;const S=document.createElement("label"),M=String(m.label||m.id);if(S.textContent=M,S.title=s(M,m.hint),m.type==="shape-stack"){g.className="filter-param-row filter-param-row--shape-stack";const b=document.createElement("div");b.className="shaderops-shape-stack";const T=Array.isArray(m.shapes)?m.shapes:[],N=t.params[m.selectedParam],k=T.find(ee=>String(ee.value)===String(N))||null,I=T.filter(ee=>Number(t.params[ee.enabledParam])>.5),Y=document.createElement("button");if(Y.type="button",Y.className="shaderops-shape-stack-trigger",Y.textContent=k?`${k.label} Â· ${I.length} active`:`${I.length} active`,Y.addEventListener("click",()=>{t.openShapeStackId=t.openShapeStackId===m.id?null:m.id,ae(e)}),b.appendChild(Y),t.openShapeStackId===m.id){const ee=document.createElement("div");ee.className="shaderops-shape-stack-menu",T.forEach(w=>{const H=document.createElement("div");H.className="shaderops-shape-stack-item",k&&String(k.value)===String(w.value)&&H.classList.add("is-selected");const te=document.createElement("input");te.type="checkbox",te.checked=Number(t.params[w.enabledParam])>.5,te.addEventListener("click",P=>P.stopPropagation()),te.addEventListener("change",()=>{const P={[w.enabledParam]:te.checked?1:0};if(te.checked)P[m.selectedParam]=w.value;else if(String(t.params[m.selectedParam])===String(w.value)){const Ct=T.find(Ie=>Ie!==w&&Number(t.params[Ie.enabledParam])>.5);P[m.selectedParam]=Ct?Ct.value:0}Object.assign(t.params,P),Xt(e,P,void 0,!0),ae(e)});const Me=document.createElement("button");Me.type="button",Me.className="shaderops-shape-stack-item-button",Me.textContent=w.label,Me.addEventListener("click",()=>{const P={[w.enabledParam]:1,[m.selectedParam]:w.value};Object.assign(t.params,P),Xt(e,P,void 0,!0),ae(e)}),H.appendChild(te),H.appendChild(Me),ee.appendChild(H)}),b.appendChild(ee)}if(k&&Array.isArray(k.controls)&&Number(t.params[k.enabledParam])>.5){const ee=document.createElement("div");ee.className="shaderops-shape-stack-detail",k.controls.filter(w=>!w.hidden&&rt(w,t.params)).forEach(w=>{const H=document.createElement("div");H.dataset.controlId=w.id;const te=document.createElement("label"),Me=String(w.label||w.id);if(te.textContent=Me,te.title=s(Me,w.hint),w.type==="select"){H.className="filter-param-row filter-param-row--select";const U=document.createElement("select");U.className="filter-param-select";const Et=t.params[w.id]??w.default??0;(w.options||[]).forEach(ze=>{const He=document.createElement("option");He.value=String(ze.value),He.textContent=ze.label,String(ze.value)===String(Et)&&(He.selected=!0),U.appendChild(He)}),U.addEventListener("change",()=>{const ze=U.value,He=Number(ze),Pn=Number.isFinite(He)&&ze.trim()!==""?He:ze;t.params[w.id]=Pn,et(e,w.id,Pn,!0)});const Oe=document.createElement("span");Oe.className="shaderops-lock-wrap shaderops-lock-wrap--aux shaderops-lock-wrap--full",Oe.appendChild(U),Oe.appendChild(r(w.id,Oe)),H.appendChild(te),H.appendChild(Oe),ee.appendChild(H);return}H.className="filter-param-row";const P=document.createElement("input");P.type="range",P.min=String(w.min??0),P.max=String(w.max??1),P.step=String(w.step??.01),w.pillMode&&(P.dataset.pillMode=String(w.pillMode));const Ct=t.params[w.id]??w.default??0;P.value=String(Ct);const Ie=document.createElement("span");Ie.className="shaderops-lock-wrap";const Ue=document.createElement("input");Ue.type="number",Ue.step=P.step,Ue.value=String(Ct);const _e=document.createElement("button");_e.type="button",_e.className="shaderops-lock-button",_e.innerHTML=Ma();const In=()=>{const U=t.lockedIds.has(w.id);_e.classList.toggle("is-locked",U),Ie.classList.toggle("is-locked",U),_e.title=U?"Unlock this value":"Lock this value (skip on All Random)"};In(),_e.addEventListener("click",U=>{U.preventDefault(),U.stopPropagation(),t.lockedIds.has(w.id)?t.lockedIds.delete(w.id):t.lockedIds.add(w.id),Ht(e,t.lockedIds),In()});const wa=(U,Et)=>{t.params[w.id]=U,et(e,w.id,U,Et)};P.addEventListener("input",()=>{const U=Number(P.value);Ue.value=P.value,wa(U,!1)}),P.addEventListener("change",()=>{wa(Number(P.value),!0)}),Ue.addEventListener("change",()=>{let U=Number(Ue.value);Number.isFinite(U)||(U=Number(P.value));const Et=Number(P.min),Oe=Number(P.max);P.value=String(Math.min(Oe,Math.max(Et,U))),wa(U,!0)}),Ie.appendChild(Ue),Ie.appendChild(_e),H.appendChild(te),H.appendChild(P),H.appendChild(Ie),ee.appendChild(H)}),b.appendChild(ee)}g.appendChild(S),g.appendChild(b),f.appendChild(g);return}if(m.type==="image-loader"){g.className="filter-param-row filter-param-row--image-loader";const b=ia(e),T=document.createElement("button");T.type="button",T.className="image-loader-load",T.textContent="Load Image",T.title="Load an image â€” strokes will sample its colors",T.addEventListener("click",()=>Mr(e));const N=document.createElement("span");N.className="image-loader-name",N.textContent=b.loaded?b.name:Ye,N.title=b.loaded?b.name:"Using default image";const k=document.createElement("button");k.type="button",k.className="image-loader-clear",k.textContent="✕",k.title="Reset to Default image",k.hidden=!b.loaded,k.addEventListener("click",()=>Ir(e));const I=document.createElement("span");I.className="image-loader-wrap",I.appendChild(T),I.appendChild(N),I.appendChild(k),g.appendChild(S),g.appendChild(I),f.appendChild(g);return}if(m.type==="toggle"){g.className="filter-param-row filter-param-row--toggle";const b=Number(t.params[m.id]??m.default??0)>.5,T=document.createElement("label");T.className="filter-param-switch",T.innerHTML=`
        ...
        `;const N=T.querySelector(".filter-param-toggle");N.addEventListener("change",()=>{const I=N.checked?1:0;t.params[m.id]=I,et(e,m.id,I,!0),ae(e)});const k=document.createElement("span");k.className="shaderops-lock-wrap shaderops-lock-wrap--aux",k.appendChild(T),k.appendChild(r(m.id,k)),g.appendChild(S),g.appendChild(k),f.appendChild(g);return}if(m.type==="select"){g.className="filter-param-row filter-param-row--select";const b=document.createElement("select");b.className="filter-param-select";const T=t.params[m.id]??m.default??0;(m.options||[]).forEach(k=>{const I=document.createElement("option");I.value=String(k.value),I.textContent=k.label,String(k.value)===String(T)&&(I.selected=!0),b.appendChild(I)}),b.addEventListener("change",()=>{const k=b.value,I=Number(k),Y=Number.isFinite(I)&&k.trim()!==""?I:k;t.params[m.id]=Y,et(e,m.id,Y,!0),ae(e)});const N=document.createElement("span");N.className="shaderops-lock-wrap shaderops-lock-wrap--aux shaderops-lock-wrap--full",N.appendChild(b),N.appendChild(r(m.id,N)),g.appendChild(S),g.appendChild(N),f.appendChild(g);return}g.className="filter-param-row";const x=document.createElement("input");x.type="range",x.min=String(m.min??0),x.max=String(m.max??1),x.step=String(m.step??.01),m.pillMode&&(x.dataset.pillMode=String(m.pillMode));const V=t.params[m.id]??m.default??0;x.value=String(V);const se=document.createElement("span");se.className="shaderops-lock-wrap";const Q=document.createElement("input");Q.type="number",Q.step=x.step,Q.value=String(V);const ce=document.createElement("button");ce.type="button",ce.className="shaderops-lock-button",ce.innerHTML=Ma();const St=()=>{const b=t.lockedIds.has(m.id);ce.classList.toggle("is-locked",b),se.classList.toggle("is-locked",b),ce.title=b?"Unlock this value":"Lock this value (skip on All Random)"};St(),ce.addEventListener("click",b=>{b.preventDefault(),b.stopPropagation(),t.lockedIds.has(m.id)?t.lockedIds.delete(m.id):t.lockedIds.add(m.id),Ht(e,t.lockedIds),St()});const Qe=(b,T)=>{t.params[m.id]=b,et(e,m.id,b,T)};x.addEventListener("input",()=>{const b=Number(x.value);Q.value=x.value,Qe(b,!1)}),x.addEventListener("change",()=>{Qe(Number(x.value),!0)}),Q.addEventListener("change",()=>{let b=Number(Q.value);Number.isFinite(b)||(b=Number(x.value));const T=Number(x.min),N=Number(x.max);x.value=String(Math.min(N,Math.max(T,b))),Qe(b,!0)}),se.appendChild(Q),se.appendChild(ce),g.appendChild(S),g.appendChild(x),g.appendChild(se),f.appendChild(g)}),_t.appendChild(f)}),rn(_t),Lo(!!t.extras.paused),Rt(e)}function mn(e){const t=q.get(e);if(t){if((t.schema||[]).some(a=>a.type==="shape-stack")){ae(e);return}_t.querySelectorAll(".filter-param-row").forEach(a=>{const n=a.dataset.controlId;if(!(n in t.params))return;const o=a.querySelector('input[type="range"]'),i=a.querySelector('input[type="number"]'),r=a.querySelector("select.filter-param-select"),s=a.querySelector("input.filter-param-toggle"),c=t.params[n];o&&document.activeElement!==o&&(o.value=String(c)),i&&document.activeElement!==i&&(i.value=String(c)),r&&document.activeElement!==r&&(r.value=String(c)),s&&document.activeElement!==s&&(s.checked=Number(c)>.5)}),Lo(!!t.extras.paused)}}function Rr(e,t=null){const{type:a,projectId:n}=e;if(n){if(a==="shaderops/ready"){const o=Array.isArray(e.schema)?e.schema:[];if(q.set(n,{schema:o,params:{...e.values||{}},extras:{...e.extras||{}},lockedIds:$o(n)}),ra(o)){const i=t&&typeof t.postMessage=="function"?t:D.contentWindow;Er(n,i)}l.selectedId===n&&(ae(n),Ro(),lt())}else if(a==="shaderops/values-changed"){const o=q.get(n);if(!o)return;if(e.values&&Object.assign(o.params,e.values),e.extras&&Object.assign(o.extras,e.extras),o.pendingLockRestore){const r=o.pendingLockRestore;o.pendingLockRestore=null,Object.entries(r).forEach(([s,c])=>{o.params[s]=c,et(n,s,c,!0)})}const i=at.get(n);i&&i.length&&(at.set(n,[]),i.forEach(r=>{try{r()}catch{}})),l.selectedId===n&&mn(n)}else if(a==="shaderops/keydown"){if(l.selectedId!==n)return;e.key==="r"?la(n):e.key==="space"&&$e(n,"togglePause")}}}cr.addEventListener("click",()=>{bt.classList.remove("is-collapsed"),E.setItem(dn,"0")});function Ho(){bt.classList.add("is-collapsed"),E.setItem(dn,"1")}bt.addEventListener("dblclick",e=>{e.target.closest(".unified-panel-body")||Ho()});ur.addEventListener("click",()=>{const e=Je();e&&la(e)});dr.addEventListener("click",()=>{const e=Je();e&&$e(e,"rerollSeed")});Ot.addEventListener("click",()=>{const e=Je();e&&$e(e,"togglePause")});fr.addEventListener("click",()=>{const e=Je();e&&$e(e,"undo")});pr.addEventListener("click",()=>{const e=Je();e&&$e(e,"redo")});mr?.addEventListener("click",()=>{window.location.reload()});zo(ko,{onHoldComplete:()=>{const e=Je();e&&Br(e)}});document.addEventListener("keydown",e=>{const t=Je();t&&(e.target?.matches("input, textarea, select, button")||((e.key==="r"||e.key==="R")&&!e.metaKey&&!e.ctrlKey&&!e.altKey?(e.preventDefault(),la(t)):e.code==="Space"&&(e.preventDefault(),$e(t,"togglePause"))))});E.getItem(dn)==="1"&&bt.classList.add("is-collapsed");function be(e,t){if(e==null)return t;try{const a=JSON.parse(e);return a??t}catch{return t}}function Be(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}function Fr(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";let t="";for(let a=0;a<3;a++)t+=e[Math.floor(Math.random()*e.length)];return t}function qo(e,t=""){const a=new Date,n=String(a.getFullYear()),o=String(a.getMonth()+1).padStart(2,"0"),i=String(a.getDate()).padStart(2,"0"),r=String(a.getHours()).padStart(2,"0"),s=String(a.getMinutes()).padStart(2,"0"),c=String(a.getSeconds()).padStart(2,"0"),u=String(t||"").trim(),d=u?`-${u}`:"";return`${e||"shader"}-${n}${o}${i}-${r}${s}${c}${d}-${Fr()}.png`}function $r(e){const t=q.get(e),a=JSON.parse(xt(e));return{source:"shaderops-png-state",schemaVersion:Fa,exportedAt:new Date().toISOString(),projectId:e,bridge:{params:t?{...t.params}:{},extras:t?{...t.extras}:{},lockedIds:t&&t.lockedIds?[...t.lockedIds]:[]},filters:{previewOn:Ne(e),stack:Array.isArray(a)?a:[]}}}function Nr(e,t=2500){return q.has(e)?Promise.resolve(!0):new Promise(a=>{const n=performance.now(),o=()=>{if(q.has(e)){a(!0);return}if(performance.now()-n>=t){a(!1);return}requestAnimationFrame(o)};o()})}const We=new Uint8Array([137,80,78,71,13,10,26,10]),Yt=new TextEncoder,Go=new TextDecoder,Ur=(()=>{const e=new Uint32Array(256);for(let t=0;t<256;t++){let a=t;for(let n=0;n<8;n++)a=a&1?3988292384^a>>>1:a>>>1;e[t]=a>>>0}return e})();function _r(e){let t=4294967295;for(let a=0;a<e.length;a++)t=Ur[(t^e[a])&255]^t>>>8;return(t^4294967295)>>>0}function Or(e,t){const a=new Uint8Array(12+t.length),n=new DataView(a.buffer);n.setUint32(0,t.length),a.set(e,4),a.set(t,8);const o=new Uint8Array(4+t.length);return o.set(e,0),o.set(t,4),n.setUint32(8+t.length,_r(o)),a}function zr(e){const t=e.reduce((o,i)=>o+i.length,0),a=new Uint8Array(t);let n=0;for(const o of e)a.set(o,n),n+=o.length;return a}function Hr(e){if(!e||typeof e!="string")return null;const t=e.indexOf(",");if(t===-1)return null;const a=e.slice(t+1),n=atob(a),o=new Uint8Array(n.length);for(let i=0;i<n.length;i++)o[i]=n.charCodeAt(i);return o}function qr(e,t){const a=Yt.encode(e),n=Yt.encode(t),o=new Uint8Array(a.length+5+n.length);o.set(a,0);let i=a.length;return o[i++]=0,o[i++]=0,o[i++]=0,o[i++]=0,o[i++]=0,o.set(n,i),o}function Gr(e,t,a){if(!e||e.length<12)throw new Error("PNG data is empty.");for(let u=0;u<We.length;u++)if(e[u]!==We[u])throw new Error("Exported image is not a valid PNG.");const n=Yt.encode(t),o=Yt.encode("iTXt"),i=Or(o,qr(t,a)),r=[We];let s=We.length,c=!1;for(;s+12<=e.length;){const d=new DataView(e.buffer,e.byteOffset+s,8).getUint32(0),f=s+4,p=s+8,h=d+12;if(s+h>e.length)throw new Error("PNG chunk stream is truncated.");const v=e.subarray(f,f+4),m=e.subarray(p,p+d),S=v[0]===105&&v[1]===84&&v[2]===88&&v[3]===116&&m.length>=n.length+1&&m.subarray(0,n.length).every((x,V)=>x===n[V])&&m[n.length]===0,M=v[0]===73&&v[1]===69&&v[2]===78&&v[3]===68;S||(!c&&M&&(r.push(i),c=!0),r.push(e.subarray(s,s+h))),s+=h}return c||r.push(i),zr(r)}function Ia(e,t){let a=t;for(;a<e.length&&e[a]!==0;)a+=1;return{text:Go.decode(e.subarray(t,a)),next:a+1}}function Wr(e,t){if(!e||e.length<12)return null;for(let n=0;n<We.length;n++)if(e[n]!==We[n])return null;let a=We.length;for(;a+12<=e.length;){const o=new DataView(e.buffer,e.byteOffset+a,8).getUint32(0),i=a+4,r=a+8,s=o+12;if(a+s>e.length)return null;const c=e.subarray(i,i+4),u=e.subarray(r,r+o),d=String.fromCharCode(c[0],c[1],c[2],c[3]);if(d==="iTXt"){const f=Ia(u,0);if(f.text===t&&f.next+3<=u.length){const p=u[f.next];let h=f.next+2;if(h=Ia(u,h).next,h=Ia(u,h).next,p===0&&h<=u.length)return Go.decode(u.subarray(h))}}if(d==="IEND")break;a+=s}return null}function jr(e){return Be(e)?{stack:(Array.isArray(e.stack)?e.stack:[]).map(n=>!Be(n)||typeof n.defId!="string"||!Re(n.defId)?null:{instanceId:typeof n.instanceId=="string"?n.instanceId:`f${Date.now()}_${Vo++}`,defId:n.defId,enabled:n.enabled!==!1,collapsed:!!n.collapsed,params:{...Za(n.defId),...Be(n.params)?n.params:{}}}).filter(Boolean),previewOn:e.previewOn!==!1}:null}async function Vr(e){if(!Be(e))throw new Error("PNG metadata is invalid JSON.");const t=Number(e.schemaVersion)||1;t>Fa&&console.warn(`PNG state schema v${t} is newer than this app (v${Fa}); applying compatible fields only.`);const a=typeof e.projectId=="string"?e.projectId:null,o=a&&l.projects.some(c=>c.id===a)?a:l.selectedId;if(!o)throw new Error("No target project is available for restore.");if(l.selectedId!==o&&await kn(o),!await Nr(o))throw new Error("Project controls are not ready yet. Please try dropping the PNG again.");const r=q.get(o);if(r&&Be(e.bridge)){const c=Be(e.bridge.params)?{...e.bridge.params}:{},u=Be(e.bridge.extras)?{...e.bridge.extras}:void 0;Xt(o,c,u,!0),Object.assign(r.params,c),u&&Object.assign(r.extras,u),Array.isArray(e.bridge.lockedIds)&&(r.lockedIds=new Set(e.bridge.lockedIds.filter(d=>typeof d=="string")),Ht(o,r.lockedIds)),l.selectedId===o&&mn(o)}const s=jr(e.filters);s&&(l.filterStacks[o]=s.stack,l.filterPreviewOn[o]=s.previewOn,pe(),l.selectedId===o&&F()),xe()}async function Xr(e){if(!e||!/\.png$/i.test(e.name||""))return!1;const t=new Uint8Array(await e.arrayBuffer()),a=Wr(t,go);if(!a)return!1;const n=be(a,null);if(!n)throw new Error("PNG state chunk exists but contains invalid JSON.");return await Vr(n),!0}async function Kr(){const[e,t,a]=await Promise.all([$n(co,{}),$n(uo,{}),qi(`${nn}${an}:`)]);l.previews=e&&typeof e=="object"&&!Array.isArray(e)?e:{},l.previewRevisions=t&&typeof t=="object"&&!Array.isArray(t)?t:{},a.forEach(([n,o])=>{o&&typeof o=="object"&&!Array.isArray(o)&&aa.set(n,o)})}function Yr(){const e=be(E.getItem(po),[]);l.favorites=Array.isArray(e)?e:[]}function Wo(){E.setItem(po,JSON.stringify(l.favorites))}function hn(){E.setItem(mo,JSON.stringify(l.projects.map(e=>e.id)))}function Jr(){const e=be(E.getItem(mo),null);if(!Array.isArray(e)||e.length===0)return;const t=new Map(l.projects.map(i=>[i.id,i])),a=e.map(i=>t.get(i)).filter(Boolean),n=new Set(a.map(i=>i.id)),o=l.projects.filter(i=>!n.has(i.id));l.projects=[...a,...o]}function Zr(){const e=be(E.getItem(ho),null);l.filterAddOrder=e&&typeof e=="object"?e:{}}function Qr(){E.setItem(ho,JSON.stringify(l.filterAddOrder))}function el(e,t){const a=l.filterAddOrder&&l.filterAddOrder[e];if(!Array.isArray(a)||a.length===0)return t;const n=new Map(t.map(s=>[s.id,s])),o=a.map(s=>n.get(s)).filter(Boolean),i=new Set(o.map(s=>s.id)),r=t.filter(s=>!i.has(s.id));return[...o,...r]}async function ca(){const e={...l.previews};Object.keys(e).forEach(t=>{const a=l.currentProjectRevisions[t];a&&(l.previewRevisions[t]=a)});try{await Promise.all([$a(co,e),$a(uo,l.previewRevisions)])}catch(t){console.warn("ShaderOps: unable to persist the IndexedDB thumbnail cache.",t)}}function jo(e,t=320,a=.72){return new Promise(n=>{if(!e||typeof e!="string"||!e.startsWith("data:image")){n(e);return}const o=new Image;o.onload=()=>{const i=Math.min(1,t/(o.width||t)),r=Math.max(1,Math.round((o.width||t)*i)),s=Math.max(1,Math.round((o.height||t)*i));try{const c=document.createElement("canvas");c.width=r,c.height=s,c.getContext("2d").drawImage(o,0,0,r,s),n(c.toDataURL("image/jpeg",a))}catch{n(e)}},o.onerror=()=>n(e),o.src=e})}function tl(){const e=be(E.getItem(fo),{}),t=e&&typeof e=="object"&&!Array.isArray(e)?e:{};Object.entries(t).forEach(([a,n])=>{if(!n||typeof n!="object")return;const o=Array.isArray(n.stack)?n.stack:[];l.filterStacks[a]=o.map(i=>!i||typeof i!="object"?i:{...i,params:{...Za(i.defId),...i.params}}),l.filterPreviewOn[a]=n.previewOn!==!1}),cn.classList.toggle("collapsed",E.getItem(on)==="1")}function pe(){const e={};Object.keys(l.filterStacks).forEach(t=>{e[t]={stack:l.filterStacks[t],previewOn:l.filterPreviewOn[t]!==!1}}),E.setItem(fo,JSON.stringify(e))}function G(e){return l.filterStacks[e]||(l.filterStacks[e]=[]),l.filterStacks[e]}function Ne(e){return l.filterPreviewOn[e]!==!1}function zn(e){return e?Ne(e)&&G(e).some(t=>t&&t.enabled):!1}function ua(e){return l.filterHistory[e]||(l.filterHistory[e]={undoStack:[],redoStack:[],suppress:!1,limit:100}),l.filterHistory[e]}function xt(e){return JSON.stringify(G(e))}function B(e,t){if(!e)return;const a=ua(e);if(a.suppress)return;const n=xt(e);a.undoStack[a.undoStack.length-1]!==n&&(a.undoStack.push(n),a.undoStack.length>a.limit&&a.undoStack.shift(),a.redoStack.length=0)}function vn(e,t){const a=ua(e);let n;try{n=JSON.parse(t)}catch{return}a.suppress=!0,l.filterStacks[e]=n,l.filterPreviewOn[e]===void 0&&(l.filterPreviewOn[e]=!0),pe(),F(),!C.hidden&&z&&l.selectedId===e&&fe(),!A.hidden&&O&&l.selectedId===e&&De(),a.suppress=!1}function al(e){if(!e)return;const t=ua(e);if(t.undoStack.length===0)return;const a=xt(e),n=t.undoStack.pop();t.redoStack.push(a),vn(e,n)}function nl(e){if(!e)return;const t=ua(e);if(t.redoStack.length===0)return;const a=xt(e),n=t.redoStack.pop();t.undoStack.push(a),vn(e,n)}let Vo=1;function ol(e,t){if(!Re(t))return;B(e),G(e).unshift({instanceId:`f${Date.now()}_${Vo++}`,defId:t,enabled:!0,collapsed:!1,params:Za(t)}),l.filterPreviewOn[e]===void 0&&(l.filterPreviewOn[e]=!0),pe(),F()}function il(e,t){const a=G(e),n=a.findIndex(o=>o.instanceId===t);n!==-1&&(B(e),a.splice(n,1),pe(),F())}function rl(e,t){const n=G(e).find(o=>o.instanceId===t);n&&(B(e),n.enabled=!n.enabled,pe(),F())}function ll(e,t){const n=G(e).find(o=>o.instanceId===t);n&&(n.collapsed=!n.collapsed,pe(),F())}function Ce(e,t,a,n,o){const r=G(e).find(s=>s.instanceId===t);r&&(o||B(e),r.params[a]=n,pe())}const sl={oilPaint:{key:"preset",values:{custom:null,paletteKnife:{brushType:"palette",brushSize:10.5,strokeStrength:.84,detail:.74,edgeBlend:.33,strokePresence:.86,mix:.92},softBrush:{brushType:"round",brushSize:14,strokeStrength:.62,detail:.52,edgeBlend:.72,strokePresence:.56,mix:.78}}},filmEmulation:{key:"stock",values:{neutral:{grain:.35,grainSize:1.1,grainAnimated:!0,halation:.25,haloSize:2.6,contrast:.05,saturation:1,fade:.02,temperature:0,tint:0,vignette:.25},portra:{grain:.45,grainSize:1.4,grainAnimated:!0,halation:.55,haloSize:3.2,contrast:.12,saturation:1,fade:.08,temperature:0,tint:0,vignette:.4},velvia:{grain:.38,grainSize:1.2,grainAnimated:!0,halation:.4,haloSize:2.8,contrast:.28,saturation:1.45,fade:.05,temperature:.05,tint:.03,vignette:.45},trix:{grain:.9,grainSize:1,grainAnimated:!0,halation:.2,haloSize:2.3,contrast:.45,saturation:0,fade:.1,temperature:-.02,tint:.02,vignette:.55},cinestill:{grain:.65,grainSize:1.8,grainAnimated:!0,halation:1.4,haloSize:4.5,contrast:.18,saturation:1.05,fade:.1,temperature:-.2,tint:.05,vignette:.5},bleach:{grain:.5,grainSize:1.3,grainAnimated:!0,halation:.35,haloSize:2.8,contrast:.6,saturation:.55,fade:.03,temperature:0,tint:0,vignette:.62}}}};function cl(e,t,a,n){const i=G(e).find(c=>c.instanceId===t);if(!i)return;const r=sl[i.defId||i.filterId];if(!r||r.key!==a)return;const s=r.values?.[String(n)];!s||typeof s!="object"||Object.entries(s).forEach(([c,u])=>{Ce(e,t,c,u,!0)})}const Hn=["Color","Distort","Blur","Effect"];function ul(){const e=new Map;eo.forEach(a=>{const n=a.group||"Other";e.has(n)||e.set(n,[]),e.get(n).push(a)});const t=[...Hn.filter(a=>e.has(a)),...[...e.keys()].filter(a=>!Hn.includes(a))];J.innerHTML=t.map(a=>`
        ...
        </div>`).join(""),J.querySelectorAll(".filter-add-grid[data-group]").forEach(a=>{dl(a,a.dataset.group)})}function dl(e,t){let a=null;e.addEventListener("dragstart",n=>{const o=n.target.closest(".filter-add-option");if(!o){n.preventDefault();return}a=o,o.classList.add("dragging"),n.dataTransfer.effectAllowed="move",n.dataTransfer.setData("text/plain",o.dataset.filterId)}),e.addEventListener("dragover",n=>{if(!a)return;n.preventDefault(),n.dataTransfer.dropEffect="move";const o=n.target.closest(".filter-add-option");if(!o||o===a){o||e.appendChild(a);return}const i=o.getBoundingClientRect();n.clientX<i.left+i.width/2?o.parentNode.insertBefore(a,o):o.parentNode.insertBefore(a,o.nextSibling)}),e.addEventListener("drop",n=>{if(n.preventDefault(),!a)return;const o=[...e.querySelectorAll(".filter-add-option")].map(i=>i.dataset.filterId);l.filterAddOrder[t]=o,Qr()}),e.addEventListener("dragend",()=>{a=null,e.querySelectorAll(".filter-add-option.dragging").forEach(n=>n.classList.remove("dragging"))})}document.body.appendChild(J);function Xo(){const e=oa.getBoundingClientRect(),t=J.querySelectorAll(".filter-add-group").length||4,a=t*150+(t-1)*14+20,n=Math.max(320,Math.min(a,window.innerWidth-16));let o=e.right-n;o=Math.max(8,Math.min(o,window.innerWidth-n-8)),J.style.width=`${n}px`,J.style.left=`${o}px`,J.style.top=`${e.bottom+6}px`}function fl(){Xo(),J.hidden=!1,oa.classList.add("open")}function da(){J.hidden=!0,oa.classList.remove("open")}window.addEventListener("resize",()=>{J.hidden||Xo()});function Ko(e,t,a,n=48){let o="";for(let i=0;i<=n;i++){const r=i/n,s=yi(e,r),c=r*t,u=(1-s)*a;o+=i===0?`M${c.toFixed(2)},${u.toFixed(2)}`:` L${c.toFixed(2)},${u.toFixed(2)}`}return o}function Yo(e,t,a,n,o,i=56){const r=Math.max(0,Math.min(.99,e)),s=Math.max(r+.001,Math.min(1,a)),c=Math.max(.05,t);let u="";for(let d=0;d<=i;d++){const f=d/i,p=Math.max(0,Math.min(1,(f-r)/(s-r))),h=Math.pow(p,1/c),v=f*n,m=(1-h)*o;u+=d===0?`M${v.toFixed(2)},${m.toFixed(2)}`:` L${v.toFixed(2)},${m.toFixed(2)}`}return u}function Jo(e,t,a){const n=Math.max(0,Math.min(.99,e)),o=Math.max(n+.001,Math.min(1,a)),i=Math.max(.05,t),r=n+(o-n)*Math.pow(.5,i);return{black:n,mid:Math.max(n,Math.min(o,r)),white:o}}function gn(e){if(!e)return;const t=_.querySelector(`.filter-levels-graph[data-instance-id="${e}"]`);if(!t)return;const a=(m,g)=>{const S=_.querySelector(`input[data-instance-id="${e}"][data-param-key="${m}"]`),M=S?Number(S.value):g;return Number.isFinite(M)?M:g},n=a("blackPoint",0),o=a("gamma",1),i=a("whitePoint",1),r=t.querySelector(".filter-levels-curve"),s=t.querySelector(".filter-levels-marker--black"),c=t.querySelector(".filter-levels-marker--mid"),u=t.querySelector(".filter-levels-marker--white"),d=t.querySelector('.filter-levels-handle[data-handle="black"]'),f=t.querySelector('.filter-levels-handle[data-handle="mid"]'),p=t.querySelector('.filter-levels-handle[data-handle="white"]');if(!r||!s||!c||!u)return;const h=Yo(n,o,i,100,46,56),v=Jo(n,o,i);r.setAttribute("d",h),s.setAttribute("x1",(v.black*100).toFixed(2)),s.setAttribute("x2",(v.black*100).toFixed(2)),c.setAttribute("x1",(v.mid*100).toFixed(2)),c.setAttribute("x2",(v.mid*100).toFixed(2)),u.setAttribute("x1",(v.white*100).toFixed(2)),u.setAttribute("x2",(v.white*100).toFixed(2)),d&&(d.style.left=`${(v.black*100).toFixed(2)}%`),f&&(f.style.left=`${(v.mid*100).toFixed(2)}%`),p&&(p.style.left=`${(v.white*100).toFixed(2)}%`)}function Pa(e,t,a){Ce(l.selectedId,e,t,a,!0),_.querySelectorAll(`input[data-instance-id="${e}"][data-param-key="${t}"]`).forEach(n=>{n.value=a})}function pl(e,t){const a=e.params[t.key];if(t.type==="select"){const n=(t.options||[]).map(o=>`<option value="${o.value}" ${a===o.value?"selected":""}>${o.label}</option>`).join("");return`
      ...
      </div>`}if(t.type==="curve"){const n=Bt(a),o=Ko(n,100,100,40);return`
      ...
      </div>`}if(t.type==="gradient"){const n=gt(a),o=Qn(n);return`
      ...
      </div>`}if(t.type==="levelsGraph"){const n=Number.isFinite(e.params[t.blackKey])?e.params[t.blackKey]:0,o=Number.isFinite(e.params[t.gammaKey])?e.params[t.gammaKey]:1,i=Number.isFinite(e.params[t.whiteKey])?e.params[t.whiteKey]:1,r=Yo(n,o,i,100,46,56),s=Jo(n,o,i);return`
    ...
    <div class="filter-param-row">
    ...
    </div>`}function F(){const e=l.selectedId,t=e?G(e):[];if(Yi.style.display=t.length===0?"block":"none",jt.checked=e?Ne(e):!1,jt.disabled=!e,yo.disabled=!e,me.disabled=!e,_.innerHTML=t.map((a,n)=>{const o=Re(a.defId);if(!o)return"";const i=o.params.filter(r=>rt(r,a.params)).map(r=>pl(a,r)).join("");return`
      ...
      </div>`}).join(""),z&&!C.hidden){const a=_.querySelector(`[data-action="open-curve"][data-instance-id="${z.instanceId}"][data-param-key="${z.paramKey}"]`);a?(z.trigger=a,Dn()):ya()}if(O&&!A.hidden){const a=_.querySelector(`[data-action="open-gradient"][data-instance-id="${O.instanceId}"][data-param-key="${O.paramKey}"]`);a?(O.trigger=a,di()):ga()}rn(_),_.querySelectorAll(".filter-levels-graph[data-instance-id]").forEach(a=>{gn(a.dataset.instanceId)}),ml()}let qn=null;function ml(){clearTimeout(qn),qn=setTimeout(hl,220)}async function yn(e){if(!e||!ve||l.selectedId!==e)return!1;const t=G(e).filter(i=>i.enabled);if(R.style.display==="none"||!Ne(e)||t.length===0)return!1;const a=[...t].reverse(),n=ve.captureAtScale(a,Zt,1);if(!n)return!1;const o=await jo(n.dataUrl);return l.selectedId!==e?!1:(l.previews[e]=o,ca(),ti(e),!0)}function hl(){const e=l.selectedId;e&&yn(e).then(t=>{t||va()})}function fa(e){const t=["linear-gradient(135deg,#2a3f88 0%,#18274f 100%)","linear-gradient(135deg,#5d2a83 0%,#251749 100%)","linear-gradient(135deg,#85481e 0%,#3a2112 100%)","linear-gradient(135deg,#165b67 0%,#0f2e35 100%)"];return t[e%t.length]}function Zo(e){const t=e.entry.includes("?")?"&":"?";return`${e.entry}${t}project=${encodeURIComponent(e.id)}`}function Qo(e,t){if(!e||e.getElementById("shaderopsUiEnhancements")||!e.getElementById("app")&&!e.body)return;const a=e.createElement("style");a.id="shaderopsUiEnhancements",a.textContent=`
  ...
  `,e.head?.appendChild(a),rn(e);const n=e.getElementById("allRandomButton");n&&!n.querySelector("svg")&&(n.textContent="",n.title="All random (R)",n.innerHTML=`
      <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <rect x="1.5" y="1.5" width="13" height="13" rx="3" stroke="currentColor" stroke-width="1.3"></rect>
        <circle cx="5" cy="5" r="1.15" fill="currentColor"></circle>
        <circle cx="11" cy="5" r="1.15" fill="currentColor"></circle>
      ...
      <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        </button>`}).join("")}function ti(e){if(!e)return;const t=l.projects.findIndex(i=>i.id===e);if(t===-1)return;const a=l.previews[e],n=a?`background-image:url('${a}');background-size:cover;`:`background:${fa(t)};`,o=CSS.escape(e);document.querySelectorAll(`[data-project-id="${o}"]`).forEach(i=>i.setAttribute("style",n))}let Mt=null,de=null,pt=null,Gn="rail",Z=[],Te=0;function pa(){Mt&&(clearTimeout(Mt),Mt=null)}function we(){pa(),de=null,pt=null,Z=[],Te=0,re.hidden=!0}function yl(e){return l.projects.find(t=>t.id===e)||null}function bl(e,t){const a=Ze(e);return a.slots.length?a.slots.map((n,o)=>{const i=typeof n.preview=="string"&&n.preview?n.preview:null,r=i?`background-image:url('${i}');background-size:cover;background-position:center;`:t+"opacity:0.42;",s=i?`background-image:url('${i}');background-size:cover;background-position:center;`:t;return{slotId:n.id,image:i,thumbStyle:r,heroStyle:s,title:i?`Checkpoint ${o+1}`:`Checkpoint ${o+1} (no snapshot yet)`}}):[]}function ai(){if(!Z.length){_n.innerHTML='<span class="thumb-hover-preview__empty">No checkpoints</span>';return}_n.innerHTML=Z.map((e,t)=>`<span class="thumb-hover-preview__cp${e.image?"":" thumb-hover-preview__cp--empty"}${t===Te?" is-active":""}" style="${e.thumbStyle}" title="${e.title}"></span>`).join("")}function xl(e,t){const a=re.getBoundingClientRect(),n=e.getBoundingClientRect(),o=10,i=window.innerWidth-a.width-8,r=window.innerHeight-a.height-8;let s=n.right+o,c=n.top+n.height*.5-a.height*.5;if(t==="effect-panel"){const u=j.hidden?n:j.getBoundingClientRect();s=u.right+o,s>i&&(s=u.left-a.width-o)}else s>i&&(s=n.left-a.width-o);re.style.left=`${Math.max(8,Math.min(s,i))}px`,re.style.top=`${Math.max(8,Math.min(c,r))}px`}function wl(e,t,a){const n=yl(t);if(!n)return;const o=Math.max(0,l.projects.findIndex(u=>u.id===t)),i=`background:${fa(o)};`,r=l.previews[t]||null,s=r?`background-image:url('${r}');background-size:cover;background-position:center;`:i;Z=bl(t,i),Te=0;const c=Z[0]?.heroStyle||s;hr.textContent=n.name,So.setAttribute("style",c),ai(),re.dataset.source=a,re.hidden=!1,xl(e,a)}function ni(e,t,a){pa(),de=e,pt=t,Gn=a,Mt=setTimeout(()=>{Mt=null,!(!de||!de.isConnected)&&wl(de,pt,Gn)},Oi)}function oi(e){if(!Z.length)return;Te=(Te+e+Z.length)%Z.length;const t=Z[Te]?.heroStyle;t&&So.setAttribute("style",t),ai()}function ii(e,t){if(pt!==e||Z.length===0||t&&de&&de.dataset.projectId!==t.dataset.projectId)return null;const a=Z[Te]?.slotId;return a||(Ze(e).slots[Te]?.id??null)}function ri(e,t){if(!t)return;if(q.has(e)){Xa(e,t);return}let a=0;const n=setInterval(()=>{if(a+=1,q.has(e)){clearInterval(n),Xa(e,t);return}a>30&&clearInterval(n)},50)}function kl(e){const t=l.projects.findIndex(n=>n.id===e);if(t===-1)return;const a=ei();l.navPage=Math.floor(t/a),xe()}const Sl='<svg viewBox="0 0 16 16" fill="currentColor" aria-hidden="true"><path d="M8 1.4l1.98 4.02 4.44.65-3.21 3.13.76 4.42L8 11.55l-3.97 2.07.76-4.42-3.21-3.13 4.44-.65z"/></svg>',Cl='<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.1" stroke-linejoin="round" aria-hidden="true"><path d="M8 1.4l1.98 4.02 4.44.65-3.21 3.13.76 4.42L8 11.55l-3.97 2.07.76-4.42-3.21-3.13 4.44-.65z"/></svg>';function Aa(e,t){const a=e.id===l.selectedId,n=l.favorites.includes(e.id),o=l.previews[e.id],i=o?`background-image:url('${o}');background-size:cover;`:`background:${fa(t)};`;return`
    ...
    </div>`}function Jt(e){return!e||typeof e!="object"?!1:Array.isArray(e.tags)&&e.tags.some(t=>String(t).toLowerCase()==="3d")?!0:/\b3d\b/i.test(String(e.engine||""))}function ma(){const e=Oa.closest(".nav-grid-section"),t=l.favorites.map(c=>l.projects.find(u=>u.id===c)).filter(Boolean);e.classList.toggle("empty",t.length===0),Oa.innerHTML=t.map(c=>Aa(c,l.projects.indexOf(c))).join("");const a=new Set(l.favorites),n=za.closest(".nav-grid-section"),o=Ha.closest(".nav-grid-section"),i=l.projects.filter(c=>!a.has(c.id)),r=i.filter(c=>!Jt(c)),s=i.filter(c=>Jt(c));n&&n.classList.toggle("empty",r.length===0),o&&o.classList.toggle("empty",s.length===0),za.innerHTML=r.map(c=>Aa(c,l.projects.indexOf(c))).join(""),Ha.innerHTML=s.map(c=>Aa(c,l.projects.indexOf(c))).join("")}function li(){const e=new Set(l.favorites),t=l.favorites.map(n=>l.projects.find(o=>o.id===n)).filter(Boolean),a=l.projects.filter(n=>!e.has(n.id));l.projects=[...t,...a]}function El(e){const t=l.favorites.indexOf(e);t===-1?l.favorites.push(e):l.favorites.splice(t,1),Wo(),li(),hn(),ma(),xe()}function Dl(){ma(),j.hidden=!1,ln.hidden=!1,na.classList.add("active")}function ha(){j.hidden||(j.hidden=!0,ln.hidden=!0,na.classList.remove("active"),we())}function xn(e,t){let a=null,n=null;e.addEventListener("dragstart",o=>{if(o.target.closest("[data-fav-toggle]")){o.preventDefault();return}const i=o.target.closest(".nav-grid-thumb");if(!i){o.preventDefault();return}a=i.dataset.projectId,n=i,i.classList.add("dragging"),o.dataTransfer.effectAllowed="move",o.dataTransfer.setData("text/plain",a)}),e.addEventListener("dragover",o=>{if(!n)return;o.preventDefault(),o.dataTransfer.dropEffect="move";const i=o.target.closest(".nav-grid-thumb");if(!i||i===n){i||e.appendChild(n);return}const r=i.getBoundingClientRect();o.clientX<r.left+r.width/2?i.parentNode.insertBefore(n,i):i.parentNode.insertBefore(n,i.nextSibling)}),e.addEventListener("drop",o=>{if(o.preventDefault(),!a)return;const i=[...e.querySelectorAll(".nav-grid-thumb")].map(r=>r.dataset.projectId);t(i)}),e.addEventListener("dragend",()=>{a=null,n=null,e.querySelectorAll(".nav-grid-thumb.dragging").forEach(o=>o.classList.remove("dragging"))})}function wn(){const e=l.projects.find(t=>t.id===l.selectedId);if(!e){Na.textContent="No project selected",Ua.textContent="â€”",D.src="about:blank",_a.disabled=!0,Da();return}Na.textContent=e.name,Ua.textContent=e.engine,D.classList.add("frame-swapping"),D.src=Zo(e),_a.disabled=!1,E.setItem(Wt,e.id),Ya=null,F(),Ao(e)?(Da(),q.get(e.id)&&(ae(e.id),Ro()),requestAnimationFrame(()=>requestAnimationFrame(lt))):(Da(),Ml(D,e.id))}function lt(){D.classList.remove("frame-swapping")}function Ml(e,t){let a=0;const n=()=>{if(e!==D||l.selectedId!==t)return;a+=1;let o=null;try{o=e.contentDocument}catch{o=null}if(o&&o.readyState!=="loading"&&(o.getElementById("app")||o.body)){try{Qo(o,t)}catch(i){console.warn("ShaderOps: unable to install project UI enhancements (early).",i)}requestAnimationFrame(()=>requestAnimationFrame(lt));return}a<300?requestAnimationFrame(n):lt()};requestAnimationFrame(n),setTimeout(lt,1500)}window.addEventListener("message",async e=>{const t=e.data;if(t&&typeof t.type=="string"&&t.type.startsWith("shaderops/")&&(t.type==="shaderops/ready"||t.type==="shaderops/values-changed"||t.type==="shaderops/keydown")){Rr(t,e.source||null);return}const a=bn(e.data);if(!a)return;const{projectId:n}=e.data;n&&n!==l.selectedId&&zn(n)&&l.previews[n]||n===l.selectedId&&n&&zn(n)&&(await yn(n)||l.previews[n])||(l.previews[n]=await jo(a),ca(),ti(n))});function va(){if(l.captureInFlight)return Promise.resolve();const e=l.projects.find(a=>a.id===l.selectedId),t=D.contentWindow;return!e||!t?Promise.resolve():yn(e.id).then(a=>{if(!a)return l.captureInFlight=!0,new Promise(n=>{const o=setTimeout(()=>{window.removeEventListener("message",i),l.captureInFlight=!1,n()},1500),i=r=>{bn(r.data)&&r.data.projectId===e.id&&(clearTimeout(o),window.removeEventListener("message",i),l.captureInFlight=!1,n())};window.addEventListener("message",i),t.postMessage({type:"shaderops/request-preview",projectId:e.id},"*")})})}async function Il(e){return new Promise(t=>{const a=document.createElement("iframe");a.style.cssText="position:fixed;width:2px;height:2px;opacity:0;pointer-events:none;left:-9999px;top:-9999px;border:none;",document.body.appendChild(a);let n=!1;const o=()=>{n||(n=!0,clearTimeout(i),window.removeEventListener("message",r),a.remove(),t())},i=setTimeout(o,1e4),r=s=>{bn(s.data)&&s.data.projectId===e.id&&o()};window.addEventListener("message",r),a.addEventListener("load",()=>{setTimeout(()=>{try{a.contentWindow?.postMessage({type:"shaderops/request-preview",projectId:e.id},"*")}catch{o()}},2500)}),a.src=Zo(e)})}async function Pl(){if(!l.prewarmActive){for(l.prewarmActive=!0;l.prewarmQueue.length>0;){const e=l.prewarmQueue.shift();l.previews[e.id]||await Il(e)}l.prewarmActive=!1}}async function kn(e){e!==l.selectedId&&(await va(),l.selectedId=e,xe(),wn())}D.addEventListener("load",()=>{const e=l.projects.find(t=>t.id===l.selectedId);if(e){try{Qo(D.contentDocument,e.id)}catch(t){console.warn("ShaderOps: unable to install project UI enhancements.",t)}lt(),setTimeout(()=>{try{D.contentWindow?.postMessage({type:"shaderops/request-preview",projectId:e.id},"*")}catch{}},2e3)}});async function Al(){const[e,t]=await Promise.all([fetch("/registry.json",{cache:"no-store"}),fetch("/project-revisions.json",{cache:"no-store"}).catch(()=>null)]);if(!e.ok)throw new Error(`Unable to load registry (${e.status})`);const a=await e.json(),n=t?.ok?await t.json():{};l.currentProjectRevisions=n&&typeof n=="object"&&!Array.isArray(n)?n:{};const o=Array.isArray(a.projects)?a.projects:[],i=await Promise.all(o.map(d=>vl(d)));l.projects=o.filter((d,f)=>i[f]),Jr();const r=new Set(l.projects.map(d=>d.id));let s=!1;Object.keys(l.previews).forEach(d=>{const f=l.currentProjectRevisions[d]&&l.previewRevisions[d]!==l.currentProjectRevisions[d];(!r.has(d)||f)&&(delete l.previews[d],delete l.previewRevisions[d],s=!0)}),Object.keys(l.previewRevisions).forEach(d=>{r.has(d)||delete l.previewRevisions[d]}),s&&ca();const c=E.getItem(Wt),u=l.projects.find(d=>d.id===c)?c:l.projects[0]?.id??null;l.selectedId=u,xe(),wn(),l.prewarmQueue=l.projects.filter(d=>!l.previews[d.id]),l.prewarmQueue.length>0&&setTimeout(Pl,3e3)}async function Bl(e){if(l.projects.find(a=>a.id===e))try{l.selectedId===e&&(await va(),D.src="about:blank",await new Promise(o=>{let i=!1;const r=()=>{i||(i=!0,D.removeEventListener("load",s),clearTimeout(c),o())},s=()=>r(),c=setTimeout(r,1200);D.addEventListener("load",s,{once:!0})}));const a=await fetch(`/api/projects/${encodeURIComponent(e)}`,{method:"DELETE"}),n=await a.json().catch(()=>({}));if(!a.ok){const o=n?.detail?`: ${n.detail}`:"",i=n?.error?`${n.error}${o}`:`Delete failed (${a.status})`;throw new Error(i)}if(l.projects=l.projects.filter(o=>o.id!==e),delete l.previews[e],ca(),l.selectedId===e){const o=l.projects[0]?.id??null;l.selectedId=o,o?E.setItem(Wt,o):E.removeItem(Wt)}l.prewarmQueue=l.prewarmQueue.filter(o=>o.id!==e),xe(),wn()}catch(a){const n=a instanceof Error?a.message:String(a);window.alert(`Unable to delete project: ${n}`)}}oe.addEventListener("click",async e=>{const t=e.target.closest("[data-project-id]");if(!t)return;const a=t.dataset.projectId,n=ii(a,t);await kn(a),ri(a,n),we()});oe.addEventListener("pointerover",e=>{const t=e.target.closest(".project-thumb[data-project-id]");!t||!oe.contains(t)||ni(t,t.dataset.projectId,"rail")});oe.addEventListener("pointerout",e=>{const t=e.target.closest(".project-thumb[data-project-id]");if(!t)return;const a=e.relatedTarget;a&&(t.contains(a)||re.contains(a))||(pa(),de===t&&we())});oe.addEventListener("pointerleave",e=>{const t=e.relatedTarget;t&&re.contains(t)||we()});function Wn(e){l.navPage+=e,xe()}function si(e){oe.classList.contains("paged")&&(e.preventDefault(),e.deltaY>0?Wn(1):e.deltaY<0&&Wn(-1))}oe.addEventListener("wheel",e=>{const t=e.target.closest(".project-thumb[data-project-id]");if(t&&!re.hidden&&de===t&&pt===t.dataset.projectId&&Z.length>0){e.preventDefault();const a=Math.abs(e.deltaY)>=Math.abs(e.deltaX)?e.deltaY:e.deltaX;a!==0&&oi(a>0?1:-1);return}si(e)},{passive:!1});ot.addEventListener("wheel",si,{passive:!1});let jn=null;window.addEventListener("resize",()=>{clearTimeout(jn),jn=setTimeout(xe,120),we()});na.addEventListener("click",e=>{e.stopPropagation(),j.hidden?Dl():ha()});j.addEventListener("click",e=>{const t=e.target.closest("[data-fav-toggle]");if(t){e.stopPropagation(),El(t.dataset.favToggle);return}const a=e.target.closest(".nav-grid-thumb[data-project-id]");if(!a)return;const n=a.dataset.projectId,o=ii(n,a);ha(),kl(n),kn(n).then(()=>{ri(n,o)}),we()});j.addEventListener("pointerover",e=>{if(j.hidden)return;const t=e.target.closest(".nav-grid-thumb[data-project-id]");!t||!j.contains(t)||ni(t,t.dataset.projectId,"effect-panel")});j.addEventListener("pointerout",e=>{const t=e.target.closest(".nav-grid-thumb[data-project-id]");if(!t)return;const a=e.relatedTarget;a&&(t.contains(a)||re.contains(a))||(pa(),de===t&&we())});j.addEventListener("pointerleave",e=>{const t=e.relatedTarget;t&&re.contains(t)||we()});j.addEventListener("wheel",e=>{const t=e.target.closest(".nav-grid-thumb[data-project-id]");if(!t||re.hidden||de!==t||pt!==t.dataset.projectId||Z.length===0)return;e.preventDefault(),e.stopPropagation();const a=Math.abs(e.deltaY)>=Math.abs(e.deltaX)?e.deltaY:e.deltaX;a!==0&&oi(a>0?1:-1)},{passive:!1});ln.addEventListener("click",()=>ha());document.addEventListener("click",e=>{j.hidden||j.contains(e.target)||na.contains(e.target)||ha()});document.addEventListener("dragstart",()=>we());window.addEventListener("blur",()=>we());xn(Oa,e=>{l.favorites=e,Wo(),li(),hn(),ma(),xe()});function ci(e,t){const a=new Set(l.favorites),n=l.favorites.map(f=>l.projects.find(p=>p.id===f)).filter(Boolean),o=l.projects.filter(f=>!a.has(f.id)&&!Jt(f)),i=l.projects.filter(f=>!a.has(f.id)&&Jt(f)),r=new Map(l.projects.map(f=>[f.id,f])),s=e.map(f=>r.get(f)).filter(Boolean),c=t==="3d"?i.length:o.length;if(s.length!==c)return;const u=t==="2d"?s:o,d=t==="3d"?s:i;l.projects=[...n,...u,...d],hn(),ma(),xe()}xn(za,e=>ci(e,"2d"));xn(Ha,e=>ci(e,"3d"));_a.addEventListener("click",()=>{if(!l.selectedId)return;const e=l.projects.find(t=>t.id===l.selectedId);rr.textContent=e?`Delete "${e.name}"? This removes its files permanently and cannot be undone.`:"This removes its files permanently and cannot be undone.",it.hidden=!1});sr.addEventListener("click",()=>{it.hidden=!0});it.addEventListener("click",e=>{e.target===it&&(it.hidden=!0)});lr.addEventListener("click",()=>{it.hidden=!0,l.selectedId&&Bl(l.selectedId)});window.addEventListener("beforeunload",()=>{const e=D.contentWindow,t=l.projects.find(a=>a.id===l.selectedId);!e||!t||e.postMessage({type:"shaderops/request-preview",projectId:t.id},"*")});let ve=null,Ya=null,Zt=0,Vn=performance.now()/1e3;const tt=document.createElement("canvas"),Xn=tt.getContext("2d",{willReadFrequently:!1});function Tl(){return ve||(ve=new Ci(R),ve)}let Ja=null;const nt=new Map;let Kn=null;function Ll(e,t){if(e){Kn!==e&&(nt.clear(),Kn=e);for(const[a,n]of t){let o=nt.get(a);o||(o=e.createElement("canvas"),o.className="fx-underlay-item",o.style.cssText="position:fixed;pointer-events:none;z-index:1;display:none;",e.body.appendChild(o),nt.set(a,o)),o.style.display="block",o.style.left=`${n.x}px`,o.style.top=`${n.y}px`,o.style.width=`${n.w}px`,o.style.height=`${n.h}px`}for(const[a,n]of nt)t.has(a)||(n.style.display="none")}}function Rl(e,t){const a=e.width||0,n=e.height||0;if(!(a<=0||n<=0))for(const[o,i]of nt){if(i.style.display==="none")continue;const r=parseFloat(i.style.width)||0,s=parseFloat(i.style.height)||0;if(r<=0||s<=0)continue;const c=Math.max(1,Math.round(r*t)),u=Math.max(1,Math.round(s*t));i.width!==c&&(i.width=c),i.height!==u&&(i.height=u);const d=Math.max(0,Math.min(a-1,Math.round(parseFloat(i.style.left)*t))),f=Math.max(0,Math.min(n-1,Math.round(parseFloat(i.style.top)*t))),p=Math.max(1,Math.min(a-d,c)),h=Math.max(1,Math.min(n-f,u)),v=i.getContext("2d");if(v)try{v.clearRect(0,0,c,u),v.drawImage(e,d,f,p,h,0,0,c,u)}catch{}}}function Fl(e,t,a){const n=[],o=new Map,i=0;try{if(e)for(const f of["hud","panelToggleDock","shaderopsCheckpoints","shaderopsCheckpointMenu"]){const p=e.getElementById(f);if(!p)continue;const h=e.defaultView?.getComputedStyle(p);if(h?.display==="none"||h?.visibility==="hidden"||h?.contentVisibility==="hidden")continue;const v=p.getBoundingClientRect();if(v.width>0&&v.height>0){const m=v.left-i,g=v.top-i,S=Math.max(0,m),M=Math.max(0,g),x=Math.min(t,m+v.width+i*2),V=Math.min(a,g+v.height+i*2);x>S&&V>M&&(n.push({x:S,y:M,w:x-S,h:V-M}),o.set(f,{x:S,y:M,w:x-S,h:V-M}))}}}catch{}Ll(e,o);const r=`${t}x${a}|`+n.map(f=>`${f.x},${f.y},${f.w},${f.h}`).join(";");if(r===Ja)return;if(Ja=r,R.style.clipPath="none",!n.length){R.style.maskImage="none",R.style.webkitMaskImage="none";return}const s=[];for(const f of n){let p=f;for(let h=s.length-1;h>=0;h--){const v=s[h];if(p.x<v.x+v.w&&p.x+p.w>v.x&&p.y<v.y+v.h&&p.y+p.h>v.y){const g=Math.min(p.x,v.x),S=Math.min(p.y,v.y),M=Math.max(p.x+p.w,v.x+v.w),x=Math.max(p.y+p.h,v.y+v.h);p={x:g,y:S,w:M-g,h:x-S},s.splice(h,1)}}s.push(p)}const c=s.map(f=>`<rect x="${f.x}" y="${f.y}" width="${f.w}" height="${f.h}" fill="#000"/>`).join(""),u=`<svg xmlns="http://www.w3.org/2000/svg" width="${t}" height="${a}"><defs><mask id="m" maskUnits="userSpaceOnUse" x="0" y="0" width="${t}" height="${a}"><rect x="0" y="0" width="${t}" height="${a}" fill="#fff"/><g>${c}</g></mask></defs></svg>`,d=`url("data:image/svg+xml,${encodeURIComponent(u)}#m")`;R.style.maskImage=d,R.style.webkitMaskImage=d,R.style.maskMode="luminance",R.style.maskRepeat="no-repeat",R.style.webkitMaskRepeat="no-repeat",R.style.maskSize="100% 100%",R.style.webkitMaskSize="100% 100%"}function ui(){requestAnimationFrame(ui);const e=performance.now()/1e3,t=Math.max(0,Math.min(.1,e-Vn));Vn=e;const a=l.selectedId,o=(a?G(a):[]).filter(M=>M.enabled),i=a?Ne(a):!1,r=!!a&&i&&o.length>0,s=a?q.get(a):null;a&&s?.extras?.paused||(Zt+=t);let u=null;try{u=D.contentDocument||null}catch{u=null}let d=null;try{d=u?.querySelector("canvas")||null}catch{d=null}if(!r||!d){R.style.display!=="none"&&(R.style.display="none"),(R.style.clipPath!=="none"||R.style.maskImage)&&(R.style.clipPath="none",R.style.maskImage="none",R.style.webkitMaskImage="none",Ja=null);for(const M of nt.values())M.style.display="none";return}R.style.display!=="block"&&(R.style.display="block");const f=Tl();d!==Ya&&(Ya=d,f.setSource(tt));const p=d.width||1,h=d.height||1;(tt.width!==p||tt.height!==h)&&(tt.width=p,tt.height=h);try{Xn.clearRect(0,0,p,h),Xn.drawImage(d,0,0,p,h)}catch{}const v=sn.getBoundingClientRect(),m=Math.max(1,Math.round(v.width)),g=Math.max(1,Math.round(v.height));(f.width!==m||f.height!==g)&&f.resize(m,g),Fl(u,m,g);const S=[...o].reverse();f.renderFrame(S,Zt),Rl(R,f.renderer.getPixelRatio())}requestAnimationFrame(ui);Zr();ul();oa.addEventListener("click",e=>{e.stopPropagation(),J.hidden?fl():da()});J.addEventListener("click",e=>{const t=e.target.closest(".filter-add-option");!t||!l.selectedId||(ol(l.selectedId,t.dataset.filterId),da())});document.addEventListener("click",e=>{const t=e.target.closest(".filter-add-wrap"),a=e.target.closest("#filterAddMenu");!J.hidden&&!t&&!a&&da()});document.addEventListener("keydown",e=>{e.key==="Escape"&&da()});_.addEventListener("click",e=>{const t=e.target.closest("[data-action]");if(!t||!l.selectedId)return;const{action:a,instanceId:n,paramKey:o}=t.dataset;if(a==="collapse")ll(l.selectedId,n);else if(a==="remove")il(l.selectedId,n);else if(a==="upload-image"){const i=t.closest(".filter-param-row").querySelector(".filter-image-input");i&&i.click()}else a==="clear-image"?(B(l.selectedId),Ce(l.selectedId,n,o,null),F()):a==="open-curve"?zl(n,o,t.dataset.label,t):a==="open-gradient"&&_l(n,o,t.dataset.label,t)});let Pt=null;_.addEventListener("pointerdown",e=>{const t=e.target.closest(".filter-levels-handle[data-instance-id][data-handle]");if(!t||!l.selectedId)return;const a=t.closest(".filter-levels-graph");if(!a)return;e.preventDefault(),e.stopPropagation();const n=t.dataset.instanceId,o=`levelsgraph:${n}`;ge!==o&&(B(l.selectedId),ge=o),Pt={instanceId:n,handle:t.dataset.handle,graph:a}});_.addEventListener("change",e=>{const t=e.target;if(l.selectedId)if(t.matches('[data-action="toggle"]'))rl(l.selectedId,t.dataset.instanceId);else if(t.classList.contains("filter-param-toggle"))B(l.selectedId),Ce(l.selectedId,t.dataset.instanceId,t.dataset.paramKey,t.checked),F();else if(t.classList.contains("filter-param-select"))B(l.selectedId),Ce(l.selectedId,t.dataset.instanceId,t.dataset.paramKey,t.value),cl(l.selectedId,t.dataset.instanceId,t.dataset.paramKey,t.value),F();else if(t.classList.contains("filter-param-color")){const a=`color:${t.dataset.instanceId}:${t.dataset.paramKey}`;ge!==a&&B(l.selectedId),Ce(l.selectedId,t.dataset.instanceId,t.dataset.paramKey,t.value),ge=null}else if(t.classList.contains("filter-image-input")){const a=t.files&&t.files[0];if(!a)return;const{instanceId:n,paramKey:o}=t.dataset,i=new FileReader;i.onload=()=>{B(l.selectedId),Ce(l.selectedId,n,o,i.result),F()},i.readAsDataURL(a)}else(t.classList.contains("filter-param-range")||t.classList.contains("filter-param-number")||t.classList.contains("filter-param-color"))&&(ge=null)});let ge=null;_.addEventListener("input",e=>{const t=e.target;if(l.selectedId){if(t.classList.contains("filter-param-range")||t.classList.contains("filter-param-number")){const{instanceId:a,paramKey:n}=t.dataset,o=Number(t.value),i=`${a}:${n}`;ge!==i&&(B(l.selectedId),ge=i),Ce(l.selectedId,a,n,o,!0),_.querySelectorAll(`[data-instance-id="${a}"][data-param-key="${n}"]`).forEach(r=>{r!==t&&(r.value=o)}),gn(a)}else if(t.classList.contains("filter-param-color")){const{instanceId:a,paramKey:n}=t.dataset,o=`color:${a}:${n}`;ge!==o&&(B(l.selectedId),ge=o),Ce(l.selectedId,a,n,t.value,!0)}}});window.addEventListener("pointermove",e=>{if(!Pt||!l.selectedId)return;const{instanceId:t,handle:a,graph:n}=Pt,o=n.getBoundingClientRect();if(o.width<=1)return;const i=Math.max(0,Math.min(1,(e.clientX-o.left)/o.width)),r=(d,f)=>{const p=_.querySelector(`input[data-instance-id="${t}"][data-param-key="${d}"]`),h=p?Number(p.value):f;return Number.isFinite(h)?h:f};let s=r("blackPoint",0),c=r("gamma",1),u=r("whitePoint",1);if(a==="black")s=Math.max(0,Math.min(u-.001,i)),Pa(t,"blackPoint",s);else if(a==="white")u=Math.max(s+.001,Math.min(1,i)),Pa(t,"whitePoint",u);else{const d=Math.max(0,Math.min(.99,s)),f=Math.max(d+.001,Math.min(1,u)),p=Math.max(.001,Math.min(.999,(i-d)/(f-d)));c=Math.max(.2,Math.min(3,Math.log(p)/Math.log(.5))),Pa(t,"gamma",c)}gn(t)});window.addEventListener("pointerup",()=>{Pt&&(Pt=null,ge=null)});let Qt=null,qe=null;_.addEventListener("dragstart",e=>{const t=e.target.closest(".filter-item");if(!t||!e.target.closest(".filter-name")){e.preventDefault();return}Qt=t.dataset.instanceId,qe=t,t.classList.add("dragging"),e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",Qt);const a=t.getBoundingClientRect();e.dataTransfer.setDragImage(t,e.clientX-a.left,e.clientY-a.top)});_.addEventListener("dragover",e=>{if(!qe)return;e.preventDefault(),e.dataTransfer.dropEffect="move";const t=e.target.closest(".filter-item");if(!t||t===qe){t||_.appendChild(qe);return}const a=t.getBoundingClientRect();e.clientY<a.top+a.height/2?t.parentNode.insertBefore(qe,t):t.parentNode.insertBefore(qe,t.nextSibling)});_.addEventListener("drop",e=>{if(e.preventDefault(),!l.selectedId||!Qt)return;const t=G(l.selectedId),a=[..._.querySelectorAll(".filter-item")].map(i=>i.dataset.instanceId),n=new Map(t.map(i=>[i.instanceId,i])),o=a.map(i=>n.get(i)).filter(Boolean);o.length===t.length&&(o.some((r,s)=>r!==t[s])&&B(l.selectedId),t.length=0,t.push(...o),pe()),F()});_.addEventListener("dragend",()=>{Qt=null,qe=null,_.querySelectorAll(".filter-item.dragging, .filter-item.drag-over").forEach(e=>{e.classList.remove("dragging","drag-over")})});const $l={w:320,h:240};function Nl(){try{const e=E.getItem(vo),t=e?JSON.parse(e):null;if(t&&typeof t.w=="number"&&typeof t.h=="number")return t}catch{}return{...$l}}let Le=Nl();function Ul(){E.setItem(vo,JSON.stringify(Le))}const C=document.createElement("div");C.id="curvePopup";C.className="curve-popup";C.hidden=!0;C.innerHTML=`
...
`;document.body.appendChild(ie);const A=document.createElement("div");A.id="gradientPopup";A.className="curve-popup gradient-popup";A.hidden=!0;A.innerHTML=`
  <div class="curve-popup-header">
    <span class="curve-popup-title"></span>
    <div class="curve-popup-header-actions">
...
`;document.body.appendChild(A);let O=null,st=null,$=null;function Sn(e){return Math.min(1,Math.max(0,e))}function Cn(){return!O||!l.selectedId?null:G(l.selectedId).find(t=>t.instanceId===O.instanceId)||null}function wt(){const e=Cn();return!e||!O?null:gt(e.params[O.paramKey])}function kt(e){const t=Cn();!t||!O||(t.params[O.paramKey]={stops:e},pe())}function di(){if(A.hidden||!O||!O.trigger)return;const e=O.trigger.getBoundingClientRect(),t=A.offsetWidth||300,a=A.offsetHeight||140;let n=e.right-t,o=e.top-a-10;o<8&&(o=e.bottom+10),n=Math.min(Math.max(8,n),window.innerWidth-t-8),o=Math.min(Math.max(8,o),window.innerHeight-a-8),A.style.left=`${n}px`,A.style.top=`${o}px`}function De(){const e=wt(),t=A.querySelector(".gradient-popup-track"),a=A.querySelector(".gradient-popup-editor");if(!(!e||!t))if($!==null&&($<0||$>=e.stops.length)&&($=null),t.style.background=Qn(e),t.innerHTML=e.stops.map((n,o)=>`<button type="button" class="gradient-popup-handle${o===$?" active":""}"
      style="left:${(n.t*100).toFixed(2)}%; background:${n.color}" data-stop-index="${o}" title="${n.color}"></button>`).join(""),$!==null){const n=e.stops[$];a.hidden=!1,a.querySelector(".gradient-popup-color").value=n.color,a.querySelector(".gradient-popup-pos").value=Math.round(n.t*100),a.querySelector(".gradient-popup-delete").disabled=e.stops.length<=2}else a.hidden=!0}function _l(e,t,a,n){O={instanceId:e,paramKey:t,trigger:n},$=null,A.querySelector(".curve-popup-title").textContent=a||"Gradient",A.hidden=!1,di(),De()}function ga(){A.hidden=!0,O=null,st=null,$=null}function Ol(){const e=Cn();if(!e||!O)return;const t=Re(e.defId),a=t&&t.params.find(o=>o.key===O.paramKey);if(!a)return;const n=gt(a.default);B(l.selectedId),$=null,kt(n.stops.map(o=>({...o}))),De(),F()}A.querySelector(".gradient-popup-close").addEventListener("click",ga);A.querySelector(".gradient-popup-reset").addEventListener("click",Ol);A.querySelector(".gradient-popup-bar").addEventListener("pointerdown",e=>{const t=e.target.closest(".gradient-popup-handle");t&&($=Number(t.dataset.stopIndex),st=$,B(l.selectedId),De(),e.preventDefault())});A.querySelector(".gradient-popup-bar").addEventListener("dblclick",e=>{if(e.target.closest(".gradient-popup-handle"))return;const t=wt(),a=e.currentTarget;if(!t)return;const n=a.getBoundingClientRect(),o=Sn((e.clientX-n.left)/n.width),i=xi(t,o),r=t.stops.map(c=>({...c})),s={t:o,color:i};r.push(s),r.sort((c,u)=>c.t-u.t),$=r.indexOf(s),B(l.selectedId),kt(r),De(),F()});document.addEventListener("pointermove",e=>{if(st===null)return;const t=A.querySelector(".gradient-popup-bar"),a=wt();if(!t||!a)return;const n=t.getBoundingClientRect(),o=Sn((e.clientX-n.left)/n.width),i=a.stops.map(s=>({...s})),r=i[st];r&&(r.t=o,i.sort((s,c)=>s.t-c.t),$=i.indexOf(r),st=$,kt(i),De(),F())});document.addEventListener("pointerup",()=>{st=null});A.querySelector(".gradient-popup-color").addEventListener("input",e=>{const t=wt();if(!t||$===null)return;const a=t.stops.map(n=>({...n}));a[$].color=e.target.value,kt(a),De(),F()});A.querySelector(".gradient-popup-color").addEventListener("change",()=>{B(l.selectedId)});A.querySelector(".gradient-popup-pos").addEventListener("change",e=>{const t=wt();if(!t||$===null)return;const a=t.stops.map(o=>({...o})),n=a[$];B(l.selectedId),n.t=Sn(Number(e.target.value)/100),a.sort((o,i)=>o.t-i.t),$=a.indexOf(n),kt(a),De(),F()});A.querySelector(".gradient-popup-delete").addEventListener("click",()=>{const e=wt();if(!e||$===null||e.stops.length<=2)return;const t=e.stops.filter((a,n)=>n!==$);B(l.selectedId),$=null,kt(t),De(),F()});let z=null,mt=null,ht=null,Pe=null,ct=null,W=null;function En(){return!z||!l.selectedId?null:G(l.selectedId).find(t=>t.instanceId===z.instanceId)||null}function Ke(){const e=En();return e?Bt(e.params[z.paramKey]):null}function vt(e){const t=En();!t||!z||(t.params[z.paramKey]={points:e},pe())}function zl(e,t,a,n){z={instanceId:e,paramKey:t,trigger:n},W=null,C.querySelector(".curve-popup-title").textContent=a||"Curve",C.style.width=`${Le.w}px`,C.style.height=`${Le.h}px`,C.hidden=!1,Dn(),fe()}function ya(){C.hidden=!0,z=null,mt=null,ht=null,W=null,At()}function Hl(){const e=En();if(!e||!z)return;const t=Re(e.defId),a=t&&t.params.find(i=>i.key===z.paramKey);if(!a)return;const o=Bt(a.default).points.map(i=>({...i}));W=null,B(l.selectedId),vt(o),fe(),F()}function Dn(){if(C.hidden||!z||!z.trigger)return;const e=z.trigger.getBoundingClientRect(),t=C.offsetWidth||Le.w,a=C.offsetHeight||Le.h;let n=e.right-t,o=e.top-a-10;o<8&&(o=e.bottom+10),n=Math.min(Math.max(8,n),window.innerWidth-t-8),o=Math.min(Math.max(8,o),window.innerHeight-a-8),C.style.left=`${n}px`,C.style.top=`${o}px`}function fe(){const e=Ke(),t=C.querySelector(".curve-popup-svg");if(!e||!t)return;const a=t.getBoundingClientRect(),n=Math.max(1,Math.round(a.width)||100),o=Math.max(1,Math.round(a.height)||100);t.setAttribute("viewBox",`0 0 ${n} ${o}`),W!==null&&(W<0||W>=e.points.length-1)&&(W=null);const i=Ko(e,n,o,48);let r="";for(let p=1;p<4;p++){const h=p/4*n,v=p/4*o;r+=`<line class="curve-grid-line" x1="0" y1="${v.toFixed(2)}" x2="${n}" y2="${v.toFixed(2)}" />`,r+=`<line class="curve-grid-line" x1="${h.toFixed(2)}" y1="0" x2="${h.toFixed(2)}" y2="${o}" />`}const s=Math.min(n,o),c=Math.max(4.5,s*.03),u=Math.max(9,s*.05);let d="";for(let p=0;p<e.points.length-1;p++){const h=e.points[p];if(h.type==="constant"||p!==W)continue;const v=e.points[p+1],m=h.x*n,g=(1-h.y)*o,S=Math.max(v.x-h.x,1e-5),M=h.tanSet?h.tanDx:S/3,x=h.tanSet?h.tanDy:0;let V=M*n,se=-x*o;const Q=Math.hypot(V,se),ce=Math.max(u*1.1,12);if(!h.tanSet)if(Q>1e-4&&Q<ce){const I=ce/Q;V*=I,se*=I}else Q<=1e-4&&(V=ce,se=0);const St=m+V,Qe=g+se,b=m-V,T=g-se;d+=`<line class="curve-handle-line" x1="${St.toFixed(2)}" y1="${Qe.toFixed(2)}" x2="${b.toFixed(2)}" y2="${T.toFixed(2)}" />`;const N=u/2,k=(I,Y)=>`M ${I.toFixed(2)} ${(Y-N).toFixed(2)} L ${(I+N).toFixed(2)} ${Y.toFixed(2)} L ${I.toFixed(2)} ${(Y+N).toFixed(2)} L ${(I-N).toFixed(2)} ${Y.toFixed(2)} Z`;d+=`<path class="curve-handle-point" data-handle-index="${p}" d="${k(St,Qe)}" />`,d+=`<path class="curve-handle-point" data-handle-index="${p}" d="${k(b,T)}" />`}const f=e.points.map((p,h)=>{const v=h===0||h===e.points.length-1,m=h===W,g=["curve-point",v?"curve-point--endpoint":"",p.type==="constant"?"curve-point--constant":"",m?"curve-point--active":""].filter(Boolean).join(" "),S=p.x*n,M=(1-p.y)*o;if(m){const x=c*1.7;return`<rect class="${g}" data-point-index="${h}" x="${(S-x/2).toFixed(2)}" y="${(M-x/2).toFixed(2)}" width="${x.toFixed(2)}" height="${x.toFixed(2)}" />`}return`<circle class="${g}" data-point-index="${h}" cx="${S.toFixed(2)}" cy="${M.toFixed(2)}" r="${c.toFixed(2)}" />`}).join("");t.innerHTML=`${r}${d}<path class="curve-popup-path" d="${i}" />${f}`}C.querySelector(".curve-popup-close").addEventListener("click",ya);C.querySelector(".curve-popup-reset").addEventListener("click",Hl);C.querySelector(".curve-popup-svg").addEventListener("pointerdown",e=>{const t=e.currentTarget,a=e.target.closest(".curve-handle-point"),n=e.target.closest(".curve-point"),o=Ke();if(o){if(a){const i=Number(a.dataset.handleIndex);B(l.selectedId),ht={index:i},W=i,t.setPointerCapture(e.pointerId),e.stopPropagation();return}if(n){const i=Number(n.dataset.pointIndex);B(l.selectedId),mt={index:i},i<o.points.length-1&&o.points[i].type!=="constant"?W=i:W=null,t.setPointerCapture(e.pointerId),e.stopPropagation(),fe();return}W!==null&&(W=null,fe())}});C.querySelector(".curve-popup-svg").addEventListener("dblclick",e=>{const t=e.target.closest(".curve-point"),a=Ke();if(!a)return;if(e.preventDefault(),t){const u=Number(t.dataset.pointIndex),d=a.points.map(f=>({...f}));d[u].type=d[u].type==="constant"?"bezier":"constant",B(l.selectedId),vt(d),fe(),F();return}if(e.target.closest(".curve-handle-point"))return;const o=C.querySelector(".curve-popup-svg").getBoundingClientRect(),i=Math.min(1,Math.max(0,(e.clientX-o.left)/o.width)),r=Math.min(1,Math.max(0,1-(e.clientY-o.top)/o.height)),s=a.points.map(u=>({...u}));s.push({x:i,y:r,type:"bezier",tanDx:0,tanDy:0,tanSet:!1}),s.sort((u,d)=>u.x-d.x),B(l.selectedId),vt(s);const c=s.findIndex(u=>u.x===i&&u.y===r);W=c<s.length-1?c:null,fe(),F()});C.querySelector(".curve-popup-svg").addEventListener("contextmenu",e=>{const t=e.target.closest(".curve-point");if(!t)return;e.preventDefault(),ct=Number(t.dataset.pointIndex);const a=Ke(),n=a&&(ct===0||ct===a.points.length-1);ie.querySelector('[data-action="delete"]').disabled=!!n,ie.style.left=`${e.clientX}px`,ie.style.top=`${e.clientY}px`,ie.hidden=!1});function At(){ie.hidden=!0,ct=null}ie.addEventListener("click",e=>{const t=e.target.closest("button[data-action]");if(!t||t.disabled||ct===null){At();return}const a=Ke();if(a){const n=a.points.map(r=>({...r})),o=ct,i=o===0||o===n.length-1;t.dataset.action==="type-bezier"?n[o].type="bezier":t.dataset.action==="type-constant"?n[o].type="constant":t.dataset.action==="delete"&&!i&&n.length>2&&n.splice(o,1),B(l.selectedId),vt(n),fe(),F()}At()});C.querySelector(".curve-popup-resize").addEventListener("pointerdown",e=>{Pe={startX:e.clientX,startY:e.clientY,startW:Le.w,startH:Le.h},e.target.setPointerCapture(e.pointerId),e.preventDefault()});document.addEventListener("pointermove",e=>{if(mt){const t=Ke(),a=C.querySelector(".curve-popup-svg");if(!t||!a)return;const n=a.getBoundingClientRect(),o=t.points.map(u=>({...u})),i=mt.index,r=i===0||i===o.length-1,s=Math.min(1,Math.max(0,1-(e.clientY-n.top)/n.height));let c=o[i].x;if(!r){const u=o[i-1].x+.001,d=o[i+1].x-.001;c=Math.min(d,Math.max(u,(e.clientX-n.left)/n.width))}o[i]={...o[i],x:c,y:s},vt(o),fe(),F()}else if(ht){const t=Ke(),a=C.querySelector(".curve-popup-svg");if(!t||!a)return;const n=a.getBoundingClientRect(),o=t.points.map(x=>({...x})),i=ht.index,r=o[i],s=o[i+1];if(!r||!s)return;const c=n.width,u=n.height,d=r.x*c,f=(1-r.y)*u,p=e.clientX-n.left,h=e.clientY-n.top;let v=(p-d)/c,m=-(h-f)/u;const S=Math.max(.001,Math.hypot(s.x-r.x,s.y-r.y))*1.5,M=Math.hypot(v,m);if(M>S){const x=S/M;v*=x,m*=x}o[i]={...r,tanDx:v,tanDy:m,tanSet:!0},vt(o),fe(),F()}else if(Pe){const t=Math.max(240,Math.min(720,Pe.startW+(e.clientX-Pe.startX))),a=Math.max(160,Math.min(560,Pe.startH+(e.clientY-Pe.startY)));Le={w:t,h:a},C.style.width=`${t}px`,C.style.height=`${a}px`,fe()}});document.addEventListener("pointerup",()=>{mt&&(mt=null),ht&&(ht=null),Pe&&(Pe=null,Ul())});document.addEventListener("click",e=>{!C.hidden&&!e.target.closest("#curvePopup")&&!e.target.closest('[data-action="open-curve"]')&&!e.target.closest("#curvePointMenu")&&ya(),!ie.hidden&&!e.target.closest("#curvePointMenu")&&At(),!A.hidden&&!e.target.closest("#gradientPopup")&&!e.target.closest('[data-action="open-gradient"]')&&ga()});document.addEventListener("keydown",e=>{e.key==="Escape"&&(ya(),At(),ga())});document.addEventListener("keydown",e=>{const t=e.key.toLowerCase();if(!(e.ctrlKey||e.metaKey)||t!=="z"||!l.selectedId)return;const a=e.target;a&&(a.tagName==="INPUT"||a.tagName==="TEXTAREA")&&a.type==="text"||(e.preventDefault(),e.shiftKey?nl(l.selectedId):al(l.selectedId))});window.addEventListener("resize",Dn);jt.addEventListener("change",()=>{l.selectedId&&(l.filterPreviewOn[l.selectedId]=jt.checked,pe(),F())});function fi(){return!ve||!l.selectedId||R.style.display==="none"||!Ne(l.selectedId)?!1:G(l.selectedId).some(e=>e.enabled)}function Mn(e){if(fi()){const c=[...G(l.selectedId).filter(u=>u.enabled)].reverse();return ve.captureAtScale(c,Zt,e)}const t=D.contentDocument,a=t?t.querySelector("canvas"):null;if(!a||!a.width||!a.height)return null;const n=Math.round(a.width*e),o=Math.round(a.height*e),i=document.createElement("canvas");return i.width=n,i.height=o,i.getContext("2d").drawImage(a,0,0,n,o),{dataUrl:i.toDataURL("image/png"),width:n,height:o}}function ql(e,t){const a=URL.createObjectURL(e),n=document.createElement("a");n.href=a,n.download=t,n.click(),setTimeout(()=>URL.revokeObjectURL(a),1e3)}function pi(e,t){const a=$r(e),n=Hr(t.dataUrl);if(!n)return console.warn("Failed to read exported PNG data for metadata embedding."),null;let o;try{const i=Gr(n,go,JSON.stringify(a));o=new Blob([i],{type:"image/png"})}catch(i){console.warn("Failed to embed state metadata into PNG export; downloading raw image.",i),o=new Blob([n],{type:"image/png"})}return o}function Gl(e,t,a){const n=pi(e,t);return n?(ql(n,a),!0):!1}function ea(e,t,a,n){const o=Number(e);return Number.isFinite(o)?Math.min(a,Math.max(t,o)):n}function mi(e){return new Promise(t=>setTimeout(t,e))}async function Wl(){if(typeof window.showDirectoryPicker!="function")throw new Error("Directory picker is not supported in this runtime.");return window.showDirectoryPicker({mode:"readwrite"})}async function jl(e,t,a){const o=await(await e.getFileHandle(t,{create:!0})).createWritable();await o.write(a),await o.close()}async function Vl(e=140){await new Promise(t=>requestAnimationFrame(()=>requestAnimationFrame(t))),e>0&&await mi(e)}let ut=!1;const ba=new Map;function ne(e,t="neutral"){Nn.textContent=e||"",Nn.dataset.tone=t}function Yn(e){const t=Math.floor(ea(e,1,200,1));K.value=String(t)}function Jn(e){const t=ea(e,.1,4,1);Ge.value=String(Number(t.toFixed(1)))}function xa(e){const t=e?ba.get(e):null;Un.textContent=t?t.name:"Not set",Un.title=t?t.name:"No folder selected",un.disabled=!t}function Xl(){const e=Number(K.value);K.dataset.prevValue=String(Number.isFinite(e)?e:8),K.addEventListener("input",()=>{const t=Number(K.dataset.prevValue||"8"),a=Number(K.value);if(!Number.isFinite(a))return;let n=a;Number.isFinite(t)&&Math.abs(a-(t+1))<1e-9?n=t*2:Number.isFinite(t)&&Math.abs(a-(t-1))<1e-9&&(n=t/2),Yn(n),K.dataset.prevValue=K.value}),K.addEventListener("change",()=>{Yn(Number(K.value||8)),K.dataset.prevValue=K.value}),Ge.addEventListener("input",()=>{Jn(Number(Ge.value||1))}),Ge.addEventListener("change",()=>{Jn(Number(Ge.value||1))})}yo.addEventListener("click",()=>{l.selectedId&&Yl()});me.addEventListener("click",async()=>{if(!l.selectedId||me.disabled)return;const e=Mn(1);if(e)try{const t=await(await fetch(e.dataUrl)).blob();await navigator.clipboard.write([new ClipboardItem({"image/png":t})]),Kl()}catch(t){console.warn("[filter] copy to clipboard failed:",t)}});function Kl(){const e=me.dataset.baseTitle||me.title;me.dataset.baseTitle=e,me.classList.add("copied"),me.title="Copied!",setTimeout(()=>{me.classList.remove("copied"),me.title=e},1200)}function Yl(){let e,t;if(fi())e=ve.width,t=ve.height;else{const a=D.contentDocument,n=a?a.querySelector("canvas"):null;e=n?n.width:R.width,t=n?n.height:R.height}nr.textContent=`${Math.round(e)} × ${Math.round(t)} px`,ne(""),Ut.disabled=!1,xa(l.selectedId),Vt.hidden=!1}function ta(){ut||(Vt.hidden=!0)}Ga.addEventListener("click",e=>{const t=e.target.closest(".export-size-option");if(!t||!l.selectedId)return;const a=Number(t.dataset.scale)||1,n=l.selectedId,o=Mn(a);if(!o){ta();return}const i=qo(n);Gl(n,o,i),ta()});Ut.addEventListener("click",async()=>{if(!l.selectedId||ut)return;const e=l.selectedId,t=Math.floor(ea(K.value,1,200,1)),a=ea(Ge.value,.1,4,1),n=ir.value==="seed"?"seed":"all-random";K.value=String(t),Ge.value=String(Number(a.toFixed(2)));const o=ba.get(e);if(!o){ne("Please set Batch Path first.","warn");return}ut=!0,Ut.disabled=!0,Wa.disabled=!0,un.disabled=!0,Ga.querySelectorAll(".export-size-option").forEach(s=>{s.disabled=!0}),ne(`Preparing batch export (${t})â€¦`);let i=0,r=0;try{for(let s=0;s<t;s++){if(l.selectedId!==e){ne("Batch stopped: selected effect changed.","warn");break}ne(`Rendering ${s+1}/${t}â€¦`),n==="all-random"?la(e):$e(e,"rerollSeed"),await xr(e,1800),await Vl();const c=Mn(a);if(!c){r+=1;continue}const u=`batch-${String(s+1).padStart(3,"0")}`,d=qo(e,u),f=pi(e,c);if(!f)r+=1;else try{await jl(o,d,f),i+=1}catch(p){console.warn("Batch export write failed:",p),r+=1}await mi(60)}}finally{ut=!1,Ut.disabled=!1,Wa.disabled=!1,xa(l.selectedId),Ga.querySelectorAll(".export-size-option").forEach(c=>{c.disabled=!1});const s=r>0?"warn":"ok";ne(`Done: ${i} exported${r?`, ${r} failed`:""}.`,s)}});Wa.addEventListener("click",async()=>{const e=l.selectedId;if(!(!e||ut)){ne("Selecting folderâ€¦");try{const t=await Wl();ba.set(e,t),xa(e),ne("Batch path set.","ok")}catch(t){console.warn("Batch export folder selection failed:",t);const a=t&&typeof t=="object"&&"name"in t?String(t.name):"";if(a==="AbortError"){ne("Folder selection cancelled.","warn");return}if(a==="NotAllowedError"||a==="SecurityError"){ne("Folder access was blocked. Please allow folder access and try again.","warn");return}const n=t instanceof Error&&t.message?t.message:"Unknown error";ne(`Failed to set folder: ${n}`,"warn")}}});un.addEventListener("click",()=>{const e=l.selectedId;!e||ut||(ba.delete(e),xa(e),ne("Batch path cleared."))});Xl();or.addEventListener("click",ta);Vt.addEventListener("click",e=>{e.target===Vt&&ta()});sn.addEventListener("dragover",e=>{(e.dataTransfer?.types?Array.from(e.dataTransfer.types):[]).includes("Files")&&(e.preventDefault(),e.dataTransfer.dropEffect="copy")});sn.addEventListener("drop",async e=>{if(!e.dataTransfer?.files?.length)return;e.preventDefault();const t=[...e.dataTransfer.files].find(a=>/image\/png/i.test(a.type)||/\.png$/i.test(a.name));if(t)try{await Xr(t)||console.info("Dropped PNG has no embedded ShaderOps state metadata.")}catch(a){console.warn("Failed to restore ShaderOps state from dropped PNG:",a)}});Ki.addEventListener("click",()=>{cn.classList.add("collapsed"),E.setItem(on,"1")});Xi.addEventListener("click",()=>{cn.classList.remove("collapsed"),E.setItem(on,"0")});async function Jl(){await Kr(),Yr(),tl(),await Al()}Jl().catch(e=>{Na.textContent="Registry load failed",Ua.textContent=e.message});
